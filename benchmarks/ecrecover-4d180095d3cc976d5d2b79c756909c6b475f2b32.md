...
| `execute_time_ms     ` |  165 |  165 |  165 |  165 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,274 |  42,274 |  42,274 |  42,274 |
| `main_cells_used     ` |  439,948,371 |  439,948,371 |  439,948,371 |  439,948,371 |
| `total_cycles        ` |  9,647,527 |  9,647,527 |  9,647,527 |  9,647,527 |
| `execute_time_ms     ` |  3,389 |  3,389 |  3,389 |  3,389 |
| `trace_gen_time_ms   ` |  8,116 |  8,116 |  8,116 |  8,116 |
| `stark_prove_excluding_trace_time_ms` |  30,769 |  30,769 |  30,769 |  30,769 |
| `main_trace_commit_time_ms` |  5,857 |  5,857 |  5,857 |  5,857 |
| `generate_perm_trace_time_ms` |  783 |  783 |  783 |  783 |
| `perm_trace_commit_time_ms` |  5,776 |  5,776 |  5,776 |  5,776 |
| `quotient_poly_compute_time_ms` |  7,245 |  7,245 |  7,245 |  7,245 |
| `quotient_poly_commit_time_ms` |  4,867 |  4,867 |  4,867 |  4,867 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,116 | 42,274 | 9,647,527 | 1,069,222,360 | 30,769 | 7,245 | 4,867 | 5,776 | 6,239 | 5,857 | 439,948,371 | 783 | 3,389 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 278 | 2,595 | 285,169 | 56,159,799 | 2,152 | 253 | 309 | 530 | 621 | 391 | 15,074,875 | 45 | 165 | 
