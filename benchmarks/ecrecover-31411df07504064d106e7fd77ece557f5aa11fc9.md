...
| `pcs_opening_time_ms ` |  643 |  643 |  643 |  643 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,230 |  42,230 |  42,230 |  42,230 |
| `main_cells_used     ` |  439,994,481 |  439,994,481 |  439,994,481 |  439,994,481 |
| `total_cycles        ` |  9,651,998 |  9,651,998 |  9,651,998 |  9,651,998 |
| `execute_time_ms     ` |  3,485 |  3,485 |  3,485 |  3,485 |
| `trace_gen_time_ms   ` |  8,212 |  8,212 |  8,212 |  8,212 |
| `stark_prove_excluding_trace_time_ms` |  30,533 |  30,533 |  30,533 |  30,533 |
| `main_trace_commit_time_ms` |  5,937 |  5,937 |  5,937 |  5,937 |
| `generate_perm_trace_time_ms` |  783 |  783 |  783 |  783 |
| `perm_trace_commit_time_ms` |  5,853 |  5,853 |  5,853 |  5,853 |
| `quotient_poly_compute_time_ms` |  6,752 |  6,752 |  6,752 |  6,752 |
| `quotient_poly_commit_time_ms` |  4,939 |  4,939 |  4,939 |  4,939 |
| `pcs_opening_time_ms ` |  6,266 |  6,266 |  6,266 |  6,266 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,212 | 42,230 | 9,651,998 | 1,069,222,360 | 30,533 | 6,752 | 4,939 | 5,853 | 6,266 | 5,937 | 439,994,481 | 783 | 3,485 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 277 | 2,636 | 285,169 | 56,159,799 | 2,181 | 267 | 309 | 526 | 643 | 392 | 15,074,875 | 40 | 178 | 
