...
| `execute_time_ms     ` |  171 |  171 |  171 |  171 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,160 |  42,160 |  42,160 |  42,160 |
| `main_cells_used     ` |  439,966,631 |  439,966,631 |  439,966,631 |  439,966,631 |
| `total_cycles        ` |  9,649,234 |  9,649,234 |  9,649,234 |  9,649,234 |
| `execute_time_ms     ` |  3,140 |  3,140 |  3,140 |  3,140 |
| `trace_gen_time_ms   ` |  7,920 |  7,920 |  7,920 |  7,920 |
| `stark_prove_excluding_trace_time_ms` |  31,100 |  31,100 |  31,100 |  31,100 |
| `main_trace_commit_time_ms` |  6,305 |  6,305 |  6,305 |  6,305 |
| `generate_perm_trace_time_ms` |  771 |  771 |  771 |  771 |
| `perm_trace_commit_time_ms` |  6,137 |  6,137 |  6,137 |  6,137 |
| `quotient_poly_compute_time_ms` |  6,620 |  6,620 |  6,620 |  6,620 |
| `quotient_poly_commit_time_ms` |  4,983 |  4,983 |  4,983 |  4,983 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,920 | 42,160 | 9,649,234 | 1,069,222,360 | 31,100 | 6,620 | 4,983 | 6,137 | 6,282 | 6,305 | 439,966,631 | 771 | 3,140 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 282 | 2,630 | 285,169 | 56,159,799 | 2,177 | 275 | 303 | 524 | 631 | 402 | 15,074,875 | 39 | 171 | 
