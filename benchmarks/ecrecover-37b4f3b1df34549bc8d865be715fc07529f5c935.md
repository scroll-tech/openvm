...
| `total_proof_time_ms ` |  2,606 |  2,606 |  2,606 |  2,606 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,311 |  42,311 |  42,311 |  42,311 |
| `main_cells_used     ` |  440,615,918 |  440,615,918 |  440,615,918 |  440,615,918 |
| `total_cycles        ` |  9,668,833 |  9,668,833 |  9,668,833 |  9,668,833 |
| `execute_time_ms     ` |  2,708 |  2,708 |  2,708 |  2,708 |
| `trace_gen_time_ms   ` |  7,125 |  7,125 |  7,125 |  7,125 |
| `stark_prove_excluding_trace_time_ms` |  32,478 |  32,478 |  32,478 |  32,478 |
| `main_trace_commit_time_ms` |  6,283 |  6,283 |  6,283 |  6,283 |
| `generate_perm_trace_time_ms` |  753 |  753 |  753 |  753 |
| `perm_trace_commit_time_ms` |  6,374 |  6,374 |  6,374 |  6,374 |
| `quotient_poly_compute_time_ms` |  7,442 |  7,442 |  7,442 |  7,442 |
| `quotient_poly_commit_time_ms` |  5,153 |  5,153 |  5,153 |  5,153 |
| `pcs_opening_time_ms ` |  6,471 |  6,471 |  6,471 |  6,471 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,125 | 42,311 | 9,668,833 | 1,069,222,360 | 32,478 | 7,442 | 5,153 | 6,374 | 6,471 | 6,283 | 440,615,918 | 753 | 2,708 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 269 | 2,606 | 285,401 | 56,172,159 | 2,189 | 298 | 301 | 526 | 629 | 392 | 15,092,297 | 40 | 148 | 
