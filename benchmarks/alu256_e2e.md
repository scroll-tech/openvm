...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-9.0 [-0.5%])</span> <div style='text-align: right'>1,713.0</div>  | <div style='text-align: right'>3,972,444</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: green">(-8.0 [-0.5%])</span> <div style='text-align: right'>1,743.0</div>  | <span style="color: red">(+1.0 [+3.4%])</span> <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: green">(-67.0 [-0.2%])</span> <div style='text-align: right'>37,297.0</div>  | <div style='text-align: right'>290,324,504</div>  | <span style="color: green">(-11,470 [-0.0%])</span> <div style='text-align: right'>113,957,241</div>  | <span style="color: green">(-78.0 [-0.2%])</span> <div style='text-align: right'>41,285.0</div>  | <span style="color: green">(-11.0 [-0.3%])</span> <div style='text-align: right'>3,988.0</div>  | <span style="color: green">(-4.0 [-1.0%])</span> <div style='text-align: right'>415.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: red">(+1 [+0.0%])</span> <div style='text-align: right'>807,095</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>281,650</div>  |
| inner_verifier | Jal | <span style="color: green">(-1,045 [-3.0%])</span> <div style='text-align: right'>33,944</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,188,590</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-60 [-0.0%])</span> <div style='text-align: right'>677,123</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-30 [-0.0%])</span> <div style='text-align: right'>338,710</div>  |
...
| inner_verifier | AddEI | ADD | <div style='text-align: right'>26,880</div>  |
| inner_verifier | AddFI | ADD | <span style="color: red">(+1 [+0.0%])</span> <div style='text-align: right'>21,526</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-1,045 [-7.5%])</span> <div style='text-align: right'>12,859</div>  |
...
| inner_verifier | ImmE | STOREW | <div style='text-align: right'>7,312</div>  |
...
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddEI | ADD | <div style='text-align: right'>806,400</div>  |
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-330 [-0.2%])</span> <div style='text-align: right'>158,268</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-195 [-0.2%])</span> <div style='text-align: right'>93,522</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,160</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+30 [+0.0%])</span> <div style='text-align: right'>645,780</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-10,450 [-7.5%])</span> <div style='text-align: right'>128,590</div>  |
...
| inner_verifier | <NativeLoadStoreAdapterAir<1>,KernelLoadStoreCoreAir<1>> | ImmE | STOREW | <div style='text-align: right'>299,792</div>  |
...
| inner_verifier | Boundary | ImmE | STOREW | <div style='text-align: right'>66,572</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-330 [-0.1%])</span> <div style='text-align: right'>423,456</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-195 [-0.1%])</span> <div style='text-align: right'>250,224</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75/alu256_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/852c6a504ef1b5a2cf6cca87c072fda6f5dfab75
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11538495745)
