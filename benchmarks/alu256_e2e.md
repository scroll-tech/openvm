...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-18.0 [-1.1%])</span> <div style='text-align: right'>1,687.0</div>  | <div style='text-align: right'>3,972,475</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: green">(-20.0 [-1.2%])</span> <div style='text-align: right'>1,716.0</div>  | <span style="color: green">(-2.0 [-6.5%])</span> <div style='text-align: right'>29.0</div>  |  |
| inner_verifier | <span style="color: red">(+4.0 [+0.0%])</span> <div style='text-align: right'>37,306.0</div>  | <div style='text-align: right'>292,028,440</div>  | <span style="color: green">(-12,430 [-0.0%])</span> <div style='text-align: right'>117,647,308</div>  | <span style="color: green">(-96.0 [-0.2%])</span> <div style='text-align: right'>41,236.0</div>  | <span style="color: green">(-100.0 [-2.5%])</span> <div style='text-align: right'>3,930.0</div>  | <span style="color: red">(+10.0 [+2.4%])</span> <div style='text-align: right'>425.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-14 [-0.0%])</span> <div style='text-align: right'>822,010</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>287,771</div>  |
| inner_verifier | Jal | <span style="color: green">(-1,082 [-3.1%])</span> <div style='text-align: right'>34,376</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,218,431</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-68 [-0.0%])</span> <div style='text-align: right'>691,253</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-34 [-0.0%])</span> <div style='text-align: right'>345,775</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-14 [-0.1%])</span> <div style='text-align: right'>21,947</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-1,082 [-7.9%])</span> <div style='text-align: right'>12,667</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-374 [-0.2%])</span> <div style='text-align: right'>160,226</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-221 [-0.2%])</span> <div style='text-align: right'>94,679</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-420 [-0.1%])</span> <div style='text-align: right'>658,410</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-10,820 [-7.9%])</span> <div style='text-align: right'>126,670</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-374 [-0.1%])</span> <div style='text-align: right'>426,734</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-221 [-0.1%])</span> <div style='text-align: right'>252,161</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/bac8a0a95db67d4b54e2f043886fb577d8f87021/alu256_e2e.dsl_ir.opcode.frequency.svg)
