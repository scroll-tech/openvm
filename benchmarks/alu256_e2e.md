...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+6.0 [+0.3%])</span> <div style='text-align: right'>1,771.0</div>  | <div style='text-align: right'>4,037,980</div>  | <div style='text-align: right'>656,394</div>  | <span style="color: red">(+7.0 [+0.4%])</span> <div style='text-align: right'>1,801.0</div>  | <span style="color: red">(+1.0 [+3.4%])</span> <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: red">(+278.0 [+0.7%])</span> <div style='text-align: right'>37,495.0</div>  | <div style='text-align: right'>290,324,504</div>  | <span style="color: green">(-13,620 [-0.0%])</span> <div style='text-align: right'>114,345,461</div>  | <span style="color: red">(+276.0 [+0.7%])</span> <div style='text-align: right'>41,647.0</div>  | <span style="color: green">(-2.0 [-0.0%])</span> <div style='text-align: right'>4,152.0</div>  | <span style="color: red">(+5.0 [+1.2%])</span> <div style='text-align: right'>427.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-35 [-0.0%])</span> <div style='text-align: right'>811,368</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>282,300</div>  |
| inner_verifier | Jal | <span style="color: green">(-1,222 [-3.4%])</span> <div style='text-align: right'>34,894</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,192,295</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-20 [-0.0%])</span> <div style='text-align: right'>678,695</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-10 [-0.0%])</span> <div style='text-align: right'>339,496</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-35 [-0.2%])</span> <div style='text-align: right'>21,961</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-1,222 [-8.2%])</span> <div style='text-align: right'>13,698</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-110 [-0.1%])</span> <div style='text-align: right'>159,764</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-65 [-0.1%])</span> <div style='text-align: right'>94,406</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>205,744</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-1,050 [-0.2%])</span> <div style='text-align: right'>658,830</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-12,220 [-8.2%])</span> <div style='text-align: right'>136,980</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-110 [-0.0%])</span> <div style='text-align: right'>424,226</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-65 [-0.0%])</span> <div style='text-align: right'>250,679</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/282ca1e8a7d6fb036945d79b739ea15eab27539a/alu256_e2e.dsl_ir.opcode.frequency.svg)
