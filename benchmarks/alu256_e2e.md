...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <div style='text-align: right'>17,511.0</div>  | <div style='text-align: right'>22,478,356</div>  | <div style='text-align: right'>2,663,633</div>  | <span style="color: green">(-1.0 [-0.0%])</span> <div style='text-align: right'>17,614.0</div>  | <span style="color: green">(-1.0 [-1.0%])</span> <div style='text-align: right'>103.0</div>  |  |
| inner_verifier | <span style="color: red">(+81.0 [+0.2%])</span> <div style='text-align: right'>40,932.0</div>  | <div style='text-align: right'>340,000,788</div>  | <span style="color: green">(-21,094 [-0.0%])</span> <div style='text-align: right'>177,012,254</div>  | <span style="color: green">(-1,280.0 [-2.3%])</span> <div style='text-align: right'>53,674.0</div>  | <span style="color: green">(-1,361.0 [-9.7%])</span> <div style='text-align: right'>12,742.0</div>  | <span style="color: red">(+8.0 [+1.9%])</span> <div style='text-align: right'>426.0</div>  |
...
| inner_verifier | Core | <span style="color: green">(-299 [-0.0%])</span> <div style='text-align: right'>1,724,288</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-15 [-0.0%])</span> <div style='text-align: right'>875,537</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>270,558</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-52 [-0.0%])</span> <div style='text-align: right'>665,051</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-26 [-0.0%])</span> <div style='text-align: right'>332,675</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-15 [-0.1%])</span> <div style='text-align: right'>22,106</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-299 [-1.9%])</span> <div style='text-align: right'>15,435</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-286 [-0.2%])</span> <div style='text-align: right'>159,654</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-169 [-0.2%])</span> <div style='text-align: right'>94,341</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>350,208</div>  |
| inner_verifier | <NativeAdapterAir,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-450 [-0.1%])</span> <div style='text-align: right'>663,180</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: green">(-19,734 [-1.9%])</span> <div style='text-align: right'>1,018,710</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-286 [-0.1%])</span> <div style='text-align: right'>427,394</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-169 [-0.1%])</span> <div style='text-align: right'>252,551</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/228b73f64d6613076945ce810a7ef0e507d7a2fa/alu256_e2e.dsl_ir.opcode.frequency.svg)
