...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+12.0 [+0.7%])</span> <div style='text-align: right'>1,725.0</div>  | <div style='text-align: right'>3,972,472</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: red">(+14.0 [+0.8%])</span> <div style='text-align: right'>1,757.0</div>  | <span style="color: red">(+2.0 [+6.7%])</span> <div style='text-align: right'>32.0</div>  |  |
| inner_verifier | <span style="color: green">(-79.0 [-0.2%])</span> <div style='text-align: right'>37,281.0</div>  | <div style='text-align: right'>291,635,224</div>  | <span style="color: green">(-3,820 [-0.0%])</span> <div style='text-align: right'>117,228,587</div>  | <span style="color: green">(-117.0 [-0.3%])</span> <div style='text-align: right'>41,267.0</div>  | <span style="color: green">(-38.0 [-0.9%])</span> <div style='text-align: right'>3,986.0</div>  | <span style="color: red">(+11.0 [+2.7%])</span> <div style='text-align: right'>425.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-2 [-0.0%])</span> <div style='text-align: right'>821,250</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>287,231</div>  |
| inner_verifier | Jal | <span style="color: green">(-327 [-0.9%])</span> <div style='text-align: right'>35,280</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,216,805</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-28 [-0.0%])</span> <div style='text-align: right'>690,145</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-14 [-0.0%])</span> <div style='text-align: right'>345,221</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-2 [-0.0%])</span> <div style='text-align: right'>21,964</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-327 [-2.4%])</span> <div style='text-align: right'>13,571</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-154 [-0.1%])</span> <div style='text-align: right'>159,962</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-91 [-0.1%])</span> <div style='text-align: right'>94,523</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-60 [-0.0%])</span> <div style='text-align: right'>658,920</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-3,270 [-2.4%])</span> <div style='text-align: right'>135,710</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-154 [-0.0%])</span> <div style='text-align: right'>426,712</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-91 [-0.0%])</span> <div style='text-align: right'>252,148</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/925b587775114a75b2fd961a995ab244a66e6a77/alu256_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/925b587775114a75b2fd961a995ab244a66e6a77
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11512846304)
