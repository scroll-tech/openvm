...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+7.0 [+0.4%])</span> <div style='text-align: right'>1,726.0</div>  | <div style='text-align: right'>3,972,444</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: red">(+7.0 [+0.4%])</span> <div style='text-align: right'>1,756.0</div>  | <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: red">(+113.0 [+0.3%])</span> <div style='text-align: right'>37,220.0</div>  | <div style='text-align: right'>290,324,504</div>  | <span style="color: red">(+3,490 [+0.0%])</span> <div style='text-align: right'>113,967,761</div>  | <span style="color: red">(+94.0 [+0.2%])</span> <div style='text-align: right'>41,194.0</div>  | <span style="color: green">(-19.0 [-0.5%])</span> <div style='text-align: right'>3,974.0</div>  | <span style="color: red">(+4.0 [+1.0%])</span> <div style='text-align: right'>417.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: red">(+2 [+0.0%])</span> <div style='text-align: right'>807,112</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>281,650</div>  |
| inner_verifier | Jal | <span style="color: red">(+273 [+0.8%])</span> <div style='text-align: right'>34,784</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,188,590</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+40 [+0.0%])</span> <div style='text-align: right'>677,215</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+20 [+0.0%])</span> <div style='text-align: right'>338,756</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+2 [+0.0%])</span> <div style='text-align: right'>21,543</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+273 [+2.0%])</span> <div style='text-align: right'>13,699</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+220 [+0.1%])</span> <div style='text-align: right'>158,774</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+130 [+0.1%])</span> <div style='text-align: right'>93,821</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,160</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+60 [+0.0%])</span> <div style='text-align: right'>646,290</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: red">(+2,730 [+2.0%])</span> <div style='text-align: right'>136,990</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+220 [+0.1%])</span> <div style='text-align: right'>423,962</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+130 [+0.1%])</span> <div style='text-align: right'>250,523</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0cc147358b09ac5a85d54c0e5f6d1229db258d93/alu256_e2e.dsl_ir.opcode.frequency.svg)
