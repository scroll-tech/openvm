...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+6.0 [+0.3%])</span> <div style='text-align: right'>1,733.0</div>  | <div style='text-align: right'>3,972,472</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: red">(+6.0 [+0.3%])</span> <div style='text-align: right'>1,765.0</div>  | <div style='text-align: right'>32.0</div>  |  |
| inner_verifier | <span style="color: green">(-10.0 [-0.0%])</span> <div style='text-align: right'>37,375.0</div>  | <div style='text-align: right'>291,635,224</div>  | <span style="color: red">(+11,300 [+0.0%])</span> <div style='text-align: right'>117,240,197</div>  | <span style="color: green">(-32.0 [-0.1%])</span> <div style='text-align: right'>41,374.0</div>  | <span style="color: green">(-22.0 [-0.5%])</span> <div style='text-align: right'>3,999.0</div>  | <span style="color: red">(+5.0 [+1.2%])</span> <div style='text-align: right'>432.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: red">(+15 [+0.0%])</span> <div style='text-align: right'>821,264</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>287,231</div>  |
| inner_verifier | Jal | <span style="color: red">(+980 [+2.8%])</span> <div style='text-align: right'>36,252</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,216,805</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+60 [+0.0%])</span> <div style='text-align: right'>690,229</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+30 [+0.0%])</span> <div style='text-align: right'>345,263</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+15 [+0.1%])</span> <div style='text-align: right'>21,978</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+980 [+7.2%])</span> <div style='text-align: right'>14,543</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+330 [+0.2%])</span> <div style='text-align: right'>160,424</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+195 [+0.2%])</span> <div style='text-align: right'>94,796</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+450 [+0.1%])</span> <div style='text-align: right'>659,340</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: red">(+9,800 [+7.2%])</span> <div style='text-align: right'>145,430</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+330 [+0.1%])</span> <div style='text-align: right'>427,174</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+195 [+0.1%])</span> <div style='text-align: right'>252,421</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/f3f27531751433187f21614182563efce156a972/alu256_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/f3f27531751433187f21614182563efce156a972
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11507322883)
