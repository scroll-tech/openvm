...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+28.0 [+0.2%])</span> <div style='text-align: right'>17,523.0</div>  | <div style='text-align: right'>22,478,356</div>  | <div style='text-align: right'>2,663,633</div>  | <span style="color: red">(+28.0 [+0.2%])</span> <div style='text-align: right'>17,627.0</div>  | <div style='text-align: right'>104.0</div>  |  |
| inner_verifier | <span style="color: green">(-321.0 [-0.8%])</span> <div style='text-align: right'>40,572.0</div>  | <div style='text-align: right'>340,000,788</div>  | <span style="color: green">(-83,612 [-0.0%])</span> <div style='text-align: right'>176,993,104</div>  | <span style="color: green">(-268.0 [-0.5%])</span> <div style='text-align: right'>54,955.0</div>  | <span style="color: red">(+53.0 [+0.4%])</span> <div style='text-align: right'>14,383.0</div>  | <span style="color: green">(-81.0 [-16.0%])</span> <div style='text-align: right'>424.0</div>  |
...
| inner_verifier | Core | <span style="color: green">(-1,242 [-0.1%])</span> <div style='text-align: right'>1,723,988</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-15 [-0.0%])</span> <div style='text-align: right'>875,547</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>270,558</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-68 [-0.0%])</span> <div style='text-align: right'>665,071</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-34 [-0.0%])</span> <div style='text-align: right'>332,685</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-15 [-0.1%])</span> <div style='text-align: right'>22,116</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-1,242 [-7.6%])</span> <div style='text-align: right'>15,135</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-374 [-0.2%])</span> <div style='text-align: right'>159,764</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-221 [-0.2%])</span> <div style='text-align: right'>94,406</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>350,208</div>  |
| inner_verifier | <NativeAdapterAir,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-450 [-0.1%])</span> <div style='text-align: right'>663,480</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: green">(-81,972 [-7.6%])</span> <div style='text-align: right'>998,910</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-374 [-0.1%])</span> <div style='text-align: right'>427,504</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-221 [-0.1%])</span> <div style='text-align: right'>252,616</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4a22388b31ccbe72994f039fa70a3df5dfa7e4f7/alu256_e2e.dsl_ir.opcode.frequency.svg)
