...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-17.0 [-1.0%])</span> <div style='text-align: right'>1,716.0</div>  | <div style='text-align: right'>3,972,472</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: green">(-18.0 [-1.0%])</span> <div style='text-align: right'>1,747.0</div>  | <span style="color: green">(-1.0 [-3.1%])</span> <div style='text-align: right'>31.0</div>  |  |
| inner_verifier | <span style="color: green">(-128.0 [-0.3%])</span> <div style='text-align: right'>37,247.0</div>  | <div style='text-align: right'>291,635,224</div>  | <span style="color: green">(-5,930 [-0.0%])</span> <div style='text-align: right'>117,234,267</div>  | <span style="color: green">(-76.0 [-0.2%])</span> <div style='text-align: right'>41,298.0</div>  | <span style="color: red">(+52.0 [+1.3%])</span> <div style='text-align: right'>4,051.0</div>  | <span style="color: green">(-17.0 [-3.9%])</span> <div style='text-align: right'>415.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-7 [-0.0%])</span> <div style='text-align: right'>821,257</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>287,231</div>  |
| inner_verifier | Jal | <span style="color: green">(-439 [-1.2%])</span> <div style='text-align: right'>35,813</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,216,805</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-76 [-0.0%])</span> <div style='text-align: right'>690,153</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-38 [-0.0%])</span> <div style='text-align: right'>345,225</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-7 [-0.0%])</span> <div style='text-align: right'>21,971</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-439 [-3.0%])</span> <div style='text-align: right'>14,104</div>  |
...
| inner_verifier | AccessAdapter<2> | AddE | FE4ADD | <div style='text-align: right'>220,374</div>  |
| inner_verifier | AccessAdapter<4> | AddE | FE4ADD | <div style='text-align: right'>130,221</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-418 [-0.3%])</span> <div style='text-align: right'>160,006</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-247 [-0.3%])</span> <div style='text-align: right'>94,549</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-210 [-0.0%])</span> <div style='text-align: right'>659,130</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-4,390 [-3.0%])</span> <div style='text-align: right'>141,040</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-418 [-0.1%])</span> <div style='text-align: right'>426,756</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-247 [-0.1%])</span> <div style='text-align: right'>252,174</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/deeb3d6ef068c8b276101dabad8523771c6cc68e/alu256_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/deeb3d6ef068c8b276101dabad8523771c6cc68e
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11512406163)
