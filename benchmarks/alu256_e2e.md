...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+11.0 [+0.6%])</span> <div style='text-align: right'>1,736.0</div>  | <div style='text-align: right'>3,972,472</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: red">(+9.0 [+0.5%])</span> <div style='text-align: right'>1,766.0</div>  | <span style="color: green">(-2.0 [-6.2%])</span> <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: red">(+9.0 [+0.0%])</span> <div style='text-align: right'>37,290.0</div>  | <div style='text-align: right'>291,635,224</div>  | <span style="color: red">(+8,919 [+0.0%])</span> <div style='text-align: right'>117,237,506</div>  | <span style="color: red">(+26.0 [+0.1%])</span> <div style='text-align: right'>41,293.0</div>  | <span style="color: red">(+17.0 [+0.4%])</span> <div style='text-align: right'>4,003.0</div>  | <span style="color: red">(+2.0 [+0.5%])</span> <div style='text-align: right'>427.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: red">(+3 [+0.0%])</span> <div style='text-align: right'>821,253</div>  |
| inner_verifier | FieldExtension | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>287,239</div>  |
| inner_verifier | Jal | <span style="color: red">(+766 [+2.2%])</span> <div style='text-align: right'>36,046</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,216,805</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+38 [+0.0%])</span> <div style='text-align: right'>690,183</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+19 [+0.0%])</span> <div style='text-align: right'>345,240</div>  |
| inner_verifier | Memory AccessAdapter<8> | <div style='text-align: right'>16,911</div>  |
| inner_verifier | Memory Boundary | <span style="color: red">(+16 [+0.0%])</span> <div style='text-align: right'>282,490</div>  |
| inner_verifier | Poseidon2 | <div style='text-align: right'>12,292</div>  |
| inner_verifier | ProgramChip | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>93,659</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+3 [+0.0%])</span> <div style='text-align: right'>21,967</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+766 [+5.6%])</span> <div style='text-align: right'>14,337</div>  |
...
| inner_verifier | MulE | BBE4MUL | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>143,520</div>  |
...
| inner_verifier | AccessAdapter<2> | AddE | FE4ADD | <span style="color: green">(-66 [-0.0%])</span> <div style='text-align: right'>220,308</div>  |
| inner_verifier | AccessAdapter<4> | AddE | FE4ADD | <span style="color: green">(-39 [-0.0%])</span> <div style='text-align: right'>130,182</div>  |
| inner_verifier | Boundary | AddE | FE4ADD | <span style="color: green">(-44 [-0.0%])</span> <div style='text-align: right'>237,732</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+154 [+0.1%])</span> <div style='text-align: right'>160,116</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+91 [+0.1%])</span> <div style='text-align: right'>94,614</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+90 [+0.0%])</span> <div style='text-align: right'>659,010</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: red">(+7,660 [+5.6%])</span> <div style='text-align: right'>143,370</div>  |
...
| inner_verifier | <NativeVectorizedAdapterAir<4>,FieldExtensionCoreAir> | MulE | BBE4MUL | <span style="color: red">(+320 [+0.0%])</span> <div style='text-align: right'>5,740,800</div>  |
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+330 [+0.1%])</span> <div style='text-align: right'>427,042</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+195 [+0.1%])</span> <div style='text-align: right'>252,343</div>  |
| inner_verifier | Boundary | MulE | BBE4MUL | <span style="color: red">(+220 [+0.0%])</span> <div style='text-align: right'>471,636</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/477c240f11b3d93a7b83163321e3831d413a4305/alu256_e2e.dsl_ir.opcode.frequency.svg)
