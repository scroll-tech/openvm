...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-1.0 [-0.1%])</span> <div style='text-align: right'>1,705.0</div>  | <div style='text-align: right'>4,189,728</div>  | <div style='text-align: right'>563,829</div>  | <span style="color: green">(-1.0 [-0.1%])</span> <div style='text-align: right'>1,748.0</div>  | <div style='text-align: right'>43.0</div>  |  |
| inner_verifier | <span style="color: green">(-246.0 [-0.6%])</span> <div style='text-align: right'>37,602.0</div>  | <div style='text-align: right'>308,543,512</div>  | <span style="color: red">(+3,510 [+0.0%])</span> <div style='text-align: right'>150,999,959</div>  | <span style="color: green">(-204.0 [-0.5%])</span> <div style='text-align: right'>43,865.0</div>  | <span style="color: red">(+42.0 [+0.7%])</span> <div style='text-align: right'>6,263.0</div>  | <span style="color: green">(-2.0 [-0.5%])</span> <div style='text-align: right'>415.0</div>  |
...
| inner_verifier | Core | <span style="color: red">(+78 [+0.0%])</span> <div style='text-align: right'>1,589,771</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-11 [-0.0%])</span> <div style='text-align: right'>771,338</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>268,082</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-48 [-0.0%])</span> <div style='text-align: right'>645,865</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-24 [-0.0%])</span> <div style='text-align: right'>323,060</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-11 [-0.1%])</span> <div style='text-align: right'>19,921</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+78 [+0.6%])</span> <div style='text-align: right'>13,462</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-264 [-0.2%])</span> <div style='text-align: right'>154,374</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-156 [-0.2%])</span> <div style='text-align: right'>91,221</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>350,968</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-330 [-0.1%])</span> <div style='text-align: right'>597,630</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: red">(+4,680 [+0.6%])</span> <div style='text-align: right'>807,720</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-264 [-0.1%])</span> <div style='text-align: right'>420,684</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-156 [-0.1%])</span> <div style='text-align: right'>248,586</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3ca59c6b0a1cf20db400e7d56ab1ff4f8f087e70/alu256_e2e.dsl_ir.opcode.frequency.svg)
