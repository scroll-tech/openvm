...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-3.0 [-0.2%])</span> <div style='text-align: right'>1,713.0</div>  | <div style='text-align: right'>3,972,472</div>  | <div style='text-align: right'>590,858</div>  | <span style="color: green">(-4.0 [-0.2%])</span> <div style='text-align: right'>1,743.0</div>  | <span style="color: green">(-1.0 [-3.2%])</span> <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: red">(+113.0 [+0.3%])</span> <div style='text-align: right'>37,360.0</div>  | <div style='text-align: right'>291,635,224</div>  | <span style="color: green">(-1,860 [-0.0%])</span> <div style='text-align: right'>117,232,407</div>  | <span style="color: red">(+86.0 [+0.2%])</span> <div style='text-align: right'>41,384.0</div>  | <span style="color: green">(-27.0 [-0.7%])</span> <div style='text-align: right'>4,024.0</div>  | <span style="color: green">(-1.0 [-0.2%])</span> <div style='text-align: right'>414.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-5 [-0.0%])</span> <div style='text-align: right'>821,252</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>287,231</div>  |
| inner_verifier | Jal | <span style="color: green">(-206 [-0.6%])</span> <div style='text-align: right'>35,607</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,216,805</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+20 [+0.0%])</span> <div style='text-align: right'>690,173</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+10 [+0.0%])</span> <div style='text-align: right'>345,235</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-5 [-0.0%])</span> <div style='text-align: right'>21,966</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-206 [-1.5%])</span> <div style='text-align: right'>13,898</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+110 [+0.1%])</span> <div style='text-align: right'>160,116</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+65 [+0.1%])</span> <div style='text-align: right'>94,614</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>204,116</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-150 [-0.0%])</span> <div style='text-align: right'>658,980</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-2,060 [-1.5%])</span> <div style='text-align: right'>138,980</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+110 [+0.0%])</span> <div style='text-align: right'>426,866</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+65 [+0.0%])</span> <div style='text-align: right'>252,239</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/072941901ace010e9cd0c70c9afd98fdbfe1f5ee/alu256_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/072941901ace010e9cd0c70c9afd98fdbfe1f5ee
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11512737615)
