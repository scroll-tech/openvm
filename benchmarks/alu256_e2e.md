...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-3.0 [-0.2%])</span> <div style='text-align: right'>1,707.0</div>  | <div style='text-align: right'>4,197,724</div>  | <div style='text-align: right'>552,112</div>  | <span style="color: green">(-3.0 [-0.2%])</span> <div style='text-align: right'>1,750.0</div>  | <div style='text-align: right'>43.0</div>  |  |
| inner_verifier | <span style="color: red">(+91.0 [+0.2%])</span> <div style='text-align: right'>38,999.0</div>  | <div style='text-align: right'>322,043,928</div>  | <span style="color: green">(-4,980 [-0.0%])</span> <div style='text-align: right'>138,534,906</div>  | <span style="color: green">(-89.0 [-0.2%])</span> <div style='text-align: right'>44,875.0</div>  | <span style="color: green">(-180.0 [-3.0%])</span> <div style='text-align: right'>5,876.0</div>  | <span style="color: green">(-22.0 [-5.0%])</span> <div style='text-align: right'>418.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-3 [-0.0%])</span> <div style='text-align: right'>813,744</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>286,249</div>  |
| inner_verifier | Jal | <span style="color: green">(-440 [-1.2%])</span> <div style='text-align: right'>34,918</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-28 [-0.0%])</span> <div style='text-align: right'>687,237</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-14 [-0.0%])</span> <div style='text-align: right'>343,788</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-3 [-0.0%])</span> <div style='text-align: right'>21,529</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-440 [-3.1%])</span> <div style='text-align: right'>13,833</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-154 [-0.1%])</span> <div style='text-align: right'>160,424</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-91 [-0.1%])</span> <div style='text-align: right'>94,796</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>350,740</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-90 [-0.0%])</span> <div style='text-align: right'>645,870</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-4,400 [-3.1%])</span> <div style='text-align: right'>138,330</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-154 [-0.0%])</span> <div style='text-align: right'>426,932</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-91 [-0.0%])</span> <div style='text-align: right'>252,278</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/48c321bdf2d7d5fd8b5594755ce4d68d306bc523/alu256_e2e.dsl_ir.opcode.frequency.svg)
