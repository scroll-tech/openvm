...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-15.0 [-0.8%])</span> <div style='text-align: right'>1,756.0</div>  | <div style='text-align: right'>4,037,980</div>  | <div style='text-align: right'>656,394</div>  | <span style="color: green">(-15.0 [-0.8%])</span> <div style='text-align: right'>1,786.0</div>  | <div style='text-align: right'>30.0</div>  |  |
| inner_verifier | <span style="color: green">(-89.0 [-0.2%])</span> <div style='text-align: right'>37,406.0</div>  | <div style='text-align: right'>290,324,504</div>  | <span style="color: red">(+1,760 [+0.0%])</span> <div style='text-align: right'>114,347,221</div>  | <span style="color: green">(-91.0 [-0.2%])</span> <div style='text-align: right'>41,556.0</div>  | <span style="color: green">(-2.0 [-0.0%])</span> <div style='text-align: right'>4,150.0</div>  | <span style="color: green">(-9.0 [-2.1%])</span> <div style='text-align: right'>418.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: red">(+10 [+0.0%])</span> <div style='text-align: right'>811,378</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>282,300</div>  |
| inner_verifier | Jal | <span style="color: red">(+209 [+0.6%])</span> <div style='text-align: right'>35,103</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>1,192,295</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-36 [-0.0%])</span> <div style='text-align: right'>678,659</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-18 [-0.0%])</span> <div style='text-align: right'>339,478</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+10 [+0.0%])</span> <div style='text-align: right'>21,971</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+209 [+1.5%])</span> <div style='text-align: right'>13,907</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-198 [-0.1%])</span> <div style='text-align: right'>159,566</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-117 [-0.1%])</span> <div style='text-align: right'>94,289</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>205,744</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+300 [+0.0%])</span> <div style='text-align: right'>659,130</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: red">(+2,090 [+1.5%])</span> <div style='text-align: right'>139,070</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-198 [-0.0%])</span> <div style='text-align: right'>424,028</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-117 [-0.0%])</span> <div style='text-align: right'>250,562</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/alu256_e2e.dsl_ir.opcode.frequency.svg)
