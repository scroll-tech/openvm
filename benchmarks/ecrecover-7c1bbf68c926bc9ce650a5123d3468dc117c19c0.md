...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,158 |  41,158 |  41,158 |  41,158 |
| `main_cells_used     ` |  365,919,810 |  365,919,810 |  365,919,810 |  365,919,810 |
| `total_cycles        ` |  8,656,748 |  8,656,748 |  8,656,748 |  8,656,748 |
| `execute_time_ms     ` |  2,505 |  2,505 |  2,505 |  2,505 |
| `trace_gen_time_ms   ` |  6,422 |  6,422 |  6,422 |  6,422 |
| `stark_prove_excluding_trace_time_ms` |  32,231 |  32,231 |  32,231 |  32,231 |
| `main_trace_commit_time_ms` |  5,848 |  5,848 |  5,848 |  5,848 |
| `generate_perm_trace_time_ms` |  693 |  693 |  693 |  693 |
| `perm_trace_commit_time_ms` |  7,231 |  7,231 |  7,231 |  7,231 |
| `quotient_poly_compute_time_ms` |  6,926 |  6,926 |  6,926 |  6,926 |
| `quotient_poly_commit_time_ms` |  5,130 |  5,130 |  5,130 |  5,130 |
| `pcs_opening_time_ms ` |  6,399 |  6,399 |  6,399 |  6,399 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,422 | 41,158 | 8,656,748 | 1,052,183,000 | 32,231 | 6,926 | 5,130 | 7,231 | 6,399 | 5,848 | 365,919,810 | 693 | 2,505 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,635 | 285,401 | 56,172,159 | 2,221 | 297 | 320 | 531 | 633 | 395 | 15,092,297 | 42 | 148 | 
