...
| --- | --- | --- | --- | --- |
| <span style="color: green">(-83.0 [-0.4%])</span> <div style='text-align: right'>19,962.0</div>  | <div style='text-align: right'>87,040,020</div>  | <span style="color: green">(-4,789 [-0.0%])</span> <div style='text-align: right'>29,794,154</div>  | <span style="color: green">(-7.0 [-0.3%])</span> <div style='text-align: right'>2,598.0</div>  | <span style="color: red">(+1.0 [+2.9%])</span> <div style='text-align: right'>36.0</div>  |

| chip_name | rows_used |
| --- | --- |
| ByteXor | <div style='text-align: right'>65,536</div>  |
| Core | <span style="color: green">(-61 [-0.0%])</span> <div style='text-align: right'>290,583</div>  |
| FieldArithmetic | <span style="color: red">(+7 [+0.0%])</span> <div style='text-align: right'>140,663</div>  |
| FieldExtension | <div style='text-align: right'>7,486</div>  |
| Memory | <div style='text-align: right'>97,480</div>  |
| Memory 2 | <span style="color: green">(-56 [-0.1%])</span> <div style='text-align: right'>40,579</div>  |
| Memory 3 | <span style="color: green">(-28 [-0.1%])</span> <div style='text-align: right'>20,291</div>  |
...
| AddFI | ADD | <span style="color: red">(+7 [+0.2%])</span> <div style='text-align: right'>2,837</div>  |
...
| IfEqI | JAL | <span style="color: green">(-61 [-3.2%])</span> <div style='text-align: right'>1,829</div>  |
...
| AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-308 [-1.3%])</span> <div style='text-align: right'>24,244</div>  |
| AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-182 [-1.3%])</span> <div style='text-align: right'>14,326</div>  |
...
| FieldArithmeticAir | AddFI | ADD | <span style="color: red">(+217 [+0.2%])</span> <div style='text-align: right'>87,947</div>  |
...
| CoreAir | IfEqI | JAL | <span style="color: green">(-4,026 [-3.2%])</span> <div style='text-align: right'>120,714</div>  |
...
| AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-308 [-0.9%])</span> <div style='text-align: right'>33,198</div>  |
| AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-182 [-0.9%])</span> <div style='text-align: right'>19,617</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5c3067cd01cfce8b6562f224d078b9ecbbc432de/verify_fibair.dsl_ir.opcode.frequency.svg)
