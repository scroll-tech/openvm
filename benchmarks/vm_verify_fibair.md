...
| --- | --- | --- | --- | --- |
| 8,218.0 <span style="color: red">(+50.0 [+0.6%])</span> | 67,641,364 | 27,538,761 <span style="color: red">(+11,392 [+0.0%])</span> | 1,719.0 <span style="color: green">(-7.0 [-0.4%])</span> | 34.0 <span style="color: red">(+1.0 [+3.0%])</span> |

| chip_name | rows_used |
| --- | --- |
| ByteXor | 65,536 |
| Core | 290,938 <span style="color: red">(+141 [+0.0%])</span> |
| FieldArithmetic | 140,536 <span style="color: red">(+47 [+0.0%])</span> |
| FieldExtension | 7,486 |
| Memory | 97,965 |
| Memory 2 | 40,679 <span style="color: red">(+44 [+0.1%])</span> |
| Memory 3 | 20,341 <span style="color: red">(+22 [+0.1%])</span> |
| Memory 4 | 3,851 |
| Memory 5 | 0 |
| Memory 6 | 0 |
| Memory 7 | 0 |
...
| --- | --- | --- |
| FADD | 3,609,094 <span style="color: red">(+1,842 [+0.1%])</span> | 113,119 <span style="color: red">(+47 [+0.0%])</span> |
...
| FMUL | 647,825 | 18,520 |
| JAL | 754,529 <span style="color: red">(+9,165 [+1.2%])</span> | 11,606 <span style="color: red">(+141 [+1.2%])</span> |
| FSUB | 375,784 | 8,894 |
| HINT_INPUT | 262,080 | 4,032 |
| CT_END | 247,455 | 3,807 |
| CT_START | 247,455 | 3,807 |
| BBE4MUL | 200,775 <span style="color: red">(+385 [+0.2%])</span> | 3,451 |
| BEQ | 177,450 | 2,730 |
...
| IfEqI | 878,410 <span style="color: red">(+9,165 [+1.1%])</span> | 13,514 <span style="color: red">(+141 [+1.1%])</span> |
| ImmV | 900,014 | 12,842 |
| StoreV | 1,003,675 | 12,540 |
| StoreF | 864,732 | 10,448 |
| ImmF | 461,083 | 7,036 |
| SubEF | 419,063 | 6,420 |
| AddEI | 215,789 <span style="color: red">(+385 [+0.2%])</span> | 5,664 |
...
| MulE | 194,816 <span style="color: red">(+385 [+0.2%])</span> | 3,418 |
| MulV | 156,493 | 3,131 |
| SubV | 96,157 | 3,100 |
| AddFI | 89,814 <span style="color: red">(+1,457 [+1.6%])</span> | 2,877 <span style="color: red">(+47 [+1.7%])</span> |
| MulVI | 80,800 | 2,604 |
| MulF | 68,343 | 2,204 |
| IfNe | 138,840 | 2,136 |
| ImmE | 134,096 | 2,008 |
...
Flamegraphs: [link](https://github.com/axiom-crypto/afs-prototype/actions/runs/11132461367/artifacts/2002766028)
