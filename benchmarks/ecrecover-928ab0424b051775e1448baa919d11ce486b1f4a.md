...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,920 |  42,920 |  42,920 |  42,920 |
| `main_cells_used     ` |  440,558,376 |  440,558,376 |  440,558,376 |  440,558,376 |
| `total_cycles        ` |  9,663,304 |  9,663,304 |  9,663,304 |  9,663,304 |
| `execute_time_ms     ` |  2,753 |  2,753 |  2,753 |  2,753 |
| `trace_gen_time_ms   ` |  7,289 |  7,289 |  7,289 |  7,289 |
| `stark_prove_excluding_trace_time_ms` |  32,878 |  32,878 |  32,878 |  32,878 |
| `main_trace_commit_time_ms` |  6,338 |  6,338 |  6,338 |  6,338 |
| `generate_perm_trace_time_ms` |  744 |  744 |  744 |  744 |
| `perm_trace_commit_time_ms` |  6,258 |  6,258 |  6,258 |  6,258 |
| `quotient_poly_compute_time_ms` |  7,875 |  7,875 |  7,875 |  7,875 |
| `quotient_poly_commit_time_ms` |  5,241 |  5,241 |  5,241 |  5,241 |
| `pcs_opening_time_ms ` |  6,419 |  6,419 |  6,419 |  6,419 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,289 | 42,920 | 9,663,304 | 1,069,222,360 | 32,878 | 7,875 | 5,241 | 6,258 | 6,419 | 6,338 | 440,558,376 | 744 | 2,753 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,603 | 285,401 | 56,172,159 | 2,189 | 294 | 305 | 533 | 620 | 392 | 15,092,297 | 42 | 148 | 
