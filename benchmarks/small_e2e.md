...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-26.0 [-0.2%])</span> <div style='text-align: right'>17,214.0</div>  | <div style='text-align: right'>20,200,816</div>  | <div style='text-align: right'>2,243,381</div>  | <span style="color: green">(-29.0 [-0.2%])</span> <div style='text-align: right'>17,282.0</div>  | <span style="color: green">(-3.0 [-4.2%])</span> <div style='text-align: right'>68.0</div>  |  |
| inner_verifier | <span style="color: red">(+531.0 [+0.6%])</span> <div style='text-align: right'>89,795.0</div>  | <div style='text-align: right'>734,396,436</div>  | <span style="color: green">(-25,796 [-0.0%])</span> <div style='text-align: right'>401,910,974</div>  | <span style="color: red">(+144.0 [+0.1%])</span> <div style='text-align: right'>118,332.0</div>  | <span style="color: green">(-387.0 [-1.3%])</span> <div style='text-align: right'>28,537.0</div>  | <span style="color: green">(-647.0 [-1.4%])</span> <div style='text-align: right'>45,838.0</div>  |
...
| inner_verifier | Core | <span style="color: green">(-391 [-0.0%])</span> <div style='text-align: right'>3,933,023</div>  |
| inner_verifier | FieldArithmetic | <span style="color: red">(+5 [+0.0%])</span> <div style='text-align: right'>1,661,982</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>846,158</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-8 [-0.0%])</span> <div style='text-align: right'>1,963,425</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-4 [-0.0%])</span> <div style='text-align: right'>981,757</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+5 [+0.0%])</span> <div style='text-align: right'>14,624</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-391 [-3.1%])</span> <div style='text-align: right'>12,033</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-44 [-0.0%])</span> <div style='text-align: right'>378,070</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-26 [-0.0%])</span> <div style='text-align: right'>223,405</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>1,132,096</div>  |
| inner_verifier | <NativeAdapterAir,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+150 [+0.0%])</span> <div style='text-align: right'>438,720</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: green">(-25,806 [-3.1%])</span> <div style='text-align: right'>794,178</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-44 [-0.0%])</span> <div style='text-align: right'>499,928</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-26 [-0.0%])</span> <div style='text-align: right'>295,412</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/316097f60c381c515dec0cda5573f3b3191678f9/small_e2e.dsl_ir.opcode.frequency.svg)
