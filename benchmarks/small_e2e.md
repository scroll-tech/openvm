...
| --- | --- | --- | --- | --- | --- |
| bench_program_inner | 1,212.0 <span style="color: green">(-6.0 [-0.5%])</span> | 1,915,713 | 277,352 | 2.0 |  |
| inner_verifier | 67,582.0 <span style="color: green">(-100.0 [-0.1%])</span> | 716,898,324 | 388,519,941 <span style="color: green">(-24,405 [-0.0%])</span> | 32,896.0 <span style="color: green">(-147.0 [-0.4%])</span> | 47,425.0 <span style="color: green">(-14.0 [-0.0%])</span> |
...
| inner_verifier | Core | 3,795,594 <span style="color: green">(-356 [-0.0%])</span> |
| inner_verifier | FieldArithmetic | 1,556,255 <span style="color: green">(-9 [-0.0%])</span> |
| inner_verifier | FieldExtension | 843,315 |
| inner_verifier | Memory | 622,695 |
| inner_verifier | Memory 2 | 1,941,891 <span style="color: green">(-36 [-0.0%])</span> |
| inner_verifier | Memory 3 | 971,011 <span style="color: green">(-18 [-0.0%])</span> |
...
| inner_verifier | AddFI | ADD | 12,443 <span style="color: green">(-9 [-0.1%])</span> |
...
| inner_verifier | IfEqI | JAL | 8,534 <span style="color: green">(-356 [-4.0%])</span> |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | 361,548 <span style="color: green">(-198 [-0.1%])</span> |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | 213,642 <span style="color: green">(-117 [-0.1%])</span> |
...
| inner_verifier | FieldArithmeticAir | AddFI | ADD | 385,733 <span style="color: green">(-279 [-0.1%])</span> |
...
| inner_verifier | CoreAir | IfEqI | JAL | 563,244 <span style="color: green">(-23,496 [-4.0%])</span> |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | 510,202 <span style="color: green">(-198 [-0.0%])</span> |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | 301,483 <span style="color: green">(-117 [-0.0%])</span> |
