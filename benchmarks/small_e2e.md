...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+83.0 [+0.5%])</span> <div style='text-align: right'>17,229.0</div>  | <div style='text-align: right'>20,200,816</div>  | <div style='text-align: right'>2,243,381</div>  | <span style="color: red">(+83.0 [+0.5%])</span> <div style='text-align: right'>17,298.0</div>  | <div style='text-align: right'>69.0</div>  |  |
| inner_verifier | <span style="color: red">(+73.0 [+0.1%])</span> <div style='text-align: right'>87,219.0</div>  | <div style='text-align: right'>734,396,436</div>  | <span style="color: red">(+162 [+0.0%])</span> <div style='text-align: right'>401,893,363</div>  | <span style="color: red">(+123.0 [+0.1%])</span> <div style='text-align: right'>120,356.0</div>  | <span style="color: red">(+50.0 [+0.2%])</span> <div style='text-align: right'>33,137.0</div>  | <span style="color: green">(-166.0 [-0.4%])</span> <div style='text-align: right'>45,558.0</div>  |
...
| inner_verifier | Core | <span style="color: red">(+17 [+0.0%])</span> <div style='text-align: right'>3,932,692</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-18 [-0.0%])</span> <div style='text-align: right'>1,661,968</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>846,158</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-24 [-0.0%])</span> <div style='text-align: right'>1,963,691</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-12 [-0.0%])</span> <div style='text-align: right'>981,890</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-18 [-0.1%])</span> <div style='text-align: right'>14,610</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+17 [+0.1%])</span> <div style='text-align: right'>11,702</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-132 [-0.0%])</span> <div style='text-align: right'>377,674</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-78 [-0.0%])</span> <div style='text-align: right'>223,171</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>1,132,096</div>  |
| inner_verifier | <NativeAdapterAir,FieldArithmeticCoreAir> | AddFI | ADD | <div style='text-align: right'>438,300</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: red">(+1,122 [+0.1%])</span> <div style='text-align: right'>772,332</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-132 [-0.0%])</span> <div style='text-align: right'>500,676</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-78 [-0.0%])</span> <div style='text-align: right'>295,854</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/a97aff22a6ecdaf398bbce57fcccacf305900566/small_e2e.dsl_ir.opcode.frequency.svg)
