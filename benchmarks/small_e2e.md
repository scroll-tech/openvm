...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-3.0 [-0.2%])</span> <div style='text-align: right'>1,389.0</div>  | <div style='text-align: right'>1,914,732</div>  | <div style='text-align: right'>276,045</div>  | <span style="color: green">(-2.0 [-0.1%])</span> <div style='text-align: right'>1,409.0</div>  | <span style="color: red">(+1.0 [+5.3%])</span> <div style='text-align: right'>20.0</div>  |  |
| inner_verifier | <span style="color: green">(-219.0 [-0.3%])</span> <div style='text-align: right'>82,579.0</div>  | <div style='text-align: right'>654,376,984</div>  | <span style="color: green">(-3,320 [-0.0%])</span> <div style='text-align: right'>274,710,307</div>  | <span style="color: green">(-78.0 [-0.1%])</span> <div style='text-align: right'>92,242.0</div>  | <span style="color: red">(+141.0 [+1.5%])</span> <div style='text-align: right'>9,663.0</div>  | <span style="color: green">(-291.0 [-0.7%])</span> <div style='text-align: right'>42,420.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-13 [-0.0%])</span> <div style='text-align: right'>1,603,986</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>862,812</div>  |
| inner_verifier | Jal | <span style="color: green">(-188 [-0.6%])</span> <div style='text-align: right'>29,647</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>2,950,358</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-60 [-0.0%])</span> <div style='text-align: right'>1,987,263</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-30 [-0.0%])</span> <div style='text-align: right'>993,675</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-13 [-0.1%])</span> <div style='text-align: right'>14,031</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-188 [-2.0%])</span> <div style='text-align: right'>9,375</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-330 [-0.1%])</span> <div style='text-align: right'>379,390</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-195 [-0.1%])</span> <div style='text-align: right'>224,185</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>654,192</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-390 [-0.1%])</span> <div style='text-align: right'>420,930</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-1,880 [-2.0%])</span> <div style='text-align: right'>93,750</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-330 [-0.1%])</span> <div style='text-align: right'>498,080</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-195 [-0.1%])</span> <div style='text-align: right'>294,320</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2255739aeadc536f9a4d0ba4387dcc4dc420fea1/small_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/2255739aeadc536f9a4d0ba4387dcc4dc420fea1
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11523653725)
