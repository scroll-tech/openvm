...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-10.0 [-0.1%])</span> <div style='text-align: right'>17,164.0</div>  | <div style='text-align: right'>20,200,833</div>  | <span style="color: green">(-65,536 [-2.8%])</span> <div style='text-align: right'>2,243,395</div>  | <span style="color: green">(-10.0 [-0.1%])</span> <div style='text-align: right'>17,232.0</div>  | <div style='text-align: right'>68.0</div>  |  |
| inner_verifier | <span style="color: red">(+153.0 [+0.2%])</span> <div style='text-align: right'>87,067.0</div>  | <div style='text-align: right'>737,542,164</div>  | <span style="color: green">(-116,660 [-0.0%])</span> <div style='text-align: right'>404,502,314</div>  | <span style="color: green">(-5,137.0 [-4.2%])</span> <div style='text-align: right'>115,857.0</div>  | <span style="color: green">(-5,290.0 [-15.5%])</span> <div style='text-align: right'>28,790.0</div>  | <span style="color: red">(+322.0 [+0.7%])</span> <div style='text-align: right'>47,362.0</div>  |
...
| inner_verifier | Core | <span style="color: green">(-758 [-0.0%])</span> <div style='text-align: right'>3,933,549</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-6 [-0.0%])</span> <div style='text-align: right'>1,662,309</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>846,468</div>  |
| inner_verifier | MemoryChip AccessAdapter<2> | <div style='text-align: right'>1,964,269</div>  |
| inner_verifier | MemoryChip AccessAdapter<4> | <div style='text-align: right'>982,200</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-6 [-0.0%])</span> <div style='text-align: right'>14,601</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-758 [-6.4%])</span> <div style='text-align: right'>11,154</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-286 [-0.1%])</span> <div style='text-align: right'>376,794</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-169 [-0.1%])</span> <div style='text-align: right'>222,651</div>  |
...
| inner_verifier | FieldArithmeticAir | AddFI | ADD | <span style="color: green">(-186 [-0.0%])</span> <div style='text-align: right'>452,631</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: green">(-50,028 [-6.4%])</span> <div style='text-align: right'>736,164</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-286 [-0.1%])</span> <div style='text-align: right'>500,720</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-169 [-0.1%])</span> <div style='text-align: right'>295,880</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/562793264f9a3c95007568e0ef900d3a07c7ed31/small_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/562793264f9a3c95007568e0ef900d3a07c7ed31
AWS Instance Type: [r7g.16xlarge](https://instances.vantage.sh/aws/ec2/r7g.16xlarge)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11309185411)
