...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+76.0 [+0.4%])</span> <div style='text-align: right'>17,283.0</div>  | <div style='text-align: right'>20,200,833</div>  | <div style='text-align: right'>2,243,395</div>  | <span style="color: red">(+77.0 [+0.4%])</span> <div style='text-align: right'>17,352.0</div>  | <span style="color: red">(+1.0 [+1.5%])</span> <div style='text-align: right'>69.0</div>  |  |
| inner_verifier | <span style="color: red">(+949.0 [+1.1%])</span> <div style='text-align: right'>88,091.0</div>  | <div style='text-align: right'>737,542,164</div>  | <span style="color: green">(-35,116 [-0.0%])</span> <div style='text-align: right'>404,477,781</div>  | <span style="color: red">(+904.0 [+0.8%])</span> <div style='text-align: right'>116,848.0</div>  | <span style="color: green">(-45.0 [-0.2%])</span> <div style='text-align: right'>28,757.0</div>  | <span style="color: green">(-357.0 [-0.8%])</span> <div style='text-align: right'>47,231.0</div>  |
...
| inner_verifier | Core | <span style="color: green">(-509 [-0.0%])</span> <div style='text-align: right'>3,933,186</div>  |
| inner_verifier | FieldArithmetic | <span style="color: green">(-22 [-0.0%])</span> <div style='text-align: right'>1,662,304</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>846,468</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: green">(-48 [-0.0%])</span> <div style='text-align: right'>1,964,245</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: green">(-24 [-0.0%])</span> <div style='text-align: right'>982,188</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-22 [-0.2%])</span> <div style='text-align: right'>14,596</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-509 [-4.5%])</span> <div style='text-align: right'>10,791</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: green">(-264 [-0.1%])</span> <div style='text-align: right'>376,662</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: green">(-156 [-0.1%])</span> <div style='text-align: right'>222,573</div>  |
...
| inner_verifier | FieldArithmeticAir | AddFI | ADD | <span style="color: green">(-682 [-0.2%])</span> <div style='text-align: right'>452,476</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: green">(-33,594 [-4.5%])</span> <div style='text-align: right'>712,206</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: green">(-264 [-0.1%])</span> <div style='text-align: right'>500,588</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: green">(-156 [-0.1%])</span> <div style='text-align: right'>295,802</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef/small_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/7e5e4aa39b0f03603fb55ffaaf39c611e381d1ef
AWS Instance Type: [r7g.16xlarge](https://instances.vantage.sh/aws/ec2/r7g.16xlarge)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11352813206)
