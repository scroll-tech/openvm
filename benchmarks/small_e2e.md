...
| --- | --- | --- | --- | --- | --- |
| bench_program_inner | 1,206.0 <span style="color: red">(+4.0 [+0.3%])</span> | 1,915,681 | 277,324 | 2.0 |  |
| inner_verifier | 67,675.0 <span style="color: green">(-14.0 [-0.0%])</span> | 712,704,020 | 384,717,253 <span style="color: red">(+52,455 [+0.0%])</span> | 22,360.0 <span style="color: red">(+26.0 [+0.1%])</span> | 45,852.0 <span style="color: red">(+242.0 [+0.5%])</span> |
...
| inner_verifier | Core | 3,795,960 <span style="color: red">(+780 [+0.0%])</span> |
| inner_verifier | FieldArithmetic | 1,556,041 <span style="color: red">(+25 [+0.0%])</span> |
| inner_verifier | FieldExtension | 843,140 |
| inner_verifier | Memory | 622,614 |
| inner_verifier | Memory 2 | 1,941,563 <span style="color: red">(+56 [+0.0%])</span> |
| inner_verifier | Memory 3 | 970,826 <span style="color: red">(+28 [+0.0%])</span> |
...
| inner_verifier | FADD | 35,979,453 <span style="color: red">(+1,265 [+0.0%])</span> | 1,102,336 <span style="color: red">(+25 [+0.0%])</span> |
| inner_verifier | BNE | 44,154,130 | 679,276 |
| inner_verifier | BBE4MUL | 19,391,931 <span style="color: red">(+490 [+0.0%])</span> | 410,568 |
...
| inner_verifier | JAL | 1,830,161 <span style="color: red">(+50,700 [+2.8%])</span> | 28,142 <span style="color: red">(+780 [+2.9%])</span> |
...
| inner_verifier | MulE | 18,833,596 <span style="color: red">(+490 [+0.0%])</span> | 408,006 |
...
| inner_verifier | IfEqI | 8,504,990 <span style="color: red">(+50,700 [+0.6%])</span> | 130,846 <span style="color: red">(+780 [+0.6%])</span> |
...
| inner_verifier | AddEI | 3,822,977 <span style="color: red">(+490 [+0.0%])</span> | 66,780 |
...
| inner_verifier | AddFI | 389,777 <span style="color: red">(+775 [+0.2%])</span> | 12,476 <span style="color: red">(+25 [+0.2%])</span> |
...
Flamegraphs: [link](https://github.com/axiom-crypto/afs-prototype/actions/runs/11112471650/artifacts/1997260414)
