...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: green">(-37.0 [-0.2%])</span> <div style='text-align: right'>17,166.0</div>  | <div style='text-align: right'>20,200,816</div>  | <div style='text-align: right'>2,243,381</div>  | <span style="color: green">(-37.0 [-0.2%])</span> <div style='text-align: right'>17,235.0</div>  | <div style='text-align: right'>69.0</div>  |  |
| inner_verifier | <span style="color: red">(+232.0 [+0.3%])</span> <div style='text-align: right'>87,222.0</div>  | <div style='text-align: right'>734,396,436</div>  | <span style="color: red">(+27,470 [+0.0%])</span> <div style='text-align: right'>401,894,017</div>  | <span style="color: red">(+230.0 [+0.2%])</span> <div style='text-align: right'>116,565.0</div>  | <span style="color: green">(-2.0 [-0.0%])</span> <div style='text-align: right'>29,343.0</div>  | <span style="color: red">(+365.0 [+0.8%])</span> <div style='text-align: right'>47,417.0</div>  |
...
| inner_verifier | Core | <span style="color: red">(+410 [+0.0%])</span> <div style='text-align: right'>3,932,706</div>  |
| inner_verifier | FieldArithmetic | <span style="color: red">(+9 [+0.0%])</span> <div style='text-align: right'>1,661,980</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>846,158</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>1,963,655</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+4 [+0.0%])</span> <div style='text-align: right'>981,872</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: red">(+9 [+0.1%])</span> <div style='text-align: right'>14,622</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: red">(+410 [+3.6%])</span> <div style='text-align: right'>11,716</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+44 [+0.0%])</span> <div style='text-align: right'>377,476</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+26 [+0.0%])</span> <div style='text-align: right'>223,054</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>1,132,096</div>  |
| inner_verifier | <NativeAdapterAir,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: red">(+270 [+0.1%])</span> <div style='text-align: right'>438,660</div>  |
...
| inner_verifier | CoreAir | IfEqI | JAL | <span style="color: red">(+27,060 [+3.6%])</span> <div style='text-align: right'>773,256</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+44 [+0.0%])</span> <div style='text-align: right'>500,478</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+26 [+0.0%])</span> <div style='text-align: right'>295,737</div>  |
...
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-staging-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d4e861352bd27e976e7903f975378a97a2a38ccd/small_e2e.dsl_ir.opcode.frequency.svg)
