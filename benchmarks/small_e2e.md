...
| --- | --- | --- | --- | --- | --- | --- |
| bench_program_inner | <span style="color: red">(+1.0 [+0.1%])</span> <div style='text-align: right'>1,429.0</div>  | <div style='text-align: right'>1,980,240</div>  | <div style='text-align: right'>341,581</div>  | <span style="color: red">(+1.0 [+0.1%])</span> <div style='text-align: right'>1,448.0</div>  | <div style='text-align: right'>19.0</div>  |  |
| inner_verifier | <span style="color: red">(+1,103.0 [+1.3%])</span> <div style='text-align: right'>83,001.0</div>  | <div style='text-align: right'>651,755,544</div>  | <span style="color: green">(-3,200 [-0.0%])</span> <div style='text-align: right'>270,740,041</div>  | <span style="color: red">(+1,310.0 [+1.4%])</span> <div style='text-align: right'>93,125.0</div>  | <span style="color: red">(+207.0 [+2.1%])</span> <div style='text-align: right'>10,124.0</div>  | <span style="color: green">(-217.0 [-0.5%])</span> <div style='text-align: right'>43,051.0</div>  |
...
| inner_verifier | FieldArithmetic | <span style="color: green">(-2 [-0.0%])</span> <div style='text-align: right'>1,595,221</div>  |
| inner_verifier | FieldExtension | <div style='text-align: right'>857,974</div>  |
| inner_verifier | Jal | <span style="color: green">(-342 [-1.2%])</span> <div style='text-align: right'>29,151</div>  |
| inner_verifier | LoadStore | <div style='text-align: right'>2,928,722</div>  |
| inner_verifier | Memory AccessAdapter<2> | <span style="color: red">(+16 [+0.0%])</span> <div style='text-align: right'>1,976,515</div>  |
| inner_verifier | Memory AccessAdapter<4> | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>988,301</div>  |
...
| inner_verifier | AddFI | ADD | <span style="color: green">(-2 [-0.0%])</span> <div style='text-align: right'>14,052</div>  |
...
| inner_verifier | IfEqI | JAL | <span style="color: green">(-342 [-3.6%])</span> <div style='text-align: right'>9,268</div>  |
...
| inner_verifier | AccessAdapter<2> | AddEI | ADD | <span style="color: red">(+88 [+0.0%])</span> <div style='text-align: right'>381,612</div>  |
| inner_verifier | AccessAdapter<4> | AddEI | ADD | <span style="color: red">(+52 [+0.0%])</span> <div style='text-align: right'>225,498</div>  |
| inner_verifier | Boundary | AddEI | ADD | <div style='text-align: right'>660,220</div>  |
| inner_verifier | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | AddFI | ADD | <span style="color: green">(-60 [-0.0%])</span> <div style='text-align: right'>421,560</div>  |
...
| inner_verifier | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | <span style="color: green">(-3,420 [-3.6%])</span> <div style='text-align: right'>92,680</div>  |
...
| inner_verifier | AccessAdapter<2> | MulE | BBE4MUL | <span style="color: red">(+88 [+0.0%])</span> <div style='text-align: right'>495,968</div>  |
| inner_verifier | AccessAdapter<4> | MulE | BBE4MUL | <span style="color: red">(+52 [+0.0%])</span> <div style='text-align: right'>293,072</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7/small_e2e.dsl_ir.opcode.frequency.svg)
Commit: https://github.com/axiom-crypto/afs-prototype/commit/66662a6b4cf6aa0a27c48c9ac892eafccee5b3f7
AWS Instance Type: [64cpu-linux-arm64](https://instances.vantage.sh/aws/ec2/64cpu-linux-arm64)
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11566984251)
