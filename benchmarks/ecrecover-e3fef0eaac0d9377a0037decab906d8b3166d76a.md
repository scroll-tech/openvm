...
| `execute_time_ms     ` |  167 |  167 |  167 |  167 |
| `trace_gen_time_ms   ` |  275 |  275 |  275 |  275 |
| `stark_prove_excluding_trace_time_ms` |  2,171 |  2,171 |  2,171 |  2,171 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,154 |  43,154 |  43,154 |  43,154 |
| `main_cells_used     ` |  439,956,541 |  439,956,541 |  439,956,541 |  439,956,541 |
| `total_cycles        ` |  9,648,337 |  9,648,337 |  9,648,337 |  9,648,337 |
| `execute_time_ms     ` |  3,318 |  3,318 |  3,318 |  3,318 |
| `trace_gen_time_ms   ` |  8,143 |  8,143 |  8,143 |  8,143 |
| `stark_prove_excluding_trace_time_ms` |  31,693 |  31,693 |  31,693 |  31,693 |
| `main_trace_commit_time_ms` |  5,862 |  5,862 |  5,862 |  5,862 |
| `generate_perm_trace_time_ms` |  786 |  786 |  786 |  786 |
| `perm_trace_commit_time_ms` |  5,805 |  5,805 |  5,805 |  5,805 |
| `quotient_poly_compute_time_ms` |  8,081 |  8,081 |  8,081 |  8,081 |
| `quotient_poly_commit_time_ms` |  4,894 |  4,894 |  4,894 |  4,894 |
| `pcs_opening_time_ms ` |  6,263 |  6,263 |  6,263 |  6,263 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,143 | 43,154 | 9,648,337 | 1,069,222,360 | 31,693 | 8,081 | 4,894 | 5,805 | 6,263 | 5,862 | 439,956,541 | 786 | 3,318 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 275 | 2,613 | 285,169 | 56,159,799 | 2,171 | 263 | 307 | 525 | 638 | 391 | 15,074,875 | 43 | 167 | 
