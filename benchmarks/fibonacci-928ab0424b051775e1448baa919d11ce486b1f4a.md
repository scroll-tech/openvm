...
| `stark_prove_excluding_trace_time_ms` |  4,970 |  4,970 |  4,970 |  4,970 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,266 |  15,266 |  15,266 |  15,266 |
| `main_cells_used     ` |  128,865,487 |  128,865,487 |  128,865,487 |  128,865,487 |
| `total_cycles        ` |  3,172,014 |  3,172,014 |  3,172,014 |  3,172,014 |
| `execute_time_ms     ` |  700 |  700 |  700 |  700 |
| `trace_gen_time_ms   ` |  2,020 |  2,020 |  2,020 |  2,020 |
| `stark_prove_excluding_trace_time_ms` |  12,546 |  12,546 |  12,546 |  12,546 |
| `main_trace_commit_time_ms` |  2,496 |  2,496 |  2,496 |  2,496 |
| `generate_perm_trace_time_ms` |  322 |  322 |  322 |  322 |
| `perm_trace_commit_time_ms` |  2,133 |  2,133 |  2,133 |  2,133 |
| `quotient_poly_compute_time_ms` |  2,999 |  2,999 |  2,999 |  2,999 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,020 | 15,266 | 3,172,014 | 369,494,488 | 12,546 | 2,999 | 2,152 | 2,133 | 2,441 | 2,496 | 128,865,487 | 322 | 700 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 822 | 6,103 | 1,500,137 | 197,453,854 | 4,970 | 792 | 506 | 1,601 | 1,089 | 801 | 51,505,102 | 178 | 311 | 
