...
| `stark_prove_excluding_trace_time_ms` |  2,213 |  2,213 |  2,213 |  2,213 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,072 |  42,072 |  42,072 |  42,072 |
| `main_cells_used     ` |  440,557,216 |  440,557,216 |  440,557,216 |  440,557,216 |
| `total_cycles        ` |  9,663,286 |  9,663,286 |  9,663,286 |  9,663,286 |
| `execute_time_ms     ` |  2,726 |  2,726 |  2,726 |  2,726 |
| `trace_gen_time_ms   ` |  7,093 |  7,093 |  7,093 |  7,093 |
| `stark_prove_excluding_trace_time_ms` |  32,253 |  32,253 |  32,253 |  32,253 |
| `main_trace_commit_time_ms` |  6,270 |  6,270 |  6,270 |  6,270 |
| `generate_perm_trace_time_ms` |  742 |  742 |  742 |  742 |
| `perm_trace_commit_time_ms` |  6,295 |  6,295 |  6,295 |  6,295 |
| `quotient_poly_compute_time_ms` |  7,376 |  7,376 |  7,376 |  7,376 |
| `quotient_poly_commit_time_ms` |  5,071 |  5,071 |  5,071 |  5,071 |
| `pcs_opening_time_ms ` |  6,497 |  6,497 |  6,497 |  6,497 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,093 | 42,072 | 9,663,286 | 1,069,222,360 | 32,253 | 7,376 | 5,071 | 6,295 | 6,497 | 6,270 | 440,557,216 | 742 | 2,726 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,628 | 285,401 | 56,172,159 | 2,213 | 303 | 307 | 530 | 635 | 392 | 15,092,297 | 44 | 149 | 
