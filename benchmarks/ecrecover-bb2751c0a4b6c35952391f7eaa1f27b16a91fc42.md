...
| `stark_prove_excluding_trace_time_ms` |  2,374 |  2,374 |  2,374 |  2,374 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,522 |  42,522 |  42,522 |  42,522 |
| `main_cells_used     ` |  445,643,808 |  445,643,808 |  445,643,808 |  445,643,808 |
| `total_cycles        ` |  9,779,416 |  9,779,416 |  9,779,416 |  9,779,416 |
| `execute_time_ms     ` |  5,492 |  5,492 |  5,492 |  5,492 |
| `trace_gen_time_ms   ` |  2,100 |  2,100 |  2,100 |  2,100 |
| `stark_prove_excluding_trace_time_ms` |  34,930 |  34,930 |  34,930 |  34,930 |
| `main_trace_commit_time_ms` |  6,279 |  6,279 |  6,279 |  6,279 |
| `generate_perm_trace_time_ms` |  792 |  792 |  792 |  792 |
| `perm_trace_commit_time_ms` |  6,157 |  6,157 |  6,157 |  6,157 |
| `quotient_poly_compute_time_ms` |  8,121 |  8,121 |  8,121 |  8,121 |
| `quotient_poly_commit_time_ms` |  5,152 |  5,152 |  5,152 |  5,152 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,100 | 42,522 | 9,779,416 | 1,069,222,360 | 34,930 | 8,121 | 5,152 | 6,157 | 8,425 | 6,279 | 445,643,808 | 792 | 5,492 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 75 | 2,745 | 290,016 | 55,907,135 | 2,374 | 274 | 311 | 526 | 811 | 406 | 15,230,037 | 44 | 296 | 
