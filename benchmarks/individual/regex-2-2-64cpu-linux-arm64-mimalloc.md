...
| --- | --- | --- | --- | --- |
| regex_program | <div style='text-align: right'>2</div>  | <span style="color: green">(-6,650 [-0.0%])</span> <div style='text-align: right'>160,101,856</div>  | <span style="color: green">(-155 [-0.0%])</span> <div style='text-align: right'>4,190,890</div>  | <span style="color: red">(+130.0 [+0.4%])</span> <div style='text-align: right'>30,628.0</div>  |
| leaf_aggregation | <div style='text-align: right'>2</div>  | <span style="color: red">(+18,320 [+0.0%])</span> <div style='text-align: right'>309,549,081</div>  | <span style="color: red">(+1,738 [+0.0%])</span> <div style='text-align: right'>7,303,019</div>  | <span style="color: green">(-711.0 [-1.6%])</span> <div style='text-align: right'>44,301.0</div>  |
...
| --- | --- | --- | --- | --- |
| regex_program | true | <span style="color: red">(+1,261.0 [+1.1%])</span> <div style='text-align: right'>115,285.0</div>  | <span style="color: green">(-6,650 [-0.0%])</span> <div style='text-align: right'>160,101,856</div>  | <span style="color: green">(-155 [-0.0%])</span> <div style='text-align: right'>4,190,890</div>  |

| group | chip_name | collect_metrics | rows_used |
| --- | --- | --- | --- |
| regex_program | <Rv32BaseAluAdapterAir,BaseAluCoreAir<4, 8>> | true | <span style="color: green">(-20 [-0.0%])</span> <div style='text-align: right'>1,150,469</div>  |
...
| regex_program | <Rv32JalrAdapterAir,Rv32JalrCoreAir> | true | <span style="color: green">(-14 [-0.0%])</span> <div style='text-align: right'>130,443</div>  |
| regex_program | <Rv32LoadStoreAdapterAir,LoadSignExtendCoreAir<4, 8>> | true | <div style='text-align: right'>687</div>  |
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true | <span style="color: green">(-114 [-0.0%])</span> <div style='text-align: right'>1,961,380</div>  |
...
| regex_program | <Rv32RdWriteAdapterAir,Rv32AuipcCoreAir> | true | <span style="color: green">(-7 [-0.0%])</span> <div style='text-align: right'>39,556</div>  |
...
| regex_program | Memory Merkle | true | <span style="color: green">(-8 [-0.0%])</span> <div style='text-align: right'>70,522</div>  |
| regex_program | PhantomAir | true | <div style='text-align: right'>289</div>  |
| regex_program | ProgramChip | true | <span style="color: green">(-575 [-0.6%])</span> <div style='text-align: right'>89,489</div>  |
| regex_program | RangeTupleCheckerAir<2> | true | <div style='text-align: right'>524,288</div>  |

| group | collect_metrics | dsl_ir | opcode | frequency |
| --- | --- | --- | --- | --- |
| regex_program | true |  | ADD | <span style="color: green">(-20 [-0.0%])</span> <div style='text-align: right'>1,007,997</div>  |
| regex_program | true |  | AND | <div style='text-align: right'>66,789</div>  |
| regex_program | true |  | AUIPC | <span style="color: green">(-7 [-0.0%])</span> <div style='text-align: right'>39,556</div>  |
...
| regex_program | true |  | JALR | <span style="color: green">(-14 [-0.0%])</span> <div style='text-align: right'>130,443</div>  |
...
| regex_program | true |  | LOADW | <span style="color: green">(-56 [-0.0%])</span> <div style='text-align: right'>1,142,834</div>  |
...
| regex_program | true |  | STOREW | <span style="color: green">(-58 [-0.0%])</span> <div style='text-align: right'>768,362</div>  |
...
| --- | --- | --- | --- | --- | --- |
| regex_program | <Rv32BaseAluAdapterAir,BaseAluCoreAir<4, 8>> | true |  | ADD | <span style="color: green">(-720 [-0.0%])</span> <div style='text-align: right'>36,287,892</div>  |
...
| regex_program | <Rv32RdWriteAdapterAir,Rv32AuipcCoreAir> | true |  | AUIPC | <span style="color: green">(-147 [-0.0%])</span> <div style='text-align: right'>830,676</div>  |
...
| regex_program | Merkle | true |  | HINT_STOREW | <span style="color: red">(+256 [+0.1%])</span> <div style='text-align: right'>408,704</div>  |
| regex_program | <Rv32CondRdWriteAdapterAir,Rv32JalLuiCoreAir> | true |  | JAL | <div style='text-align: right'>1,108,350</div>  |
| regex_program | <Rv32JalrAdapterAir,Rv32JalrCoreAir> | true |  | JALR | <span style="color: green">(-392 [-0.0%])</span> <div style='text-align: right'>3,652,404</div>  |
...
| regex_program | AccessAdapter<8> | true |  | LOADBU | <span style="color: green">(-34 [-18.2%])</span> <div style='text-align: right'>153</div>  |
| regex_program | Boundary | true |  | LOADBU | <span style="color: green">(-80 [-18.2%])</span> <div style='text-align: right'>360</div>  |
| regex_program | Merkle | true |  | LOADBU | <span style="color: red">(+128 [+6.2%])</span> <div style='text-align: right'>2,176</div>  |
...
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true |  | LOADW | <span style="color: green">(-2,240 [-0.0%])</span> <div style='text-align: right'>45,713,360</div>  |
...
| regex_program | Merkle | true |  | LOADW | <span style="color: green">(-192 [-0.8%])</span> <div style='text-align: right'>24,768</div>  |
...
| regex_program | Merkle | true |  | STOREB | <span style="color: green">(-896 [-7.1%])</span> <div style='text-align: right'>11,776</div>  |
...
| regex_program | Merkle | true |  | STOREH | <span style="color: red">(+256 [+0.1%])</span> <div style='text-align: right'>321,280</div>  |
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true |  | STOREW | <span style="color: green">(-2,320 [-0.0%])</span> <div style='text-align: right'>30,734,480</div>  |
...
| regex_program | Merkle | true |  | STOREW | <span style="color: red">(+192 [+0.0%])</span> <div style='text-align: right'>1,484,288</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | <span style="color: green">(-5.0 [-11.1%])</span> <div style='text-align: right'>40.0</div>  | <span style="color: red">(+9.0 [+0.1%])</span> <div style='text-align: right'>9,835.0</div>  | <span style="color: green">(-12.0 [-0.2%])</span> <div style='text-align: right'>7,338.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-8.0 [-3.7%])</span> <div style='text-align: right'>206.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-6,650 [-0.0%])</span> <div style='text-align: right'>160,101,856</div>  | <span style="color: green">(-155 [-0.0%])</span> <div style='text-align: right'>4,190,890</div>  | <span style="color: red">(+130.0 [+0.4%])</span> <div style='text-align: right'>30,628.0</div>  |
| leaf_aggregation |  |  |  | <div style='text-align: right'>2</div>  |  |  | <span style="color: red">(+18,320 [+0.0%])</span> <div style='text-align: right'>309,549,081</div>  | <span style="color: red">(+1,738 [+0.0%])</span> <div style='text-align: right'>7,303,019</div>  | <span style="color: green">(-711.0 [-1.6%])</span> <div style='text-align: right'>44,301.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 |  | <span style="color: red">(+20.0 [+0.8%])</span> <div style='text-align: right'>2,485.0</div>  |  |  |  |  | <span style="color: red">(+101.0 [+0.6%])</span> <div style='text-align: right'>18,308.0</div>  | <div style='text-align: right'>790,590,848</div>  |  |
| leaf_aggregation | 0 | <span style="color: red">(+10.0 [+5.5%])</span> <div style='text-align: right'>192.0</div>  | <span style="color: green">(-107.0 [-0.7%])</span> <div style='text-align: right'>14,632.0</div>  | <span style="color: green">(-89.0 [-0.7%])</span> <div style='text-align: right'>12,972.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+2.0 [+3.6%])</span> <div style='text-align: right'>58.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-604.0 [-2.0%])</span> <div style='text-align: right'>29,669.0</div>  | <div style='text-align: right'>806,027,288</div>  | <span style="color: green">(-80.0 [-0.2%])</span> <div style='text-align: right'>47,770.0</div>  |

| group | collect_metrics | segment | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- | --- |
| leaf_aggregation | true | 0 | <span style="color: green">(-486.0 [-0.4%])</span> <div style='text-align: right'>115,333.0</div>  | <span style="color: red">(+18,320 [+0.0%])</span> <div style='text-align: right'>309,549,081</div>  | <span style="color: red">(+1,738 [+0.0%])</span> <div style='text-align: right'>7,303,019</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | 0 | <span style="color: red">(+1,733 [+1.8%])</span> <div style='text-align: right'>98,570</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | 0 | <span style="color: red">(+5 [+0.0%])</span> <div style='text-align: right'>2,859,767</div>  |
...
| leaf_aggregation | Memory AccessAdapter<2> | true | 0 | <span style="color: red">(+48 [+0.0%])</span> <div style='text-align: right'>849,662</div>  |
| leaf_aggregation | Memory AccessAdapter<4> | true | 0 | <span style="color: red">(+24 [+0.0%])</span> <div style='text-align: right'>425,041</div>  |
...
| leaf_aggregation | true | AddFI | ADD | 0 | <span style="color: red">(+5 [+0.0%])</span> <div style='text-align: right'>79,874</div>  |
...
| leaf_aggregation | true | IfEqI | JAL | 0 | <span style="color: red">(+1,733 [+3.8%])</span> <div style='text-align: right'>47,875</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | AddEI | ADD | 0 | <span style="color: red">(+264 [+0.0%])</span> <div style='text-align: right'>611,490</div>  |
| leaf_aggregation | AccessAdapter<4> | true | AddEI | ADD | 0 | <span style="color: red">(+156 [+0.0%])</span> <div style='text-align: right'>361,335</div>  |
| leaf_aggregation | Boundary | true | AddEI | ADD | 0 | <div style='text-align: right'>708,752</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | 0 | <span style="color: red">(+150 [+0.0%])</span> <div style='text-align: right'>2,396,220</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | 0 | <span style="color: red">(+17,330 [+3.8%])</span> <div style='text-align: right'>478,750</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | MulE | BBE4MUL | 0 | <span style="color: red">(+264 [+0.0%])</span> <div style='text-align: right'>835,472</div>  |
| leaf_aggregation | AccessAdapter<4> | true | MulE | BBE4MUL | 0 | <span style="color: red">(+156 [+0.0%])</span> <div style='text-align: right'>493,688</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-leaf_aggregation.dsl_ir.opcode.frequency.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/6ddf6d0e838c80d989bf423597449a6f98f99ad1/regex-2-2-64cpu-linux-arm64-mimalloc-regex_program.dsl_ir.opcode.frequency.svg)
