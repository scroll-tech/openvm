...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,600 [-0.0%])</span> <div style='text-align: right'>48,124,947</div>  | <span style="color: green">(-208 [-0.1%])</span> <div style='text-align: right'>396,934</div>  | <span style="color: red">(+2.0 [+0.1%])</span> <div style='text-align: right'>3,163.0</div>  |
...
| --- | --- | --- | --- | --- | --- |
| <span style="color: red">(+1.0 [+12.5%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+2.0 [+0.6%])</span> <div style='text-align: right'>356.0</div>  | <span style="color: green">(-1.0 [-10.0%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <div style='text-align: right'>15.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+2.0 [+0.1%])</span> <div style='text-align: right'>3,163.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: green">(-1,600 [-0.0%])</span> <div style='text-align: right'>48,124,947</div>  | <span style="color: green">(-208 [-0.1%])</span> <div style='text-align: right'>396,934</div>  | <span style="color: green">(-24.0 [-2.4%])</span> <div style='text-align: right'>980.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: green">(-32 [-0.1%])</span> <div style='text-align: right'>58,124</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: green">(-16 [-0.0%])</span> <div style='text-align: right'>35,762</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-104 [-2.0%])</span> <div style='text-align: right'>4,989</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-104 [-2.0%])</span> <div style='text-align: right'>4,989</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: green">(-176 [-1.4%])</span> <div style='text-align: right'>12,617</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: green">(-104 [-1.3%])</span> <div style='text-align: right'>7,618</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: green">(-176 [-1.2%])</span> <div style='text-align: right'>14,806</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: green">(-104 [-1.2%])</span> <div style='text-align: right'>8,749</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-1,040 [-2.0%])</span> <div style='text-align: right'>49,890</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+22.0 [+3.6%])</span> <div style='text-align: right'>631.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,600 [-0.0%])</span> <div style='text-align: right'>48,124,947</div>  | <span style="color: green">(-208 [-0.1%])</span> <div style='text-align: right'>396,934</div>  | <span style="color: red">(+2.0 [+0.1%])</span> <div style='text-align: right'>3,163.0</div>  |
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/1ddb32208c0959ea370ab0b0d560feeda3a279db/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)
