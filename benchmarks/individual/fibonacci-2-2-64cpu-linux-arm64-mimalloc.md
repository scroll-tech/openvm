...
| --- | --- | --- | --- | --- |
| fibonacci_program | <div style='text-align: right'>2</div>  | <div style='text-align: right'>51,512,218</div>  | <div style='text-align: right'>1,500,219</div>  | <span style="color: red">(+27.0 [+0.4%])</span> <div style='text-align: right'>6,394.0</div>  |
| leaf_aggregation | <div style='text-align: right'>2</div>  | <span style="color: green">(-24,980 [-0.0%])</span> <div style='text-align: right'>143,341,990</div>  | <span style="color: green">(-2,295 [-0.1%])</span> <div style='text-align: right'>3,502,996</div>  | <span style="color: red">(+281.0 [+1.6%])</span> <div style='text-align: right'>17,887.0</div>  |
...
| --- | --- | --- | --- | --- |
| fibonacci_program | true | <span style="color: green">(-91.0 [-1.4%])</span> <div style='text-align: right'>6,425.0</div>  | <div style='text-align: right'>51,512,218</div>  | <div style='text-align: right'>1,500,219</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | <div style='text-align: right'>4.0</div>  | <div style='text-align: right'>1,230.0</div>  | <span style="color: green">(-2.0 [-0.2%])</span> <div style='text-align: right'>981.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>188.0</div>  | <div style='text-align: right'>1</div>  | <div style='text-align: right'>51,512,218</div>  | <div style='text-align: right'>1,500,219</div>  | <span style="color: red">(+27.0 [+0.4%])</span> <div style='text-align: right'>6,394.0</div>  |
| leaf_aggregation |  |  |  | <div style='text-align: right'>2</div>  |  |  | <span style="color: green">(-24,980 [-0.0%])</span> <div style='text-align: right'>143,341,990</div>  | <span style="color: green">(-2,295 [-0.1%])</span> <div style='text-align: right'>3,502,996</div>  | <span style="color: red">(+281.0 [+1.6%])</span> <div style='text-align: right'>17,887.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 |  | <span style="color: red">(+2.0 [+0.8%])</span> <div style='text-align: right'>248.0</div>  |  |  |  |  | <span style="color: red">(+25.0 [+0.5%])</span> <div style='text-align: right'>4,916.0</div>  | <div style='text-align: right'>196,595,668</div>  |  |
| leaf_aggregation | 0 | <span style="color: red">(+3.0 [+9.4%])</span> <div style='text-align: right'>35.0</div>  | <span style="color: green">(-45.0 [-1.0%])</span> <div style='text-align: right'>4,456.0</div>  | <span style="color: green">(-33.0 [-0.9%])</span> <div style='text-align: right'>3,652.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>41.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+326.0 [+2.5%])</span> <div style='text-align: right'>13,431.0</div>  | <div style='text-align: right'>398,753,816</div>  | <span style="color: red">(+3.0 [+1.3%])</span> <div style='text-align: right'>227.0</div>  |

| group | collect_metrics | segment | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- | --- |
| leaf_aggregation | true | 0 | <span style="color: green">(-112.0 [-0.6%])</span> <div style='text-align: right'>18,483.0</div>  | <span style="color: green">(-24,980 [-0.0%])</span> <div style='text-align: right'>143,341,990</div>  | <span style="color: green">(-2,295 [-0.1%])</span> <div style='text-align: right'>3,502,996</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | 0 | <span style="color: green">(-116 [-0.0%])</span> <div style='text-align: right'>400,844</div>  |
| leaf_aggregation | AccessAdapter<4> | true | 0 | <span style="color: green">(-58 [-0.0%])</span> <div style='text-align: right'>200,674</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | 0 | <span style="color: green">(-2,295 [-3.0%])</span> <div style='text-align: right'>73,284</div>  |
...
| leaf_aggregation | true | IfEqI | JAL | 0 | <span style="color: green">(-2,295 [-7.2%])</span> <div style='text-align: right'>29,395</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | AddEI | ADD | 0 | <span style="color: green">(-638 [-0.3%])</span> <div style='text-align: right'>189,420</div>  |
| leaf_aggregation | AccessAdapter<4> | true | AddEI | ADD | 0 | <span style="color: green">(-377 [-0.3%])</span> <div style='text-align: right'>111,930</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | 0 | <span style="color: green">(-22,950 [-7.2%])</span> <div style='text-align: right'>293,950</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-638 [-0.3%])</span> <div style='text-align: right'>228,580</div>  |
| leaf_aggregation | AccessAdapter<4> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-377 [-0.3%])</span> <div style='text-align: right'>135,070</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/e1becd62d7486acb6b6e365e33e6f9296dc1caf2/fibonacci-2-2-64cpu-linux-arm64-mimalloc-fibonacci_program.dsl_ir.opcode.frequency.svg)
