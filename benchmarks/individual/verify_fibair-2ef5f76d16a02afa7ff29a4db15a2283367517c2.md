...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+38,890 [+0.3%])</span> <div style='text-align: right'>14,595,230</div>  | <span style="color: green">(-78 [-0.0%])</span> <div style='text-align: right'>397,056</div>  | <span style="color: green">(-14.0 [-0.9%])</span> <div style='text-align: right'>1,529.0</div>  |
...
| --- | --- | --- | --- | --- | --- |
| <div style='text-align: right'>8.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+0.6%])</span> <div style='text-align: right'>177.0</div>  | <span style="color: green">(-2.0 [-18.2%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <div style='text-align: right'>15.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-14.0 [-0.9%])</span> <div style='text-align: right'>1,529.0</div>  | <div style='text-align: right'>42,000,416</div>  | <span style="color: red">(+38,890 [+0.3%])</span> <div style='text-align: right'>14,595,230</div>  | <span style="color: green">(-78 [-0.0%])</span> <div style='text-align: right'>397,056</div>  | <span style="color: green">(-1.0 [-1.6%])</span> <div style='text-align: right'>62.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: red">(+16 [+0.0%])</span> <div style='text-align: right'>58,160</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>35,780</div>  |
| verify_fibair | AccessAdapter<8> | 0 | <div style='text-align: right'>23,300</div>  |
| verify_fibair | Arc<BabyBearParameters>, 1> | 0 | <span style="color: red">(+130 [+1.0%])</span> <div style='text-align: right'>13,413</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-39 [-0.8%])</span> <div style='text-align: right'>5,050</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-39 [-0.8%])</span> <div style='text-align: right'>5,050</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: red">(+88 [+0.7%])</span> <div style='text-align: right'>12,815</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: red">(+52 [+0.7%])</span> <div style='text-align: right'>7,735</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: red">(+88 [+0.6%])</span> <div style='text-align: right'>15,004</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: red">(+52 [+0.6%])</span> <div style='text-align: right'>8,866</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-390 [-0.8%])</span> <div style='text-align: right'>50,500</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>345.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+38,890 [+0.3%])</span> <div style='text-align: right'>14,595,230</div>  | <span style="color: green">(-78 [-0.0%])</span> <div style='text-align: right'>397,056</div>  | <span style="color: green">(-14.0 [-0.9%])</span> <div style='text-align: right'>1,529.0</div>  |
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/2ef5f76d16a02afa7ff29a4db15a2283367517c2/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)
