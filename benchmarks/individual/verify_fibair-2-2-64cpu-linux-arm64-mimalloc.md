...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,260 [-0.0%])</span> <div style='text-align: right'>48,125,825</div>  | <span style="color: green">(-35 [-0.0%])</span> <div style='text-align: right'>198,545</div>  | <span style="color: red">(+6.0 [+0.1%])</span> <div style='text-align: right'>5,711.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-10.0%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: red">(+19.0 [+1.1%])</span> <div style='text-align: right'>1,723.0</div>  | <span style="color: red">(+3.0 [+0.5%])</span> <div style='text-align: right'>582.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>64.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,260 [-0.0%])</span> <div style='text-align: right'>48,125,825</div>  | <span style="color: green">(-35 [-0.0%])</span> <div style='text-align: right'>198,545</div>  | <span style="color: red">(+6.0 [+0.1%])</span> <div style='text-align: right'>5,711.0</div>  | <span style="color: red">(+1.0 [+7.1%])</span> <div style='text-align: right'>15.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: green">(-52 [-0.1%])</span> <div style='text-align: right'>58,132</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: green">(-26 [-0.1%])</span> <div style='text-align: right'>35,766</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: green">(-35 [-0.7%])</span> <div style='text-align: right'>5,069</div>  |
...
| verify_fibair |  | JAL | <span style="color: green">(-35 [-0.7%])</span> <div style='text-align: right'>5,069</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: green">(-286 [-2.2%])</span> <div style='text-align: right'>12,749</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: green">(-169 [-2.1%])</span> <div style='text-align: right'>7,696</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: green">(-286 [-1.9%])</span> <div style='text-align: right'>14,850</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: green">(-169 [-1.9%])</span> <div style='text-align: right'>8,775</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: green">(-350 [-0.7%])</span> <div style='text-align: right'>50,690</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+7.0 [+0.7%])</span> <div style='text-align: right'>1,079.0</div>  | <span style="color: green">(-20.0 [-0.7%])</span> <div style='text-align: right'>2,909.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/3f6c84d31281d03c823ed14a9a8a719a31b75b67/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
