...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+660 [+0.0%])</span> <div style='text-align: right'>48,126,485</div>  | <span style="color: red">(+24 [+0.0%])</span> <div style='text-align: right'>198,569</div>  | <span style="color: red">(+8.0 [+0.1%])</span> <div style='text-align: right'>5,652.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-3.0 [-25.0%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: red">(+4.0 [+0.2%])</span> <div style='text-align: right'>1,683.0</div>  | <span style="color: green">(-6.0 [-1.0%])</span> <div style='text-align: right'>577.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+1.6%])</span> <div style='text-align: right'>64.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+660 [+0.0%])</span> <div style='text-align: right'>48,126,485</div>  | <span style="color: red">(+24 [+0.0%])</span> <div style='text-align: right'>198,569</div>  | <span style="color: red">(+8.0 [+0.1%])</span> <div style='text-align: right'>5,652.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+24 [+0.0%])</span> <div style='text-align: right'>58,156</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+12 [+0.0%])</span> <div style='text-align: right'>35,778</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+24 [+0.5%])</span> <div style='text-align: right'>5,093</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+24 [+0.5%])</span> <div style='text-align: right'>5,093</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+132 [+1.0%])</span> <div style='text-align: right'>12,881</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+78 [+1.0%])</span> <div style='text-align: right'>7,774</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+132 [+0.9%])</span> <div style='text-align: right'>14,982</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+78 [+0.9%])</span> <div style='text-align: right'>8,853</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+240 [+0.5%])</span> <div style='text-align: right'>50,930</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-3.0 [-0.3%])</span> <div style='text-align: right'>1,059.0</div>  | <span style="color: red">(+7.0 [+0.2%])</span> <div style='text-align: right'>2,910.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/56eacfd6dbf0317a66246d116353c7bd0bd4e73c/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
