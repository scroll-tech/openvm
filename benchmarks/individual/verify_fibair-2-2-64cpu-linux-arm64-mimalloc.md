...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+570 [+0.0%])</span> <div style='text-align: right'>8,427,636</div>  | <span style="color: red">(+29 [+0.0%])</span> <div style='text-align: right'>198,605</div>  | <span style="color: red">(+9.0 [+0.6%])</span> <div style='text-align: right'>1,624.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: red">(+4.0 [+0.4%])</span> <div style='text-align: right'>1,008.0</div>  | <span style="color: red">(+570 [+0.0%])</span> <div style='text-align: right'>8,427,636</div>  | <span style="color: red">(+29 [+0.0%])</span> <div style='text-align: right'>198,605</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: red">(+16 [+0.1%])</span> <div style='text-align: right'>22,012</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: red">(+8 [+0.1%])</span> <div style='text-align: right'>11,006</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: red">(+29 [+0.6%])</span> <div style='text-align: right'>5,129</div>  |
...
| verify_fibair | true |  | JAL | <span style="color: red">(+29 [+0.6%])</span> <div style='text-align: right'>5,129</div>  |
...
| verify_fibair | AccessAdapter<2> | true |  | ADD | <span style="color: red">(+88 [+0.7%])</span> <div style='text-align: right'>11,990</div>  |
| verify_fibair | AccessAdapter<4> | true |  | ADD | <span style="color: red">(+52 [+0.7%])</span> <div style='text-align: right'>7,085</div>  |
...
| verify_fibair | AccessAdapter<2> | true |  | BBE4MUL | <span style="color: red">(+88 [+0.6%])</span> <div style='text-align: right'>15,818</div>  |
| verify_fibair | AccessAdapter<4> | true |  | BBE4MUL | <span style="color: red">(+52 [+0.6%])</span> <div style='text-align: right'>9,347</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true |  | JAL | <span style="color: red">(+290 [+0.6%])</span> <div style='text-align: right'>51,290</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+1.0 [+11.1%])</span> <div style='text-align: right'>10.0</div>  | <span style="color: red">(+2.0 [+0.9%])</span> <div style='text-align: right'>236.0</div>  | <span style="color: red">(+2.0 [+1.1%])</span> <div style='text-align: right'>185.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+2.0 [+4.0%])</span> <div style='text-align: right'>52.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+570 [+0.0%])</span> <div style='text-align: right'>8,427,636</div>  | <span style="color: red">(+29 [+0.0%])</span> <div style='text-align: right'>198,605</div>  | <span style="color: red">(+9.0 [+0.6%])</span> <div style='text-align: right'>1,624.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <div style='text-align: right'>50.0</div>  | <span style="color: red">(+7.0 [+0.5%])</span> <div style='text-align: right'>1,338.0</div>  | <div style='text-align: right'>23,969,816</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/23ed04a34b2c7a9088387bcc4b894423d1e4728f/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
