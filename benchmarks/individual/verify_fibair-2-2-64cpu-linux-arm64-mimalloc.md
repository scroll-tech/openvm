...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,670 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+69 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+7.0 [+0.1%])</span> <div style='text-align: right'>5,681.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+1.0 [+11.1%])</span> <div style='text-align: right'>10.0</div>  | <span style="color: red">(+3.0 [+0.2%])</span> <div style='text-align: right'>1,702.0</div>  | <span style="color: green">(-2.0 [-0.3%])</span> <div style='text-align: right'>579.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+1.6%])</span> <div style='text-align: right'>65.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,670 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+69 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+7.0 [+0.1%])</span> <div style='text-align: right'>5,681.0</div>  | <span style="color: green">(-1.0 [-6.7%])</span> <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+56 [+0.1%])</span> <div style='text-align: right'>58,212</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+28 [+0.1%])</span> <div style='text-align: right'>35,806</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+69 [+1.4%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+69 [+1.4%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+308 [+2.4%])</span> <div style='text-align: right'>13,189</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+182 [+2.3%])</span> <div style='text-align: right'>7,956</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+308 [+2.1%])</span> <div style='text-align: right'>15,290</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+182 [+2.1%])</span> <div style='text-align: right'>9,035</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+690 [+1.4%])</span> <div style='text-align: right'>51,690</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+5.0 [+0.5%])</span> <div style='text-align: right'>1,079.0</div>  | <span style="color: green">(-1.0 [-0.0%])</span> <div style='text-align: right'>2,900.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d578ccb9ecb49f17b0cb1a2eef8dc2f89a151236/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
