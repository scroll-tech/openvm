...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-910 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>199,151</div>  | <span style="color: red">(+56.0 [+3.9%])</span> <div style='text-align: right'>1,496.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: red">(+9.0 [+0.9%])</span> <div style='text-align: right'>1,036.0</div>  | <span style="color: green">(-910 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>199,151</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: green">(-24 [-0.1%])</span> <div style='text-align: right'>21,964</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: green">(-12 [-0.1%])</span> <div style='text-align: right'>10,982</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: green">(-4 [-0.1%])</span> <div style='text-align: right'>5,060</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: green">(-15 [-0.0%])</span> <div style='text-align: right'>67,436</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: green">(-15 [-1.2%])</span> <div style='text-align: right'>1,279</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: green">(-4 [-0.4%])</span> <div style='text-align: right'>956</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: green">(-132 [-1.1%])</span> <div style='text-align: right'>11,682</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: green">(-78 [-1.1%])</span> <div style='text-align: right'>6,903</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: green">(-450 [-1.2%])</span> <div style='text-align: right'>38,370</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: green">(-40 [-0.4%])</span> <div style='text-align: right'>9,560</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: green">(-132 [-1.0%])</span> <div style='text-align: right'>13,662</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: green">(-78 [-1.0%])</span> <div style='text-align: right'>8,073</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-6.2%])</span> <div style='text-align: right'>15.0</div>  | <span style="color: red">(+3.0 [+1.2%])</span> <div style='text-align: right'>263.0</div>  | <div style='text-align: right'>211.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+2.3%])</span> <div style='text-align: right'>45.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-910 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>199,151</div>  | <span style="color: red">(+56.0 [+3.9%])</span> <div style='text-align: right'>1,496.0</div>  | <div style='text-align: right'>21.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+4.0 [+8.7%])</span> <div style='text-align: right'>50.0</div>  | <span style="color: red">(+49.0 [+4.3%])</span> <div style='text-align: right'>1,183.0</div>  | <div style='text-align: right'>23,085,080</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7503341a5b006871698024878a0db053217a18c3/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
