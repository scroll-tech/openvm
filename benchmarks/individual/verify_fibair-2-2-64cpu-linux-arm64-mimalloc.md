...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-2,930 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-118 [-0.1%])</span> <div style='text-align: right'>199,151</div>  | <div style='text-align: right'>1,466.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: green">(-5.0 [-0.5%])</span> <div style='text-align: right'>1,026.0</div>  | <span style="color: green">(-2,930 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-118 [-0.1%])</span> <div style='text-align: right'>199,151</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: green">(-76 [-0.3%])</span> <div style='text-align: right'>21,964</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: green">(-38 [-0.3%])</span> <div style='text-align: right'>10,982</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: green">(-97 [-1.9%])</span> <div style='text-align: right'>5,060</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: green">(-21 [-0.0%])</span> <div style='text-align: right'>67,436</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: green">(-21 [-1.6%])</span> <div style='text-align: right'>1,279</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: green">(-97 [-9.2%])</span> <div style='text-align: right'>956</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: green">(-418 [-3.5%])</span> <div style='text-align: right'>11,682</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: green">(-247 [-3.5%])</span> <div style='text-align: right'>6,903</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: green">(-630 [-1.6%])</span> <div style='text-align: right'>38,370</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: green">(-970 [-9.2%])</span> <div style='text-align: right'>9,560</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: green">(-418 [-3.0%])</span> <div style='text-align: right'>13,662</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: green">(-247 [-3.0%])</span> <div style='text-align: right'>8,073</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>15.0</div>  | <span style="color: green">(-1.0 [-0.4%])</span> <div style='text-align: right'>257.0</div>  | <span style="color: red">(+1.0 [+0.5%])</span> <div style='text-align: right'>211.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+2.3%])</span> <div style='text-align: right'>45.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-2,930 [-0.0%])</span> <div style='text-align: right'>8,305,377</div>  | <span style="color: green">(-118 [-0.1%])</span> <div style='text-align: right'>199,151</div>  | <div style='text-align: right'>1,466.0</div>  | <div style='text-align: right'>21.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-2.0 [-4.3%])</span> <div style='text-align: right'>44.0</div>  | <span style="color: red">(+3.0 [+0.3%])</span> <div style='text-align: right'>1,165.0</div>  | <div style='text-align: right'>23,085,080</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/eb9bbf6faca703c533d7a67332ab50b82a7ed90b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
