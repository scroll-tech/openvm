...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,569 |  42,569 |  42,569 |  42,569 |
| `main_cells_used     ` |  439,994,481 |  439,994,481 |  439,994,481 |  439,994,481 |
| `total_cycles        ` |  9,651,998 |  9,651,998 |  9,651,998 |  9,651,998 |
| `execute_time_ms     ` |  2,781 |  2,781 |  2,781 |  2,781 |
| `trace_gen_time_ms   ` |  7,292 |  7,292 |  7,292 |  7,292 |
| `stark_prove_excluding_trace_time_ms` |  32,496 |  32,496 |  32,496 |  32,496 |
| `main_trace_commit_time_ms` |  6,297 |  6,297 |  6,297 |  6,297 |
| `generate_perm_trace_time_ms` |  731 |  731 |  731 |  731 |
| `perm_trace_commit_time_ms` |  6,171 |  6,171 |  6,171 |  6,171 |
| `quotient_poly_compute_time_ms` |  7,899 |  7,899 |  7,899 |  7,899 |
| `quotient_poly_commit_time_ms` |  5,117 |  5,117 |  5,117 |  5,117 |
| `pcs_opening_time_ms ` |  6,277 |  6,277 |  6,277 |  6,277 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,292 | 42,569 | 9,651,998 | 1,069,222,360 | 32,496 | 7,899 | 5,117 | 6,171 | 6,277 | 6,297 | 439,994,481 | 731 | 2,781 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 263 | 2,597 | 285,169 | 56,159,799 | 2,186 | 289 | 304 | 523 | 640 | 387 | 15,074,875 | 41 | 148 | 
