...
| `total_proof_time_ms ` |  2,921 |  2,921 |  2,921 |  2,921 |
...
| `stark_prove_excluding_trace_time_ms` |  2,359 |  2,359 |  2,359 |  2,359 |
...
| `main_cells_used     ` |  445,623,228 |  445,623,228 |  445,623,228 |  445,623,228 |
| `total_cycles        ` |  9,777,435 |  9,777,435 |  9,777,435 |  9,777,435 |
| `execute_time_ms     ` |  11,504 |  11,504 |  11,504 |  11,504 |
| `trace_gen_time_ms   ` |  2,177 |  2,177 |  2,177 |  2,177 |
| `stark_prove_excluding_trace_time_ms` |  34,579 |  34,579 |  34,579 |  34,579 |
| `main_trace_commit_time_ms` |  6,265 |  6,265 |  6,265 |  6,265 |
| `generate_perm_trace_time_ms` |  737 |  737 |  737 |  737 |
| `perm_trace_commit_time_ms` |  6,111 |  6,111 |  6,111 |  6,111 |
| `quotient_poly_compute_time_ms` |  7,987 |  7,987 |  7,987 |  7,987 |
| `quotient_poly_commit_time_ms` |  5,061 |  5,061 |  5,061 |  5,061 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,177 | 48,260 | 9,777,435 | 1,069,222,360 | 34,579 | 7,987 | 5,061 | 6,111 | 8,415 | 6,265 | 445,623,228 | 737 | 11,504 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 72 | 2,921 | 290,016 | 55,907,135 | 2,359 | 271 | 315 | 526 | 804 | 402 | 15,230,037 | 38 | 490 | 
