...
| `execute_time_ms     ` |  168 |  168 |  168 |  168 |
| `trace_gen_time_ms   ` |  271 |  271 |  271 |  271 |
| `stark_prove_excluding_trace_time_ms` |  2,128 |  2,128 |  2,128 |  2,128 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,910 |  42,910 |  42,910 |  42,910 |
| `main_cells_used     ` |  439,979,631 |  439,979,631 |  439,979,631 |  439,979,631 |
| `total_cycles        ` |  9,650,534 |  9,650,534 |  9,650,534 |  9,650,534 |
| `execute_time_ms     ` |  3,310 |  3,310 |  3,310 |  3,310 |
| `trace_gen_time_ms   ` |  8,155 |  8,155 |  8,155 |  8,155 |
| `stark_prove_excluding_trace_time_ms` |  31,445 |  31,445 |  31,445 |  31,445 |
...
| `quotient_poly_compute_time_ms` |  7,969 |  7,969 |  7,969 |  7,969 |
| `quotient_poly_commit_time_ms` |  4,858 |  4,858 |  4,858 |  4,858 |
| `pcs_opening_time_ms ` |  6,292 |  6,292 |  6,292 |  6,292 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,155 | 42,910 | 9,650,534 | 1,069,222,360 | 31,445 | 7,969 | 4,858 | 5,719 | 6,292 | 5,821 | 439,979,631 | 783 | 3,310 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 271 | 2,567 | 285,169 | 56,159,799 | 2,128 | 246 | 302 | 529 | 621 | 385 | 15,074,875 | 41 | 168 | 
