...
| `total_proof_time_ms ` |  2,637 |  2,637 |  2,637 |  2,637 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,995 |  42,995 |  42,995 |  42,995 |
| `main_cells_used     ` |  440,579,838 |  440,579,838 |  440,579,838 |  440,579,838 |
| `total_cycles        ` |  9,665,421 |  9,665,421 |  9,665,421 |  9,665,421 |
| `execute_time_ms     ` |  2,756 |  2,756 |  2,756 |  2,756 |
| `trace_gen_time_ms   ` |  7,233 |  7,233 |  7,233 |  7,233 |
| `stark_prove_excluding_trace_time_ms` |  33,006 |  33,006 |  33,006 |  33,006 |
| `main_trace_commit_time_ms` |  6,357 |  6,357 |  6,357 |  6,357 |
| `generate_perm_trace_time_ms` |  745 |  745 |  745 |  745 |
| `perm_trace_commit_time_ms` |  6,262 |  6,262 |  6,262 |  6,262 |
| `quotient_poly_compute_time_ms` |  8,171 |  8,171 |  8,171 |  8,171 |
| `quotient_poly_commit_time_ms` |  5,101 |  5,101 |  5,101 |  5,101 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,233 | 42,995 | 9,665,421 | 1,069,222,360 | 33,006 | 8,171 | 5,101 | 6,262 | 6,366 | 6,357 | 440,579,838 | 745 | 2,756 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 268 | 2,637 | 285,401 | 56,172,159 | 2,220 | 311 | 329 | 528 | 616 | 392 | 15,092,297 | 41 | 149 | 
