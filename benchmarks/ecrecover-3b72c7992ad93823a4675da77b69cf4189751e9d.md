...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,622 |  42,622 |  42,622 |  42,622 |
| `main_cells_used     ` |  440,557,918 |  440,557,918 |  440,557,918 |  440,557,918 |
| `total_cycles        ` |  9,663,355 |  9,663,355 |  9,663,355 |  9,663,355 |
| `execute_time_ms     ` |  2,748 |  2,748 |  2,748 |  2,748 |
| `trace_gen_time_ms   ` |  7,137 |  7,137 |  7,137 |  7,137 |
| `stark_prove_excluding_trace_time_ms` |  32,737 |  32,737 |  32,737 |  32,737 |
| `main_trace_commit_time_ms` |  6,328 |  6,328 |  6,328 |  6,328 |
| `generate_perm_trace_time_ms` |  742 |  742 |  742 |  742 |
| `perm_trace_commit_time_ms` |  6,226 |  6,226 |  6,226 |  6,226 |
| `quotient_poly_compute_time_ms` |  7,878 |  7,878 |  7,878 |  7,878 |
| `quotient_poly_commit_time_ms` |  5,138 |  5,138 |  5,138 |  5,138 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,137 | 42,622 | 9,663,355 | 1,069,222,360 | 32,737 | 7,878 | 5,138 | 6,226 | 6,423 | 6,328 | 440,557,918 | 742 | 2,748 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 263 | 2,616 | 285,401 | 56,172,159 | 2,205 | 290 | 304 | 530 | 639 | 397 | 15,092,297 | 43 | 148 | 
