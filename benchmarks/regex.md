...
| --- | --- | --- | --- | --- |
| regex_program | <div style='text-align: right'>2</div>  | <span style="color: green">(-10,773 [-0.0%])</span> <div style='text-align: right'>160,096,222</div>  | <span style="color: green">(-136 [-0.0%])</span> <div style='text-align: right'>4,190,887</div>  | <span style="color: green">(-174.0 [-0.6%])</span> <div style='text-align: right'>27,654.0</div>  |
| leaf_aggregation | <div style='text-align: right'>2</div>  | <span style="color: green">(-42,830 [-0.0%])</span> <div style='text-align: right'>309,654,703</div>  | <span style="color: green">(-3,978 [-0.1%])</span> <div style='text-align: right'>7,302,032</div>  | <span style="color: red">(+271.0 [+0.6%])</span> <div style='text-align: right'>44,657.0</div>  |
...
| --- | --- | --- | --- | --- |
| regex_program | true | <span style="color: green">(-285.0 [-0.3%])</span> <div style='text-align: right'>107,756.0</div>  | <span style="color: green">(-10,773 [-0.0%])</span> <div style='text-align: right'>160,096,222</div>  | <span style="color: green">(-136 [-0.0%])</span> <div style='text-align: right'>4,190,887</div>  |

| group | chip_name | collect_metrics | rows_used |
| --- | --- | --- | --- |
| regex_program | <Rv32BaseAluAdapterAir,BaseAluCoreAir<4, 8>> | true | <span style="color: green">(-16 [-0.0%])</span> <div style='text-align: right'>1,150,469</div>  |
...
| regex_program | <Rv32JalrAdapterAir,Rv32JalrCoreAir> | true | <span style="color: green">(-12 [-0.0%])</span> <div style='text-align: right'>130,442</div>  |
| regex_program | <Rv32LoadStoreAdapterAir,LoadSignExtendCoreAir<4, 8>> | true | <div style='text-align: right'>687</div>  |
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true | <span style="color: green">(-102 [-0.0%])</span> <div style='text-align: right'>1,961,378</div>  |
...
| regex_program | <Rv32RdWriteAdapterAir,Rv32AuipcCoreAir> | true | <span style="color: green">(-6 [-0.0%])</span> <div style='text-align: right'>39,556</div>  |
...
| regex_program | Memory AccessAdapter<8> | true | <span style="color: green">(-51 [-0.1%])</span> <div style='text-align: right'>34,586</div>  |
| regex_program | Memory Boundary | true | <span style="color: green">(-102 [-0.1%])</span> <div style='text-align: right'>69,172</div>  |
| regex_program | Memory Merkle | true | <span style="color: green">(-80 [-0.1%])</span> <div style='text-align: right'>70,444</div>  |
| regex_program | PhantomAir | true | <div style='text-align: right'>289</div>  |
| regex_program | ProgramChip | true | <span style="color: green">(-188 [-0.2%])</span> <div style='text-align: right'>89,366</div>  |
| regex_program | RangeTupleCheckerAir<2> | true | <div style='text-align: right'>524,288</div>  |

| group | collect_metrics | dsl_ir | opcode | frequency |
| --- | --- | --- | --- | --- |
| regex_program | true |  | ADD | <span style="color: green">(-16 [-0.0%])</span> <div style='text-align: right'>1,007,997</div>  |
| regex_program | true |  | AND | <div style='text-align: right'>66,789</div>  |
| regex_program | true |  | AUIPC | <span style="color: green">(-6 [-0.0%])</span> <div style='text-align: right'>39,556</div>  |
...
| regex_program | true |  | JALR | <span style="color: green">(-12 [-0.0%])</span> <div style='text-align: right'>130,442</div>  |
...
| regex_program | true |  | LOADW | <span style="color: green">(-50 [-0.0%])</span> <div style='text-align: right'>1,142,833</div>  |
...
| regex_program | true |  | STOREW | <span style="color: green">(-52 [-0.0%])</span> <div style='text-align: right'>768,361</div>  |
...
| --- | --- | --- | --- | --- | --- |
| regex_program | <Rv32BaseAluAdapterAir,BaseAluCoreAir<4, 8>> | true |  | ADD | <span style="color: green">(-576 [-0.0%])</span> <div style='text-align: right'>36,287,892</div>  |
...
| regex_program | <Rv32RdWriteAdapterAir,Rv32AuipcCoreAir> | true |  | AUIPC | <span style="color: green">(-126 [-0.0%])</span> <div style='text-align: right'>830,676</div>  |
...
| regex_program | Merkle | true |  | HINT_STOREW | <span style="color: green">(-320 [-0.1%])</span> <div style='text-align: right'>408,320</div>  |
| regex_program | <Rv32CondRdWriteAdapterAir,Rv32JalLuiCoreAir> | true |  | JAL | <div style='text-align: right'>1,108,350</div>  |
| regex_program | <Rv32JalrAdapterAir,Rv32JalrCoreAir> | true |  | JALR | <span style="color: green">(-336 [-0.0%])</span> <div style='text-align: right'>3,652,376</div>  |
...
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true |  | LOADW | <span style="color: green">(-2,000 [-0.0%])</span> <div style='text-align: right'>45,713,320</div>  |
| regex_program | AccessAdapter<8> | true |  | LOADW | <span style="color: red">(+17 [+0.6%])</span> <div style='text-align: right'>3,026</div>  |
| regex_program | Boundary | true |  | LOADW | <span style="color: red">(+40 [+0.6%])</span> <div style='text-align: right'>7,120</div>  |
| regex_program | Merkle | true |  | LOADW | <span style="color: red">(+64 [+0.3%])</span> <div style='text-align: right'>24,896</div>  |
...
| regex_program | Merkle | true |  | STOREB | <span style="color: green">(-3,200 [-26.0%])</span> <div style='text-align: right'>9,088</div>  |
...
| regex_program | <Rv32LoadStoreAdapterAir,LoadStoreCoreAir<4>> | true |  | STOREW | <span style="color: green">(-2,080 [-0.0%])</span> <div style='text-align: right'>30,734,440</div>  |
| regex_program | AccessAdapter<8> | true |  | STOREW | <span style="color: red">(+153 [+0.0%])</span> <div style='text-align: right'>389,691</div>  |
| regex_program | Boundary | true |  | STOREW | <span style="color: red">(+360 [+0.0%])</span> <div style='text-align: right'>916,920</div>  |
| regex_program | Merkle | true |  | STOREW | <span style="color: red">(+704 [+0.0%])</span> <div style='text-align: right'>1,485,184</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | <span style="color: green">(-4.0 [-8.9%])</span> <div style='text-align: right'>41.0</div>  | <span style="color: red">(+105.0 [+1.2%])</span> <div style='text-align: right'>9,198.0</div>  | <span style="color: red">(+141.0 [+2.1%])</span> <div style='text-align: right'>6,721.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-2.0 [-0.9%])</span> <div style='text-align: right'>213.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-10,773 [-0.0%])</span> <div style='text-align: right'>160,096,222</div>  | <span style="color: green">(-136 [-0.0%])</span> <div style='text-align: right'>4,190,887</div>  | <span style="color: green">(-174.0 [-0.6%])</span> <div style='text-align: right'>27,654.0</div>  |
| leaf_aggregation |  |  |  | <div style='text-align: right'>2</div>  |  |  | <span style="color: green">(-42,830 [-0.0%])</span> <div style='text-align: right'>309,654,703</div>  | <span style="color: green">(-3,978 [-0.1%])</span> <div style='text-align: right'>7,302,032</div>  | <span style="color: red">(+271.0 [+0.6%])</span> <div style='text-align: right'>44,657.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 |  |  |  |  |  |  | <span style="color: green">(-279.0 [-1.5%])</span> <div style='text-align: right'>18,456.0</div>  | <div style='text-align: right'>790,590,848</div>  |  |
| leaf_aggregation | 0 | <span style="color: red">(+13.0 [+7.4%])</span> <div style='text-align: right'>189.0</div>  | <span style="color: red">(+90.0 [+0.6%])</span> <div style='text-align: right'>14,436.0</div>  | <span style="color: red">(+73.0 [+0.6%])</span> <div style='text-align: right'>12,795.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-4.0 [-6.7%])</span> <div style='text-align: right'>56.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+181.0 [+0.6%])</span> <div style='text-align: right'>30,221.0</div>  | <div style='text-align: right'>806,027,288</div>  | <span style="color: green">(-313.0 [-0.7%])</span> <div style='text-align: right'>47,737.0</div>  |

| group | collect_metrics | segment | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- | --- |
| leaf_aggregation | true | 0 | <span style="color: red">(+496.0 [+0.4%])</span> <div style='text-align: right'>116,389.0</div>  | <span style="color: green">(-42,830 [-0.0%])</span> <div style='text-align: right'>309,654,703</div>  | <span style="color: green">(-3,978 [-0.1%])</span> <div style='text-align: right'>7,302,032</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | 0 | <span style="color: green">(-3,941 [-3.9%])</span> <div style='text-align: right'>97,028</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | 0 | <span style="color: green">(-37 [-0.0%])</span> <div style='text-align: right'>2,857,302</div>  |
...
| leaf_aggregation | Memory AccessAdapter<2> | true | 0 | <span style="color: green">(-132 [-0.0%])</span> <div style='text-align: right'>849,550</div>  |
| leaf_aggregation | Memory AccessAdapter<4> | true | 0 | <span style="color: green">(-66 [-0.0%])</span> <div style='text-align: right'>424,985</div>  |
...
| leaf_aggregation | true | AddFI | ADD | 0 | <span style="color: green">(-37 [-0.0%])</span> <div style='text-align: right'>79,845</div>  |
...
| leaf_aggregation | true | IfEqI | JAL | 0 | <span style="color: green">(-3,941 [-7.8%])</span> <div style='text-align: right'>46,333</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | AddEI | ADD | 0 | <span style="color: green">(-726 [-0.1%])</span> <div style='text-align: right'>610,874</div>  |
| leaf_aggregation | AccessAdapter<4> | true | AddEI | ADD | 0 | <span style="color: green">(-429 [-0.1%])</span> <div style='text-align: right'>360,971</div>  |
| leaf_aggregation | Boundary | true | AddEI | ADD | 0 | <div style='text-align: right'>708,752</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | 0 | <span style="color: green">(-1,110 [-0.0%])</span> <div style='text-align: right'>2,395,350</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | 0 | <span style="color: green">(-39,410 [-7.8%])</span> <div style='text-align: right'>463,330</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-726 [-0.1%])</span> <div style='text-align: right'>834,856</div>  |
| leaf_aggregation | AccessAdapter<4> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-429 [-0.1%])</span> <div style='text-align: right'>493,324</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-leaf_aggregation.dsl_ir.opcode.frequency.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/aebff4028ce532c4dd80cc441bd975b9090acdbc/regex-regex_program.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/aebff4028ce532c4dd80cc441bd975b9090acdbc
Instance Type: 64cpu-linux-arm64
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11735593869)
