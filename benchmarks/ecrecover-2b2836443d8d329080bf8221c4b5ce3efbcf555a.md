...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,564 |  40,564 |  40,564 |  40,564 |
| `main_cells_used     ` |  365,927,700 |  365,927,700 |  365,927,700 |  365,927,700 |
| `total_cycles        ` |  8,657,537 |  8,657,537 |  8,657,537 |  8,657,537 |
| `execute_time_ms     ` |  2,537 |  2,537 |  2,537 |  2,537 |
| `trace_gen_time_ms   ` |  6,431 |  6,431 |  6,431 |  6,431 |
| `stark_prove_excluding_trace_time_ms` |  31,596 |  31,596 |  31,596 |  31,596 |
| `main_trace_commit_time_ms` |  5,889 |  5,889 |  5,889 |  5,889 |
| `generate_perm_trace_time_ms` |  671 |  671 |  671 |  671 |
| `perm_trace_commit_time_ms` |  7,052 |  7,052 |  7,052 |  7,052 |
| `quotient_poly_compute_time_ms` |  6,499 |  6,499 |  6,499 |  6,499 |
| `quotient_poly_commit_time_ms` |  5,059 |  5,059 |  5,059 |  5,059 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,431 | 40,564 | 8,657,537 | 1,052,183,000 | 31,596 | 6,499 | 5,059 | 7,052 | 6,423 | 5,889 | 365,927,700 | 671 | 2,537 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 275 | 2,602 | 285,401 | 56,172,159 | 2,179 | 292 | 302 | 517 | 628 | 394 | 15,092,297 | 42 | 148 | 
