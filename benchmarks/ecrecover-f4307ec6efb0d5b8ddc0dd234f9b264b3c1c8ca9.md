...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,573 |  42,573 |  42,573 |  42,573 |
| `main_cells_used     ` |  440,568,976 |  440,568,976 |  440,568,976 |  440,568,976 |
| `total_cycles        ` |  9,664,399 |  9,664,399 |  9,664,399 |  9,664,399 |
| `execute_time_ms     ` |  2,768 |  2,768 |  2,768 |  2,768 |
| `trace_gen_time_ms   ` |  7,192 |  7,192 |  7,192 |  7,192 |
| `stark_prove_excluding_trace_time_ms` |  32,613 |  32,613 |  32,613 |  32,613 |
| `main_trace_commit_time_ms` |  6,356 |  6,356 |  6,356 |  6,356 |
| `generate_perm_trace_time_ms` |  730 |  730 |  730 |  730 |
| `perm_trace_commit_time_ms` |  6,297 |  6,297 |  6,297 |  6,297 |
| `quotient_poly_compute_time_ms` |  7,820 |  7,820 |  7,820 |  7,820 |
| `quotient_poly_commit_time_ms` |  5,024 |  5,024 |  5,024 |  5,024 |
| `pcs_opening_time_ms ` |  6,383 |  6,383 |  6,383 |  6,383 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 7,192 | 42,573 | 9,664,399 | 1,069,222,360 | 32,613 | 7,820 | 5,024 | 6,297 | 6,383 | 6,356 | 440,568,976 | 730 | 2,768 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 267 | 2,609 | 285,401 | 56,172,159 | 2,193 | 291 | 297 | 538 | 629 | 395 | 15,092,297 | 40 | 149 | 
