...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,205 |  41,205 |  41,205 |  41,205 |
| `main_cells_used     ` |  365,866,490 |  365,866,490 |  365,866,490 |  365,866,490 |
| `total_cycles        ` |  8,651,416 |  8,651,416 |  8,651,416 |  8,651,416 |
| `execute_time_ms     ` |  2,589 |  2,589 |  2,589 |  2,589 |
| `trace_gen_time_ms   ` |  6,427 |  6,427 |  6,427 |  6,427 |
| `stark_prove_excluding_trace_time_ms` |  32,189 |  32,189 |  32,189 |  32,189 |
| `main_trace_commit_time_ms` |  5,850 |  5,850 |  5,850 |  5,850 |
| `generate_perm_trace_time_ms` |  705 |  705 |  705 |  705 |
| `perm_trace_commit_time_ms` |  7,164 |  7,164 |  7,164 |  7,164 |
| `quotient_poly_compute_time_ms` |  6,931 |  6,931 |  6,931 |  6,931 |
| `quotient_poly_commit_time_ms` |  5,153 |  5,153 |  5,153 |  5,153 |
| `pcs_opening_time_ms ` |  6,381 |  6,381 |  6,381 |  6,381 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,427 | 41,205 | 8,651,416 | 1,052,183,000 | 32,189 | 6,931 | 5,153 | 7,164 | 6,381 | 5,850 | 365,866,490 | 705 | 2,589 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 265 | 2,594 | 285,401 | 56,172,159 | 2,180 | 295 | 301 | 530 | 615 | 395 | 15,092,297 | 42 | 149 | 
