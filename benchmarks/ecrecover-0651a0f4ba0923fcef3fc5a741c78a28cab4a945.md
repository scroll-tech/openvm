...
| `execute_time_ms     ` |  177 |  177 |  177 |  177 |
| `trace_gen_time_ms   ` |  279 |  279 |  279 |  279 |
| `stark_prove_excluding_trace_time_ms` |  2,280 |  2,280 |  2,280 |  2,280 |
...
| `pcs_opening_time_ms ` |  784 |  784 |  784 |  784 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  47,000 |  47,000 |  47,000 |  47,000 |
| `main_cells_used     ` |  439,994,067 |  439,994,067 |  439,994,067 |  439,994,067 |
| `total_cycles        ` |  9,652,971 |  9,652,971 |  9,652,971 |  9,652,971 |
| `execute_time_ms     ` |  3,272 |  3,272 |  3,272 |  3,272 |
| `trace_gen_time_ms   ` |  8,057 |  8,057 |  8,057 |  8,057 |
| `stark_prove_excluding_trace_time_ms` |  35,671 |  35,671 |  35,671 |  35,671 |
| `main_trace_commit_time_ms` |  6,345 |  6,345 |  6,345 |  6,345 |
| `generate_perm_trace_time_ms` |  783 |  783 |  783 |  783 |
| `perm_trace_commit_time_ms` |  6,140 |  6,140 |  6,140 |  6,140 |
| `quotient_poly_compute_time_ms` |  8,964 |  8,964 |  8,964 |  8,964 |
| `quotient_poly_commit_time_ms` |  5,093 |  5,093 |  5,093 |  5,093 |
| `pcs_opening_time_ms ` |  8,344 |  8,344 |  8,344 |  8,344 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,057 | 47,000 | 9,652,971 | 1,069,222,360 | 35,671 | 8,964 | 5,093 | 6,140 | 8,344 | 6,345 | 439,994,067 | 783 | 3,272 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 279 | 2,736 | 285,169 | 56,159,799 | 2,280 | 272 | 294 | 507 | 784 | 379 | 15,074,875 | 41 | 177 | 
