...
| `total_proof_time_ms ` |  2,589 |  2,589 |  2,589 |  2,589 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,550 |  40,550 |  40,550 |  40,550 |
| `main_cells_used     ` |  365,952,880 |  365,952,880 |  365,952,880 |  365,952,880 |
| `total_cycles        ` |  8,660,055 |  8,660,055 |  8,660,055 |  8,660,055 |
| `execute_time_ms     ` |  2,531 |  2,531 |  2,531 |  2,531 |
| `trace_gen_time_ms   ` |  6,325 |  6,325 |  6,325 |  6,325 |
| `stark_prove_excluding_trace_time_ms` |  31,694 |  31,694 |  31,694 |  31,694 |
| `main_trace_commit_time_ms` |  5,871 |  5,871 |  5,871 |  5,871 |
| `generate_perm_trace_time_ms` |  674 |  674 |  674 |  674 |
| `perm_trace_commit_time_ms` |  7,114 |  7,114 |  7,114 |  7,114 |
| `quotient_poly_compute_time_ms` |  6,524 |  6,524 |  6,524 |  6,524 |
| `quotient_poly_commit_time_ms` |  5,137 |  5,137 |  5,137 |  5,137 |
| `pcs_opening_time_ms ` |  6,373 |  6,373 |  6,373 |  6,373 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,325 | 40,550 | 8,660,055 | 1,052,183,000 | 31,694 | 6,524 | 5,137 | 7,114 | 6,373 | 5,871 | 365,952,880 | 674 | 2,531 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,589 | 285,401 | 56,172,159 | 2,174 | 286 | 295 | 529 | 630 | 393 | 15,092,297 | 38 | 149 | 
