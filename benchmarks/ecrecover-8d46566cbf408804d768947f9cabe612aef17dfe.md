...
| `execute_time_ms     ` |  282 |  282 |  282 |  282 |
...
| `pcs_opening_time_ms ` |  810 |  810 |  810 |  810 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,583 |  41,583 |  41,583 |  41,583 |
| `main_cells_used     ` |  439,921,957 |  439,921,957 |  439,921,957 |  439,921,957 |
| `total_cycles        ` |  9,646,075 |  9,646,075 |  9,646,075 |  9,646,075 |
| `execute_time_ms     ` |  5,715 |  5,715 |  5,715 |  5,715 |
| `trace_gen_time_ms   ` |  2,098 |  2,098 |  2,098 |  2,098 |
| `stark_prove_excluding_trace_time_ms` |  33,770 |  33,770 |  33,770 |  33,770 |
| `main_trace_commit_time_ms` |  5,829 |  5,829 |  5,829 |  5,829 |
| `generate_perm_trace_time_ms` |  780 |  780 |  780 |  780 |
| `perm_trace_commit_time_ms` |  5,818 |  5,818 |  5,818 |  5,818 |
| `quotient_poly_compute_time_ms` |  8,086 |  8,086 |  8,086 |  8,086 |
| `quotient_poly_commit_time_ms` |  4,878 |  4,878 |  4,878 |  4,878 |
| `pcs_opening_time_ms ` |  8,376 |  8,376 |  8,376 |  8,376 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,098 | 41,583 | 9,646,075 | 1,069,222,360 | 33,770 | 8,086 | 4,878 | 5,818 | 8,376 | 5,829 | 439,921,957 | 780 | 5,715 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 75 | 2,730 | 285,169 | 56,159,799 | 2,373 | 279 | 306 | 530 | 810 | 401 | 15,074,875 | 44 | 282 | 
