...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,885 |  40,885 |  40,885 |  40,885 |
| `main_cells_used     ` |  365,913,040 |  365,913,040 |  365,913,040 |  365,913,040 |
| `total_cycles        ` |  8,656,071 |  8,656,071 |  8,656,071 |  8,656,071 |
| `execute_time_ms     ` |  2,522 |  2,522 |  2,522 |  2,522 |
| `trace_gen_time_ms   ` |  6,389 |  6,389 |  6,389 |  6,389 |
| `stark_prove_excluding_trace_time_ms` |  31,974 |  31,974 |  31,974 |  31,974 |
| `main_trace_commit_time_ms` |  5,856 |  5,856 |  5,856 |  5,856 |
| `generate_perm_trace_time_ms` |  674 |  674 |  674 |  674 |
| `perm_trace_commit_time_ms` |  7,098 |  7,098 |  7,098 |  7,098 |
| `quotient_poly_compute_time_ms` |  6,912 |  6,912 |  6,912 |  6,912 |
| `quotient_poly_commit_time_ms` |  5,012 |  5,012 |  5,012 |  5,012 |
| `pcs_opening_time_ms ` |  6,418 |  6,418 |  6,418 |  6,418 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,389 | 40,885 | 8,656,071 | 1,052,183,000 | 31,974 | 6,912 | 5,012 | 7,098 | 6,418 | 5,856 | 365,913,040 | 674 | 2,522 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 273 | 2,638 | 285,401 | 56,172,159 | 2,217 | 303 | 326 | 527 | 622 | 396 | 15,092,297 | 40 | 148 | 
