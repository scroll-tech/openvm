...
| `execute_time_ms     ` |  490 |  490 |  490 |  490 |
| `trace_gen_time_ms   ` |  77 |  77 |  77 |  77 |
| `stark_prove_excluding_trace_time_ms` |  2,350 |  2,350 |  2,350 |  2,350 |
...
| `total_cells_used    ` |  445,619,418 |  445,619,418 |  445,619,418 |  445,619,418 |
| `total_cycles        ` |  9,777,054 |  9,777,054 |  9,777,054 |  9,777,054 |
| `execute_time_ms     ` |  11,474 |  11,474 |  11,474 |  11,474 |
| `trace_gen_time_ms   ` |  2,093 |  2,093 |  2,093 |  2,093 |
| `stark_prove_excluding_trace_time_ms` |  34,941 |  34,941 |  34,941 |  34,941 |
| `main_trace_commit_time_ms` |  6,326 |  6,326 |  6,326 |  6,326 |
| `generate_perm_trace_time_ms` |  788 |  788 |  788 |  788 |
| `perm_trace_commit_time_ms` |  6,170 |  6,170 |  6,170 |  6,170 |
| `quotient_poly_compute_time_ms` |  8,083 |  8,083 |  8,083 |  8,083 |
| `quotient_poly_commit_time_ms` |  5,147 |  5,147 |  5,147 |  5,147 |
| `pcs_opening_time_ms ` |  8,424 |  8,424 |  8,424 |  8,424 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,093 | 48,508 | 9,777,054 | 445,619,418 | 1,069,222,360 | 34,941 | 8,083 | 5,147 | 6,170 | 8,424 | 6,326 | 788 | 11,474 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 77 | 2,917 | 290,016 | 15,230,037 | 55,907,135 | 2,350 | 274 | 302 | 531 | 809 | 391 | 40 | 490 | 
