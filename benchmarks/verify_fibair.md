...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,240 [-0.0%])</span> <div style='text-align: right'>8,172,372</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>198,759</div>  | <span style="color: red">(+13.0 [+0.8%])</span> <div style='text-align: right'>1,601.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: green">(-25.0 [-0.8%])</span> <div style='text-align: right'>3,013.0</div>  | <span style="color: green">(-1,240 [-0.0%])</span> <div style='text-align: right'>8,172,372</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>198,759</div>  |

| group | chip_name | collect_metrics | rows_used |
| --- | --- | --- | --- |
| verify_fibair | <BranchNativeAdapterAir,BranchEqualCoreAir<1>> | true | <div style='text-align: right'>31,888</div>  |
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: red">(+16 [+0.3%])</span> <div style='text-align: right'>5,170</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: green">(-35 [-0.1%])</span> <div style='text-align: right'>66,938</div>  |
...
| verify_fibair | Memory AccessAdapter<2> | true | <span style="color: green">(-20 [-0.1%])</span> <div style='text-align: right'>16,464</div>  |
| verify_fibair | Memory AccessAdapter<4> | true | <span style="color: green">(-10 [-0.1%])</span> <div style='text-align: right'>8,232</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: green">(-35 [-2.7%])</span> <div style='text-align: right'>1,285</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: red">(+16 [+1.5%])</span> <div style='text-align: right'>1,066</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: green">(-110 [-0.9%])</span> <div style='text-align: right'>11,902</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: green">(-65 [-0.9%])</span> <div style='text-align: right'>7,033</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: green">(-1,050 [-2.7%])</span> <div style='text-align: right'>38,550</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: red">(+160 [+1.5%])</span> <div style='text-align: right'>10,660</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: green">(-110 [-0.8%])</span> <div style='text-align: right'>13,882</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: green">(-65 [-0.8%])</span> <div style='text-align: right'>8,203</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+1.0 [+6.2%])</span> <div style='text-align: right'>17.0</div>  | <span style="color: red">(+3.0 [+1.0%])</span> <div style='text-align: right'>317.0</div>  | <div style='text-align: right'>270.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-1.0 [-2.1%])</span> <div style='text-align: right'>46.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,240 [-0.0%])</span> <div style='text-align: right'>8,172,372</div>  | <span style="color: green">(-19 [-0.0%])</span> <div style='text-align: right'>198,759</div>  | <span style="color: red">(+13.0 [+0.8%])</span> <div style='text-align: right'>1,601.0</div>  | <span style="color: green">(-1.0 [-4.5%])</span> <div style='text-align: right'>21.0</div>  |
...
| --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+10.0 [+0.8%])</span> <div style='text-align: right'>1,284.0</div>  | <div style='text-align: right'>23,085,080</div>  |
