...
| `execute_time_ms     ` |  175 |  175 |  175 |  175 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,680 |  41,680 |  41,680 |  41,680 |
| `main_cells_used     ` |  439,933,251 |  439,933,251 |  439,933,251 |  439,933,251 |
| `total_cycles        ` |  9,646,120 |  9,646,120 |  9,646,120 |  9,646,120 |
| `execute_time_ms     ` |  3,413 |  3,413 |  3,413 |  3,413 |
| `trace_gen_time_ms   ` |  8,058 |  8,058 |  8,058 |  8,058 |
| `stark_prove_excluding_trace_time_ms` |  30,209 |  30,209 |  30,209 |  30,209 |
| `main_trace_commit_time_ms` |  5,872 |  5,872 |  5,872 |  5,872 |
| `generate_perm_trace_time_ms` |  779 |  779 |  779 |  779 |
| `perm_trace_commit_time_ms` |  5,827 |  5,827 |  5,827 |  5,827 |
| `quotient_poly_compute_time_ms` |  6,799 |  6,799 |  6,799 |  6,799 |
| `quotient_poly_commit_time_ms` |  4,769 |  4,769 |  4,769 |  4,769 |
| `pcs_opening_time_ms ` |  6,160 |  6,160 |  6,160 |  6,160 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 8,058 | 41,680 | 9,646,120 | 1,069,222,360 | 30,209 | 6,799 | 4,769 | 5,827 | 6,160 | 5,872 | 439,933,251 | 779 | 3,413 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 278 | 2,618 | 285,169 | 56,159,799 | 2,165 | 261 | 306 | 528 | 630 | 395 | 15,074,875 | 42 | 175 | 
