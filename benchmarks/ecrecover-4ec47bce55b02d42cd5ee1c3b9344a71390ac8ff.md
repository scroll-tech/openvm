...
| `total_proof_time_ms ` |  2,746 |  2,746 |  2,746 |  2,746 |
...
| `pcs_opening_time_ms ` |  811 |  811 |  811 |  811 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,745 |  42,745 |  42,745 |  42,745 |
| `main_cells_used     ` |  445,609,708 |  445,609,708 |  445,609,708 |  445,609,708 |
| `total_cycles        ` |  9,776,188 |  9,776,188 |  9,776,188 |  9,776,188 |
| `execute_time_ms     ` |  5,672 |  5,672 |  5,672 |  5,672 |
| `trace_gen_time_ms   ` |  2,147 |  2,147 |  2,147 |  2,147 |
| `stark_prove_excluding_trace_time_ms` |  34,926 |  34,926 |  34,926 |  34,926 |
| `main_trace_commit_time_ms` |  6,324 |  6,324 |  6,324 |  6,324 |
| `generate_perm_trace_time_ms` |  786 |  786 |  786 |  786 |
| `perm_trace_commit_time_ms` |  6,172 |  6,172 |  6,172 |  6,172 |
| `quotient_poly_compute_time_ms` |  8,105 |  8,105 |  8,105 |  8,105 |
| `quotient_poly_commit_time_ms` |  5,105 |  5,105 |  5,105 |  5,105 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,147 | 42,745 | 9,776,188 | 1,069,222,360 | 34,926 | 8,105 | 5,105 | 6,172 | 8,431 | 6,324 | 445,609,708 | 786 | 5,672 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 72 | 2,746 | 290,016 | 55,907,135 | 2,376 | 276 | 308 | 528 | 811 | 405 | 15,230,037 | 44 | 298 | 
