...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,191 |  41,191 |  41,191 |  41,191 |
| `main_cells_used     ` |  365,893,486 |  365,893,486 |  365,893,486 |  365,893,486 |
| `total_cycles        ` |  8,653,657 |  8,653,657 |  8,653,657 |  8,653,657 |
| `execute_time_ms     ` |  2,622 |  2,622 |  2,622 |  2,622 |
| `trace_gen_time_ms   ` |  6,461 |  6,461 |  6,461 |  6,461 |
| `stark_prove_excluding_trace_time_ms` |  32,108 |  32,108 |  32,108 |  32,108 |
| `main_trace_commit_time_ms` |  5,790 |  5,790 |  5,790 |  5,790 |
| `generate_perm_trace_time_ms` |  709 |  709 |  709 |  709 |
| `perm_trace_commit_time_ms` |  7,076 |  7,076 |  7,076 |  7,076 |
| `quotient_poly_compute_time_ms` |  7,080 |  7,080 |  7,080 |  7,080 |
| `quotient_poly_commit_time_ms` |  5,066 |  5,066 |  5,066 |  5,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,461 | 41,191 | 8,653,657 | 1,052,183,000 | 32,108 | 7,080 | 5,066 | 7,076 | 6,383 | 5,790 | 365,893,486 | 709 | 2,622 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,587 | 285,401 | 56,172,159 | 2,180 | 288 | 308 | 530 | 620 | 395 | 15,092,297 | 36 | 145 | 
