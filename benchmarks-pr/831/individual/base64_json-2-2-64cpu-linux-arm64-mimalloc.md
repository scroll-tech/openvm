...
| --- | --- | --- | --- | --- |
| base64_json_program | <div style='text-align: right'>2</div>  | <span style="color: red">(+6,032,838 [+67.3%])</span> <div style='text-align: right'>14,993,390</div>  | <div style='text-align: right'>217,349</div>  | <span style="color: green">(-127.0 [-4.5%])</span> <div style='text-align: right'>2,708.0</div>  |
...
| --- | --- | --- | --- | --- |
| base64_json_program | true | <span style="color: green">(-4,640.0 [-78.5%])</span> <div style='text-align: right'>1,272.0</div>  | <span style="color: red">(+6,032,838 [+67.3%])</span> <div style='text-align: right'>14,993,390</div>  | <div style='text-align: right'>217,349</div>  |

| group | chip_name | collect_metrics | rows_used |
| --- | --- | --- | --- |
| base64_json_program | ProgramChip | true | <span style="color: red">(+2 [+0.0%])</span> <div style='text-align: right'>19,410</div>  |
...
| base64_json_program | Merkle | true | <div style='text-align: right'>5,534</div>  |
...
| base64_json_program | Poseidon2VmAir<BabyBearParameters> | true | <div style='text-align: right'>10,714</div>  |
...
| base64_json_program | Merkle | true |  | HINT_STOREW | <span style="color: green">(-128 [-0.3%])</span> <div style='text-align: right'>49,920</div>  |
...
| base64_json_program | Merkle | true |  | LOADBU | <span style="color: green">(-256 [-2.1%])</span> <div style='text-align: right'>12,224</div>  |
...
| base64_json_program | Merkle | true |  | LOADW | <span style="color: red">(+64 [+0.5%])</span> <div style='text-align: right'>12,608</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| base64_json_program | <div style='text-align: right'>14.0</div>  | <span style="color: green">(-101.0 [-15.9%])</span> <div style='text-align: right'>533.0</div>  | <span style="color: green">(-99.0 [-20.9%])</span> <div style='text-align: right'>375.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-13.0 [-6.1%])</span> <div style='text-align: right'>199.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+6,032,838 [+67.3%])</span> <div style='text-align: right'>14,993,390</div>  | <div style='text-align: right'>217,349</div>  | <span style="color: green">(-127.0 [-4.5%])</span> <div style='text-align: right'>2,708.0</div>  |
...
| --- | --- | --- | --- | --- |
| base64_json_program | 0 | <span style="color: green">(-2.0 [-1.3%])</span> <div style='text-align: right'>155.0</div>  | <span style="color: green">(-24.0 [-1.2%])</span> <div style='text-align: right'>2,020.0</div>  | <div style='text-align: right'>49,353,492</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0c63a7a78f5a0237376f5575508cd777064f626c/base64_json-2-2-64cpu-linux-arm64-mimalloc-base64_json_program.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/0c63a7a78f5a0237376f5575508cd777064f626c

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11877299169)
