...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,110 [+0.0%])</span> <div style='text-align: right'>48,128,235</div>  | <span style="color: red">(+62 [+0.0%])</span> <div style='text-align: right'>198,667</div>  | <span style="color: green">(-49.0 [-0.9%])</span> <div style='text-align: right'>5,677.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-10.0%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: green">(-28.0 [-1.6%])</span> <div style='text-align: right'>1,682.0</div>  | <div style='text-align: right'>580.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+1.5%])</span> <div style='text-align: right'>66.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,110 [+0.0%])</span> <div style='text-align: right'>48,128,235</div>  | <span style="color: red">(+62 [+0.0%])</span> <div style='text-align: right'>198,667</div>  | <span style="color: green">(-49.0 [-0.9%])</span> <div style='text-align: right'>5,677.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+28 [+0.0%])</span> <div style='text-align: right'>58,200</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+14 [+0.0%])</span> <div style='text-align: right'>35,800</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+62 [+1.2%])</span> <div style='text-align: right'>5,191</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+62 [+1.2%])</span> <div style='text-align: right'>5,191</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+154 [+1.2%])</span> <div style='text-align: right'>13,123</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+91 [+1.2%])</span> <div style='text-align: right'>7,917</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+154 [+1.0%])</span> <div style='text-align: right'>15,224</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+91 [+1.0%])</span> <div style='text-align: right'>8,996</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+620 [+1.2%])</span> <div style='text-align: right'>51,910</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+8.0 [+0.7%])</span> <div style='text-align: right'>1,085.0</div>  | <span style="color: green">(-29.0 [-1.0%])</span> <div style='text-align: right'>2,910.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/b9b70a13faa304274a489dc92891a5d9fa2960a0/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/b9b70a13faa304274a489dc92891a5d9fa2960a0

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12185414580)
