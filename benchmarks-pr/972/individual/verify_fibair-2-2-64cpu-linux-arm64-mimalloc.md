...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+630 [+0.0%])</span> <div style='text-align: right'>48,126,455</div>  | <span style="color: red">(+42 [+0.0%])</span> <div style='text-align: right'>198,587</div>  | <span style="color: green">(-28.0 [-0.5%])</span> <div style='text-align: right'>5,683.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+1.0 [+11.1%])</span> <div style='text-align: right'>10.0</div>  | <span style="color: green">(-20.0 [-1.2%])</span> <div style='text-align: right'>1,703.0</div>  | <span style="color: green">(-16.0 [-2.7%])</span> <div style='text-align: right'>566.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>64.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+630 [+0.0%])</span> <div style='text-align: right'>48,126,455</div>  | <span style="color: red">(+42 [+0.0%])</span> <div style='text-align: right'>198,587</div>  | <span style="color: green">(-28.0 [-0.5%])</span> <div style='text-align: right'>5,683.0</div>  | <span style="color: green">(-1.0 [-6.7%])</span> <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+12 [+0.0%])</span> <div style='text-align: right'>58,144</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+6 [+0.0%])</span> <div style='text-align: right'>35,772</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+42 [+0.8%])</span> <div style='text-align: right'>5,111</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+42 [+0.8%])</span> <div style='text-align: right'>5,111</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+66 [+0.5%])</span> <div style='text-align: right'>12,815</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+39 [+0.5%])</span> <div style='text-align: right'>7,735</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+66 [+0.4%])</span> <div style='text-align: right'>14,916</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+39 [+0.4%])</span> <div style='text-align: right'>8,814</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+420 [+0.8%])</span> <div style='text-align: right'>51,110</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+3.0 [+0.3%])</span> <div style='text-align: right'>1,082.0</div>  | <span style="color: green">(-11.0 [-0.4%])</span> <div style='text-align: right'>2,898.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d5b05ee2628bbd1ebca273f9718a69a817493adb/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/d5b05ee2628bbd1ebca273f9718a69a817493adb

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12229722488)
