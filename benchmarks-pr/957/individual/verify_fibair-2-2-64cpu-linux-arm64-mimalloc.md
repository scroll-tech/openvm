...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,470 [-0.0%])</span> <div style='text-align: right'>48,126,755</div>  | <span style="color: green">(-63 [-0.0%])</span> <div style='text-align: right'>198,582</div>  | <span style="color: green">(-144.0 [-2.5%])</span> <div style='text-align: right'>5,569.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>9.0</div>  | <span style="color: green">(-21.0 [-1.2%])</span> <div style='text-align: right'>1,673.0</div>  | <span style="color: red">(+1.0 [+0.2%])</span> <div style='text-align: right'>575.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>65.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,470 [-0.0%])</span> <div style='text-align: right'>48,126,755</div>  | <span style="color: green">(-63 [-0.0%])</span> <div style='text-align: right'>198,582</div>  | <span style="color: green">(-144.0 [-2.5%])</span> <div style='text-align: right'>5,569.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: green">(-48 [-0.1%])</span> <div style='text-align: right'>58,164</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: green">(-24 [-0.1%])</span> <div style='text-align: right'>35,782</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: green">(-63 [-1.2%])</span> <div style='text-align: right'>5,106</div>  |
...
| verify_fibair |  | JAL | <span style="color: green">(-63 [-1.2%])</span> <div style='text-align: right'>5,106</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: green">(-264 [-2.0%])</span> <div style='text-align: right'>12,925</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: green">(-156 [-2.0%])</span> <div style='text-align: right'>7,800</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: green">(-264 [-1.7%])</span> <div style='text-align: right'>15,026</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: green">(-156 [-1.7%])</span> <div style='text-align: right'>8,879</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: green">(-630 [-1.2%])</span> <div style='text-align: right'>51,060</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-17.0 [-1.6%])</span> <div style='text-align: right'>1,057.0</div>  | <span style="color: green">(-106.0 [-3.6%])</span> <div style='text-align: right'>2,839.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/50351fbe0bea2159612cbfb49bc079190a89cc34/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/50351fbe0bea2159612cbfb49bc079190a89cc34

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12195406366)
