...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,490 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+79 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+6.0 [+0.1%])</span> <div style='text-align: right'>5,715.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>9.0</div>  | <span style="color: green">(-5.0 [-0.3%])</span> <div style='text-align: right'>1,706.0</div>  | <span style="color: green">(-4.0 [-0.7%])</span> <div style='text-align: right'>580.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-3.0 [-4.7%])</span> <div style='text-align: right'>61.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,490 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+79 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+6.0 [+0.1%])</span> <div style='text-align: right'>5,715.0</div>  | <span style="color: green">(-1.0 [-6.7%])</span> <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+40 [+0.1%])</span> <div style='text-align: right'>58,212</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+20 [+0.1%])</span> <div style='text-align: right'>35,806</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+79 [+1.6%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+79 [+1.6%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+220 [+1.7%])</span> <div style='text-align: right'>13,189</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+130 [+1.7%])</span> <div style='text-align: right'>7,956</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+220 [+1.5%])</span> <div style='text-align: right'>15,290</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+130 [+1.5%])</span> <div style='text-align: right'>9,035</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+790 [+1.6%])</span> <div style='text-align: right'>51,690</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+3.0 [+0.3%])</span> <div style='text-align: right'>1,088.0</div>  | <span style="color: red">(+8.0 [+0.3%])</span> <div style='text-align: right'>2,921.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f4e2a0a3304a7cd4dc66d68a2c2f909c0c68bbe/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
