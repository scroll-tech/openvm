...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,120 [-0.0%])</span> <div style='text-align: right'>8,424,907</div>  | <span style="color: green">(-42 [-0.0%])</span> <div style='text-align: right'>198,482</div>  | <span style="color: green">(-41.0 [-2.5%])</span> <div style='text-align: right'>1,609.0</div>  |
...
| --- | --- |
| <span style="color: red">(+3.0 [+30.0%])</span> <div style='text-align: right'>13.0</div>  | <div style='text-align: right'>32</div>  |

| group | collect_metrics | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: red">(+2.0 [+0.2%])</span> <div style='text-align: right'>1,009.0</div>  | <span style="color: green">(-1,120 [-0.0%])</span> <div style='text-align: right'>8,424,907</div>  | <span style="color: green">(-42 [-0.0%])</span> <div style='text-align: right'>198,482</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: green">(-40 [-0.2%])</span> <div style='text-align: right'>21,952</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: green">(-20 [-0.2%])</span> <div style='text-align: right'>10,976</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: green">(-42 [-0.8%])</span> <div style='text-align: right'>5,023</div>  |
...
| verify_fibair | true |  | JAL | <span style="color: green">(-42 [-0.8%])</span> <div style='text-align: right'>5,023</div>  |
...
| verify_fibair | AccessAdapter<2> | true |  | ADD | <span style="color: green">(-220 [-1.9%])</span> <div style='text-align: right'>11,660</div>  |
| verify_fibair | AccessAdapter<4> | true |  | ADD | <span style="color: green">(-130 [-1.9%])</span> <div style='text-align: right'>6,890</div>  |
...
| verify_fibair | AccessAdapter<2> | true |  | BBE4MUL | <span style="color: green">(-220 [-1.4%])</span> <div style='text-align: right'>15,488</div>  |
| verify_fibair | AccessAdapter<4> | true |  | BBE4MUL | <span style="color: green">(-130 [-1.4%])</span> <div style='text-align: right'>9,152</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true |  | JAL | <span style="color: green">(-420 [-0.8%])</span> <div style='text-align: right'>50,230</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-10.0%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: green">(-1.0 [-0.4%])</span> <div style='text-align: right'>235.0</div>  | <div style='text-align: right'>185.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>51.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,120 [-0.0%])</span> <div style='text-align: right'>8,424,907</div>  | <span style="color: green">(-42 [-0.0%])</span> <div style='text-align: right'>198,482</div>  | <span style="color: green">(-41.0 [-2.5%])</span> <div style='text-align: right'>1,609.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-2.0 [-4.0%])</span> <div style='text-align: right'>48.0</div>  | <span style="color: green">(-38.0 [-2.8%])</span> <div style='text-align: right'>1,326.0</div>  | <div style='text-align: right'>23,969,816</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/507c09488359a94d6b72be18a86b4216cdfa6596/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/507c09488359a94d6b72be18a86b4216cdfa6596

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12123738741)
