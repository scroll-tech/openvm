...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+420 [+0.0%])</span> <div style='text-align: right'>8,426,447</div>  | <span style="color: red">(+42 [+0.0%])</span> <div style='text-align: right'>198,566</div>  | <span style="color: green">(-15.0 [-0.9%])</span> <div style='text-align: right'>1,635.0</div>  |
...
| --- | --- |
| <span style="color: red">(+5.0 [+50.0%])</span> <div style='text-align: right'>15.0</div>  | <div style='text-align: right'>32</div>  |

| group | collect_metrics | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: green">(-5.0 [-0.5%])</span> <div style='text-align: right'>1,002.0</div>  | <span style="color: red">(+420 [+0.0%])</span> <div style='text-align: right'>8,426,447</div>  | <span style="color: red">(+42 [+0.0%])</span> <div style='text-align: right'>198,566</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: red">(+42 [+0.8%])</span> <div style='text-align: right'>5,107</div>  |
...
| verify_fibair | true |  | JAL | <span style="color: red">(+42 [+0.8%])</span> <div style='text-align: right'>5,107</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true |  | JAL | <span style="color: red">(+420 [+0.8%])</span> <div style='text-align: right'>51,070</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>10.0</div>  | <span style="color: red">(+3.0 [+1.3%])</span> <div style='text-align: right'>239.0</div>  | <span style="color: red">(+4.0 [+2.2%])</span> <div style='text-align: right'>189.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+2.0%])</span> <div style='text-align: right'>52.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+420 [+0.0%])</span> <div style='text-align: right'>8,426,447</div>  | <span style="color: red">(+42 [+0.0%])</span> <div style='text-align: right'>198,566</div>  | <span style="color: green">(-15.0 [-0.9%])</span> <div style='text-align: right'>1,635.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-1.0 [-2.0%])</span> <div style='text-align: right'>49.0</div>  | <span style="color: green">(-17.0 [-1.2%])</span> <div style='text-align: right'>1,347.0</div>  | <div style='text-align: right'>23,969,816</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/22f7f17bab5fcca896bc98cd89581d55802dc499/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/22f7f17bab5fcca896bc98cd89581d55802dc499

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12123199887)
