...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,260 [-0.0%])</span> <div style='text-align: right'>48,125,887</div>  | <span style="color: green">(-70 [-0.0%])</span> <div style='text-align: right'>397,094</div>  | <span style="color: green">(-69.0 [-2.3%])</span> <div style='text-align: right'>2,973.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <span style="color: red">(+1.0 [+12.5%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: green">(-6.0 [-0.3%])</span> <div style='text-align: right'>1,752.0</div>  | <span style="color: green">(-11.0 [-1.4%])</span> <div style='text-align: right'>754.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-9.0 [-2.5%])</span> <div style='text-align: right'>344.0</div>  | <span style="color: green">(-2.0 [-18.2%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <span style="color: red">(+1.0 [+6.7%])</span> <div style='text-align: right'>16.0</div>  |

| segment | total_cycles | trace_gen_time_ms |
| --- | --- | --- |
| 0 | <span style="color: green">(-35 [-0.0%])</span> <div style='text-align: right'>198,547</div>  | <span style="color: red">(+5.0 [+0.5%])</span> <div style='text-align: right'>997.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-69.0 [-2.3%])</span> <div style='text-align: right'>2,973.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: green">(-1,260 [-0.0%])</span> <div style='text-align: right'>48,125,887</div>  | <span style="color: green">(-70 [-0.0%])</span> <div style='text-align: right'>397,094</div>  | <span style="color: green">(-7.0 [-0.7%])</span> <div style='text-align: right'>982.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: green">(-52 [-0.1%])</span> <div style='text-align: right'>58,132</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: green">(-26 [-0.1%])</span> <div style='text-align: right'>35,766</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-35 [-0.7%])</span> <div style='text-align: right'>5,069</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-35 [-0.7%])</span> <div style='text-align: right'>5,069</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: green">(-286 [-2.2%])</span> <div style='text-align: right'>12,661</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: green">(-169 [-2.2%])</span> <div style='text-align: right'>7,644</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: green">(-286 [-1.9%])</span> <div style='text-align: right'>14,850</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: green">(-169 [-1.9%])</span> <div style='text-align: right'>8,775</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-350 [-0.7%])</span> <div style='text-align: right'>50,690</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-0.1%])</span> <div style='text-align: right'>759.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,260 [-0.0%])</span> <div style='text-align: right'>48,125,887</div>  | <span style="color: green">(-70 [-0.0%])</span> <div style='text-align: right'>397,094</div>  | <span style="color: green">(-69.0 [-2.3%])</span> <div style='text-align: right'>2,973.0</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/30a29cdd2580d5375b5f288118bc50e8bf343bf1/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/30a29cdd2580d5375b5f288118bc50e8bf343bf1
...
[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12306797392)
