...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-2,580 [-0.0%])</span> <div style='text-align: right'>48,125,867</div>  | <span style="color: green">(-306 [-0.1%])</span> <div style='text-align: right'>397,034</div>  | <span style="color: red">(+92.0 [+3.2%])</span> <div style='text-align: right'>3,011.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <span style="color: green">(-1.0 [-11.1%])</span> <div style='text-align: right'>8.0</div>  | <span style="color: green">(-41.0 [-2.3%])</span> <div style='text-align: right'>1,764.0</div>  | <span style="color: red">(+52.0 [+7.3%])</span> <div style='text-align: right'>761.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-8.0 [-2.3%])</span> <div style='text-align: right'>342.0</div>  | <span style="color: green">(-3.0 [-25.0%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <div style='text-align: right'>15.0</div>  |

| segment | total_cycles | trace_gen_time_ms |
| --- | --- | --- |
| 0 | <span style="color: green">(-153 [-0.1%])</span> <div style='text-align: right'>198,517</div>  | <span style="color: green">(-93.0 [-8.5%])</span> <div style='text-align: right'>1,002.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+92.0 [+3.2%])</span> <div style='text-align: right'>3,011.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: green">(-2,580 [-0.0%])</span> <div style='text-align: right'>48,125,867</div>  | <span style="color: green">(-306 [-0.1%])</span> <div style='text-align: right'>397,034</div>  | <span style="color: green">(-97.0 [-9.0%])</span> <div style='text-align: right'>985.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: green">(-60 [-0.1%])</span> <div style='text-align: right'>58,148</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: green">(-30 [-0.1%])</span> <div style='text-align: right'>35,774</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-153 [-2.9%])</span> <div style='text-align: right'>5,039</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-153 [-2.9%])</span> <div style='text-align: right'>5,039</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: green">(-330 [-2.5%])</span> <div style='text-align: right'>12,749</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: green">(-195 [-2.5%])</span> <div style='text-align: right'>7,696</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: green">(-330 [-2.2%])</span> <div style='text-align: right'>14,938</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: green">(-195 [-2.2%])</span> <div style='text-align: right'>8,827</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-1,530 [-2.9%])</span> <div style='text-align: right'>50,390</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+48.0 [+6.9%])</span> <div style='text-align: right'>747.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-2,580 [-0.0%])</span> <div style='text-align: right'>48,125,867</div>  | <span style="color: green">(-306 [-0.1%])</span> <div style='text-align: right'>397,034</div>  | <span style="color: red">(+92.0 [+3.2%])</span> <div style='text-align: right'>3,011.0</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/64fe14d337123ae4222e4d60db91adc3b6a5db2d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)
