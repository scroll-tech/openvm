...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+2,560 [+0.0%])</span> <div style='text-align: right'>48,128,385</div>  | <span style="color: red">(+123 [+0.1%])</span> <div style='text-align: right'>198,668</div>  | <span style="color: green">(-56.0 [-1.0%])</span> <div style='text-align: right'>5,588.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-3.0 [-25.0%])</span> <div style='text-align: right'>9.0</div>  | <span style="color: green">(-11.0 [-0.7%])</span> <div style='text-align: right'>1,668.0</div>  | <span style="color: green">(-11.0 [-1.9%])</span> <div style='text-align: right'>572.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+2.0 [+3.2%])</span> <div style='text-align: right'>65.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+2,560 [+0.0%])</span> <div style='text-align: right'>48,128,385</div>  | <span style="color: red">(+123 [+0.1%])</span> <div style='text-align: right'>198,668</div>  | <span style="color: green">(-56.0 [-1.0%])</span> <div style='text-align: right'>5,588.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+76 [+0.1%])</span> <div style='text-align: right'>58,208</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+38 [+0.1%])</span> <div style='text-align: right'>35,804</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+123 [+2.4%])</span> <div style='text-align: right'>5,192</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+123 [+2.4%])</span> <div style='text-align: right'>5,192</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+418 [+3.3%])</span> <div style='text-align: right'>13,167</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+247 [+3.2%])</span> <div style='text-align: right'>7,943</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+418 [+2.8%])</span> <div style='text-align: right'>15,268</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+247 [+2.8%])</span> <div style='text-align: right'>9,022</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+1,230 [+2.4%])</span> <div style='text-align: right'>51,920</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+3.0 [+0.3%])</span> <div style='text-align: right'>1,065.0</div>  | <span style="color: green">(-48.0 [-1.7%])</span> <div style='text-align: right'>2,855.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/732bd70d8e66e0fdf6a9293eb71a60c28a5cb29b/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
