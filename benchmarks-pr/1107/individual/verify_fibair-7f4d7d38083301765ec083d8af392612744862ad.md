...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+910 [+0.0%])</span> <div style='text-align: right'>48,126,797</div>  | <span style="color: red">(+126 [+0.0%])</span> <div style='text-align: right'>397,220</div>  | <span style="color: red">(+37.0 [+1.2%])</span> <div style='text-align: right'>3,210.0</div>  |
...
| --- | --- | --- | --- | --- | --- |
| <span style="color: green">(-1.0 [-11.1%])</span> <div style='text-align: right'>8.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-8.0 [-2.2%])</span> <div style='text-align: right'>353.0</div>  | <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <span style="color: red">(+1.0 [+6.7%])</span> <div style='text-align: right'>16.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+37.0 [+1.2%])</span> <div style='text-align: right'>3,210.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: red">(+910 [+0.0%])</span> <div style='text-align: right'>48,126,797</div>  | <span style="color: red">(+126 [+0.0%])</span> <div style='text-align: right'>397,220</div>  | <span style="color: red">(+39.0 [+4.0%])</span> <div style='text-align: right'>1,016.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: red">(+16 [+0.0%])</span> <div style='text-align: right'>58,148</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>35,774</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: red">(+63 [+1.2%])</span> <div style='text-align: right'>5,132</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: red">(+63 [+1.2%])</span> <div style='text-align: right'>5,132</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: red">(+88 [+0.7%])</span> <div style='text-align: right'>12,749</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: red">(+52 [+0.7%])</span> <div style='text-align: right'>7,696</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: red">(+88 [+0.6%])</span> <div style='text-align: right'>14,938</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: red">(+52 [+0.6%])</span> <div style='text-align: right'>8,827</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: red">(+630 [+1.2%])</span> <div style='text-align: right'>51,320</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+16.0 [+2.6%])</span> <div style='text-align: right'>630.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+910 [+0.0%])</span> <div style='text-align: right'>48,126,797</div>  | <span style="color: red">(+126 [+0.0%])</span> <div style='text-align: right'>397,220</div>  | <span style="color: red">(+37.0 [+1.2%])</span> <div style='text-align: right'>3,210.0</div>  |
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7f4d7d38083301765ec083d8af392612744862ad/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)
