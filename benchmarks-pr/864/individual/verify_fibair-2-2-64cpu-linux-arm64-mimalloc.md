...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+12,962 [+0.2%])</span> <div style='text-align: right'>8,308,097</div>  | <span style="color: red">(+728 [+0.4%])</span> <div style='text-align: right'>199,263</div>  | <span style="color: red">(+25.0 [+1.8%])</span> <div style='text-align: right'>1,438.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: green">(-22.0 [-2.2%])</span> <div style='text-align: right'>996.0</div>  | <span style="color: red">(+12,962 [+0.2%])</span> <div style='text-align: right'>8,308,097</div>  | <span style="color: red">(+728 [+0.4%])</span> <div style='text-align: right'>199,263</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: red">(+40 [+0.2%])</span> <div style='text-align: right'>22,036</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: red">(+20 [+0.2%])</span> <div style='text-align: right'>11,018</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: red">(+79 [+1.6%])</span> <div style='text-align: right'>5,155</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: green">(-684 [-1.0%])</span> <div style='text-align: right'>67,453</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: red">(+649 [+100.3%])</span> <div style='text-align: right'>1,296</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: red">(+79 [+8.1%])</span> <div style='text-align: right'>1,051</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: red">(+220 [+1.9%])</span> <div style='text-align: right'>12,078</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: red">(+130 [+1.9%])</span> <div style='text-align: right'>7,137</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: red">(+19,470 [+100.3%])</span> <div style='text-align: right'>38,880</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: red">(+790 [+8.1%])</span> <div style='text-align: right'>10,510</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: red">(+220 [+1.6%])</span> <div style='text-align: right'>14,058</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: red">(+130 [+1.6%])</span> <div style='text-align: right'>8,307</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+5.0 [+62.5%])</span> <div style='text-align: right'>13.0</div>  | <span style="color: green">(-3.0 [-1.2%])</span> <div style='text-align: right'>245.0</div>  | <div style='text-align: right'>195.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+2.0 [+4.8%])</span> <div style='text-align: right'>44.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+12,962 [+0.2%])</span> <div style='text-align: right'>8,308,097</div>  | <span style="color: red">(+728 [+0.4%])</span> <div style='text-align: right'>199,263</div>  | <span style="color: red">(+25.0 [+1.8%])</span> <div style='text-align: right'>1,438.0</div>  | <span style="color: red">(+2.0 [+13.3%])</span> <div style='text-align: right'>17.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-3.0 [-5.8%])</span> <div style='text-align: right'>49.0</div>  | <span style="color: red">(+31.0 [+2.8%])</span> <div style='text-align: right'>1,144.0</div>  | <span style="color: red">(+294,912 [+1.3%])</span> <div style='text-align: right'>23,085,080</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/d3c02890181ca27a17cd4ad60304ab6d2c30bb81/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/d3c02890181ca27a17cd4ad60304ab6d2c30bb81

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12035826029)
