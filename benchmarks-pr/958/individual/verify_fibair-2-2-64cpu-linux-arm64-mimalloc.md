...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-80 [-0.0%])</span> <div style='text-align: right'>48,128,145</div>  | <span style="color: red">(+6 [+0.0%])</span> <div style='text-align: right'>198,651</div>  | <span style="color: green">(-12.0 [-0.2%])</span> <div style='text-align: right'>5,701.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: red">(+1.0 [+11.1%])</span> <div style='text-align: right'>10.0</div>  | <span style="color: red">(+3.0 [+0.2%])</span> <div style='text-align: right'>1,697.0</div>  | <span style="color: red">(+7.0 [+1.2%])</span> <div style='text-align: right'>581.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+1.5%])</span> <div style='text-align: right'>66.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-80 [-0.0%])</span> <div style='text-align: right'>48,128,145</div>  | <span style="color: red">(+6 [+0.0%])</span> <div style='text-align: right'>198,651</div>  | <span style="color: green">(-12.0 [-0.2%])</span> <div style='text-align: right'>5,701.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: green">(-8 [-0.0%])</span> <div style='text-align: right'>58,204</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: green">(-4 [-0.0%])</span> <div style='text-align: right'>35,802</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+6 [+0.1%])</span> <div style='text-align: right'>5,175</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+6 [+0.1%])</span> <div style='text-align: right'>5,175</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: green">(-44 [-0.3%])</span> <div style='text-align: right'>13,145</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: green">(-26 [-0.3%])</span> <div style='text-align: right'>7,930</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: green">(-44 [-0.3%])</span> <div style='text-align: right'>15,246</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: green">(-26 [-0.3%])</span> <div style='text-align: right'>9,009</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+60 [+0.1%])</span> <div style='text-align: right'>51,750</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-10.0 [-0.9%])</span> <div style='text-align: right'>1,064.0</div>  | <span style="color: green">(-5.0 [-0.2%])</span> <div style='text-align: right'>2,940.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/4b3b2a95ea11901050e6f1e9bb6d4543e00c3d07

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/12202793774)
