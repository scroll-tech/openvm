...
| --- | --- | --- | --- | --- |
| fibonacci_program | <div style='text-align: right'>2</div>  | <div style='text-align: right'>51,514,594</div>  | <div style='text-align: right'>1,500,219</div>  | <span style="color: red">(+201.0 [+2.9%])</span> <div style='text-align: right'>7,028.0</div>  |
| leaf_aggregation | <div style='text-align: right'>2</div>  | <span style="color: green">(-17,930 [-0.0%])</span> <div style='text-align: right'>143,303,076</div>  | <span style="color: green">(-1,643 [-0.0%])</span> <div style='text-align: right'>3,501,625</div>  | <span style="color: red">(+800.0 [+4.3%])</span> <div style='text-align: right'>19,560.0</div>  |
...
| --- | --- | --- | --- | --- |
| fibonacci_program | true | <span style="color: red">(+358.0 [+6.8%])</span> <div style='text-align: right'>5,648.0</div>  | <div style='text-align: right'>51,514,594</div>  | <div style='text-align: right'>1,500,219</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | <div style='text-align: right'>7.0</div>  | <span style="color: red">(+87.0 [+8.7%])</span> <div style='text-align: right'>1,082.0</div>  | <span style="color: red">(+77.0 [+9.2%])</span> <div style='text-align: right'>917.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+7.0 [+3.6%])</span> <div style='text-align: right'>199.0</div>  | <div style='text-align: right'>1</div>  | <div style='text-align: right'>51,514,594</div>  | <div style='text-align: right'>1,500,219</div>  | <span style="color: red">(+201.0 [+2.9%])</span> <div style='text-align: right'>7,028.0</div>  |
| leaf_aggregation |  |  |  | <div style='text-align: right'>2</div>  |  |  | <span style="color: green">(-17,930 [-0.0%])</span> <div style='text-align: right'>143,303,076</div>  | <span style="color: green">(-1,643 [-0.0%])</span> <div style='text-align: right'>3,501,625</div>  | <span style="color: red">(+800.0 [+4.3%])</span> <div style='text-align: right'>19,560.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 |  | <span style="color: red">(+8.0 [+5.2%])</span> <div style='text-align: right'>162.0</div>  |  |  |  |  | <span style="color: red">(+106.0 [+1.9%])</span> <div style='text-align: right'>5,784.0</div>  | <div style='text-align: right'>196,595,668</div>  |  |
| leaf_aggregation | 0 | <span style="color: green">(-1.0 [-2.4%])</span> <div style='text-align: right'>41.0</div>  | <span style="color: red">(+104.0 [+2.8%])</span> <div style='text-align: right'>3,813.0</div>  | <span style="color: red">(+84.0 [+2.7%])</span> <div style='text-align: right'>3,229.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-4.0 [-7.5%])</span> <div style='text-align: right'>49.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+696.0 [+4.6%])</span> <div style='text-align: right'>15,747.0</div>  | <div style='text-align: right'>398,753,816</div>  | <span style="color: green">(-2.0 [-0.8%])</span> <div style='text-align: right'>239.0</div>  |

| group | collect_metrics | segment | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- | --- |
| leaf_aggregation | true | 0 | <span style="color: red">(+852.0 [+5.8%])</span> <div style='text-align: right'>15,524.0</div>  | <span style="color: green">(-17,930 [-0.0%])</span> <div style='text-align: right'>143,303,076</div>  | <span style="color: green">(-1,643 [-0.0%])</span> <div style='text-align: right'>3,501,625</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | 0 | <span style="color: green">(-72 [-0.0%])</span> <div style='text-align: right'>400,424</div>  |
| leaf_aggregation | AccessAdapter<4> | true | 0 | <span style="color: green">(-36 [-0.0%])</span> <div style='text-align: right'>200,464</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | 0 | <span style="color: green">(-1,631 [-2.2%])</span> <div style='text-align: right'>72,171</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | 0 | <span style="color: green">(-12 [-0.0%])</span> <div style='text-align: right'>1,352,931</div>  |
...
| leaf_aggregation | true | AddFI | ADD | 0 | <span style="color: green">(-12 [-0.0%])</span> <div style='text-align: right'>44,861</div>  |
...
| leaf_aggregation | true | IfEqI | JAL | 0 | <span style="color: green">(-1,631 [-5.5%])</span> <div style='text-align: right'>28,282</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | AddEI | ADD | 0 | <span style="color: green">(-396 [-0.2%])</span> <div style='text-align: right'>184,426</div>  |
| leaf_aggregation | AccessAdapter<4> | true | AddEI | ADD | 0 | <span style="color: green">(-234 [-0.2%])</span> <div style='text-align: right'>108,979</div>  |
| leaf_aggregation | Boundary | true | AddEI | ADD | 0 | <div style='text-align: right'>135,608</div>  |
| leaf_aggregation | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | 0 | <span style="color: green">(-360 [-0.0%])</span> <div style='text-align: right'>1,345,830</div>  |
...
| leaf_aggregation | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | 0 | <span style="color: green">(-16,310 [-5.5%])</span> <div style='text-align: right'>282,820</div>  |
...
| leaf_aggregation | AccessAdapter<2> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-396 [-0.2%])</span> <div style='text-align: right'>223,564</div>  |
| leaf_aggregation | AccessAdapter<4> | true | MulE | BBE4MUL | 0 | <span style="color: green">(-234 [-0.2%])</span> <div style='text-align: right'>132,106</div>  |
