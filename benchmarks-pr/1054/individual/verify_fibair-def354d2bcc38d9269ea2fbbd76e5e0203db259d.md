...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,100 [+0.0%])</span> <div style='text-align: right'>48,128,287</div>  | <span style="color: red">(+80 [+0.0%])</span> <div style='text-align: right'>397,294</div>  | <span style="color: green">(-11.0 [-0.3%])</span> <div style='text-align: right'>3,164.0</div>  |
...
| --- | --- | --- | --- | --- | --- |
| <span style="color: green">(-1.0 [-11.1%])</span> <div style='text-align: right'>8.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+3.0 [+0.8%])</span> <div style='text-align: right'>357.0</div>  | <span style="color: red">(+1.0 [+10.0%])</span> <div style='text-align: right'>11.0</div>  | <div style='text-align: right'>32</div>  | <div style='text-align: right'>15.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-11.0 [-0.3%])</span> <div style='text-align: right'>3,164.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: red">(+1,100 [+0.0%])</span> <div style='text-align: right'>48,128,287</div>  | <span style="color: red">(+80 [+0.0%])</span> <div style='text-align: right'>397,294</div>  | <span style="color: green">(-13.0 [-1.3%])</span> <div style='text-align: right'>972.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: red">(+40 [+0.1%])</span> <div style='text-align: right'>58,212</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: red">(+20 [+0.1%])</span> <div style='text-align: right'>35,806</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: red">(+40 [+0.8%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: red">(+40 [+0.8%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: red">(+220 [+1.7%])</span> <div style='text-align: right'>13,101</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: red">(+130 [+1.7%])</span> <div style='text-align: right'>7,904</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: red">(+220 [+1.5%])</span> <div style='text-align: right'>15,290</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: red">(+130 [+1.5%])</span> <div style='text-align: right'>9,035</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: red">(+400 [+0.8%])</span> <div style='text-align: right'>51,690</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-26.0 [-4.1%])</span> <div style='text-align: right'>607.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,100 [+0.0%])</span> <div style='text-align: right'>48,128,287</div>  | <span style="color: red">(+80 [+0.0%])</span> <div style='text-align: right'>397,294</div>  | <span style="color: green">(-11.0 [-0.3%])</span> <div style='text-align: right'>3,164.0</div>  |
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/def354d2bcc38d9269ea2fbbd76e5e0203db259d/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/openvm-org/openvm/commit/def354d2bcc38d9269ea2fbbd76e5e0203db259d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/12345579977)
