...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-530 [-0.0%])</span> <div style='text-align: right'>48,126,657</div>  | <span style="color: green">(-134 [-0.0%])</span> <div style='text-align: right'>397,080</div>  | <span style="color: green">(-40.0 [-1.3%])</span> <div style='text-align: right'>3,135.0</div>  |
...
| --- | --- | --- | --- | --- | --- |
| <span style="color: red">(+1.0 [+11.1%])</span> <div style='text-align: right'>10.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+4.0 [+1.1%])</span> <div style='text-align: right'>358.0</div>  | <span style="color: green">(-1.0 [-10.0%])</span> <div style='text-align: right'>9.0</div>  | <div style='text-align: right'>32</div>  | <div style='text-align: right'>15.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-40.0 [-1.3%])</span> <div style='text-align: right'>3,135.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: green">(-530 [-0.0%])</span> <div style='text-align: right'>48,126,657</div>  | <span style="color: green">(-134 [-0.0%])</span> <div style='text-align: right'>397,080</div>  | <span style="color: green">(-23.0 [-2.3%])</span> <div style='text-align: right'>962.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: red">(+8 [+0.0%])</span> <div style='text-align: right'>58,180</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: red">(+4 [+0.0%])</span> <div style='text-align: right'>35,790</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-67 [-1.3%])</span> <div style='text-align: right'>5,062</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-67 [-1.3%])</span> <div style='text-align: right'>5,062</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: red">(+44 [+0.3%])</span> <div style='text-align: right'>12,925</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: red">(+26 [+0.3%])</span> <div style='text-align: right'>7,800</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: red">(+44 [+0.3%])</span> <div style='text-align: right'>15,114</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: red">(+26 [+0.3%])</span> <div style='text-align: right'>8,931</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-670 [-1.3%])</span> <div style='text-align: right'>50,620</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-20.0 [-3.2%])</span> <div style='text-align: right'>613.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-530 [-0.0%])</span> <div style='text-align: right'>48,126,657</div>  | <span style="color: green">(-134 [-0.0%])</span> <div style='text-align: right'>397,080</div>  | <span style="color: green">(-40.0 [-1.3%])</span> <div style='text-align: right'>3,135.0</div>  |
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/07f5fdd7eadf1245a1193932cd73881ce67bd983/verify_fibair-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/openvm-org/openvm/commit/07f5fdd7eadf1245a1193932cd73881ce67bd983
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/12345531123)
