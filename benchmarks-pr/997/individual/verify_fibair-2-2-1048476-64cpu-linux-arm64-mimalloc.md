...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-1,950 [-0.0%])</span> <div style='text-align: right'>48,126,337</div>  | <span style="color: green">(-83 [-0.0%])</span> <div style='text-align: right'>198,564</div>  | <span style="color: green">(-49.0 [-1.7%])</span> <div style='text-align: right'>2,907.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <span style="color: green">(-1.0 [-11.1%])</span> <div style='text-align: right'>8.0</div>  | <span style="color: red">(+12.0 [+0.7%])</span> <div style='text-align: right'>1,718.0</div>  | <span style="color: red">(+2.0 [+0.3%])</span> <div style='text-align: right'>620.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-4.0 [-1.1%])</span> <div style='text-align: right'>349.0</div>  | <div style='text-align: right'>11.0</div>  | <div style='text-align: right'>32</div>  | <span style="color: red">(+1.0 [+6.7%])</span> <div style='text-align: right'>16.0</div>  |

| group | segment | stark_prove_excluding_trace_time_ms | total_cells | total_cells_used | total_cycles | trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-49.0 [-1.7%])</span> <div style='text-align: right'>2,907.0</div>  | <div style='text-align: right'>107,769,880</div>  | <span style="color: green">(-1,950 [-0.0%])</span> <div style='text-align: right'>48,126,337</div>  | <span style="color: green">(-83 [-0.0%])</span> <div style='text-align: right'>198,564</div>  | <span style="color: red">(+10.0 [+0.9%])</span> <div style='text-align: right'>1,089.0</div>  |
...
| verify_fibair | AccessAdapter<2> | 0 | <span style="color: green">(-64 [-0.1%])</span> <div style='text-align: right'>58,148</div>  |
| verify_fibair | AccessAdapter<4> | 0 | <span style="color: green">(-32 [-0.1%])</span> <div style='text-align: right'>35,774</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 0 | <span style="color: green">(-83 [-1.6%])</span> <div style='text-align: right'>5,086</div>  |
...
| verify_fibair |  | JAL | 0 | <span style="color: green">(-83 [-1.6%])</span> <div style='text-align: right'>5,086</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | 0 | <span style="color: green">(-352 [-2.7%])</span> <div style='text-align: right'>12,749</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | 0 | <span style="color: green">(-208 [-2.6%])</span> <div style='text-align: right'>7,696</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | 0 | <span style="color: green">(-352 [-2.3%])</span> <div style='text-align: right'>14,938</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | 0 | <span style="color: green">(-208 [-2.3%])</span> <div style='text-align: right'>8,827</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | 0 | <span style="color: green">(-830 [-1.6%])</span> <div style='text-align: right'>50,860</div>  |
...
| --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-17.0 [-2.8%])</span> <div style='text-align: right'>581.0</div>  | <div style='text-align: right'>2</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-1,950 [-0.0%])</span> <div style='text-align: right'>48,126,337</div>  | <span style="color: green">(-83 [-0.0%])</span> <div style='text-align: right'>198,564</div>  | <span style="color: green">(-49.0 [-1.7%])</span> <div style='text-align: right'>2,907.0</div>  |
...
| --- | --- |
| 0 | <span style="color: red">(+10.0 [+0.9%])</span> <div style='text-align: right'>1,097.0</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7d99b67fe1a5242a9dc10d32449c366e7aae4b9e/verify_fibair-2-2-1048476-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
