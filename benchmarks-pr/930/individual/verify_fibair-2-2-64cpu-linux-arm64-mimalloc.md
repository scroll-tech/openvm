...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,140 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+65 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+1.0 [+0.0%])</span> <div style='text-align: right'>5,716.0</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>9.0</div>  | <span style="color: red">(+4.0 [+0.2%])</span> <div style='text-align: right'>1,711.0</div>  | <span style="color: red">(+6.0 [+1.0%])</span> <div style='text-align: right'>586.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-1.0 [-1.6%])</span> <div style='text-align: right'>63.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,140 [+0.0%])</span> <div style='text-align: right'>48,128,225</div>  | <span style="color: red">(+65 [+0.0%])</span> <div style='text-align: right'>198,645</div>  | <span style="color: red">(+1.0 [+0.0%])</span> <div style='text-align: right'>5,716.0</div>  | <div style='text-align: right'>14.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: red">(+28 [+0.0%])</span> <div style='text-align: right'>58,212</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: red">(+14 [+0.0%])</span> <div style='text-align: right'>35,806</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: red">(+65 [+1.3%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair |  | JAL | <span style="color: red">(+65 [+1.3%])</span> <div style='text-align: right'>5,169</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: red">(+154 [+1.2%])</span> <div style='text-align: right'>13,189</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: red">(+91 [+1.2%])</span> <div style='text-align: right'>7,956</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: red">(+154 [+1.0%])</span> <div style='text-align: right'>15,290</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: red">(+91 [+1.0%])</span> <div style='text-align: right'>9,035</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: red">(+650 [+1.3%])</span> <div style='text-align: right'>51,690</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: red">(+4.0 [+0.4%])</span> <div style='text-align: right'>1,082.0</div>  | <span style="color: green">(-7.0 [-0.2%])</span> <div style='text-align: right'>2,923.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0daea3823d0f1264a187820acf6e118187c1260d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
