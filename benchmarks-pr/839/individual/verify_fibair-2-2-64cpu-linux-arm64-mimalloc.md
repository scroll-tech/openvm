...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+1,240 [+0.0%])</span> <div style='text-align: right'>8,308,597</div>  | <span style="color: red">(+19 [+0.0%])</span> <div style='text-align: right'>199,286</div>  | <span style="color: green">(-12.0 [-0.8%])</span> <div style='text-align: right'>1,558.0</div>  |
...
| --- | --- |
| <span style="color: red">(+2.0 [+22.2%])</span> <div style='text-align: right'>11.0</div>  | <div style='text-align: right'>32</div>  |

| group | collect_metrics | execute_time_ms | total_cells_used | total_cycles |
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: red">(+9.0 [+0.8%])</span> <div style='text-align: right'>1,115.0</div>  | <span style="color: red">(+1,240 [+0.0%])</span> <div style='text-align: right'>8,308,597</div>  | <span style="color: red">(+19 [+0.0%])</span> <div style='text-align: right'>199,286</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: red">(+20 [+0.1%])</span> <div style='text-align: right'>22,024</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: red">(+10 [+0.1%])</span> <div style='text-align: right'>11,012</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: green">(-16 [-0.3%])</span> <div style='text-align: right'>5,154</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: red">(+35 [+0.1%])</span> <div style='text-align: right'>67,477</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: red">(+35 [+2.7%])</span> <div style='text-align: right'>1,320</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: green">(-16 [-1.5%])</span> <div style='text-align: right'>1,050</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: red">(+110 [+0.9%])</span> <div style='text-align: right'>12,012</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: red">(+65 [+0.9%])</span> <div style='text-align: right'>7,098</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: red">(+1,050 [+2.7%])</span> <div style='text-align: right'>39,600</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: green">(-160 [-1.5%])</span> <div style='text-align: right'>10,500</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: red">(+110 [+0.8%])</span> <div style='text-align: right'>13,992</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: red">(+65 [+0.8%])</span> <div style='text-align: right'>8,268</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-1.0 [-5.9%])</span> <div style='text-align: right'>16.0</div>  | <span style="color: red">(+5.0 [+1.9%])</span> <div style='text-align: right'>267.0</div>  | <span style="color: red">(+5.0 [+2.3%])</span> <div style='text-align: right'>219.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: red">(+1.0 [+2.2%])</span> <div style='text-align: right'>47.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+1,240 [+0.0%])</span> <div style='text-align: right'>8,308,597</div>  | <span style="color: red">(+19 [+0.0%])</span> <div style='text-align: right'>199,286</div>  | <span style="color: green">(-12.0 [-0.8%])</span> <div style='text-align: right'>1,558.0</div>  | <div style='text-align: right'>22.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <div style='text-align: right'>45.0</div>  | <span style="color: green">(-17.0 [-1.3%])</span> <div style='text-align: right'>1,246.0</div>  | <div style='text-align: right'>23,085,080</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/5f952d252aa01a0a9c56ea52f3bc80d440c99560/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/5f952d252aa01a0a9c56ea52f3bc80d440c99560

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11943643353)
