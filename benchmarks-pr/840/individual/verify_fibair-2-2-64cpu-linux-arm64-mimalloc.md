...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: red">(+4,070 [+0.0%])</span> <div style='text-align: right'>8,310,317</div>  | <span style="color: red">(+216 [+0.1%])</span> <div style='text-align: right'>199,383</div>  | <span style="color: green">(-23.0 [-1.5%])</span> <div style='text-align: right'>1,464.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | true | <span style="color: green">(-2.0 [-0.2%])</span> <div style='text-align: right'>1,027.0</div>  | <span style="color: red">(+4,070 [+0.0%])</span> <div style='text-align: right'>8,310,317</div>  | <span style="color: red">(+216 [+0.1%])</span> <div style='text-align: right'>199,383</div>  |
...
| verify_fibair | AccessAdapter<2> | true | <span style="color: red">(+60 [+0.3%])</span> <div style='text-align: right'>22,052</div>  |
| verify_fibair | AccessAdapter<4> | true | <span style="color: red">(+30 [+0.3%])</span> <div style='text-align: right'>11,026</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | <span style="color: red">(+173 [+3.4%])</span> <div style='text-align: right'>5,238</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | <span style="color: red">(+43 [+0.1%])</span> <div style='text-align: right'>67,490</div>  |
...
| verify_fibair | true | AddFI | ADD | <span style="color: red">(+43 [+3.3%])</span> <div style='text-align: right'>1,333</div>  |
...
| verify_fibair | true | IfEqI | JAL | <span style="color: red">(+173 [+18.0%])</span> <div style='text-align: right'>1,134</div>  |
...
| verify_fibair | AccessAdapter<2> | true | AddEI | ADD | <span style="color: red">(+330 [+2.8%])</span> <div style='text-align: right'>12,166</div>  |
| verify_fibair | AccessAdapter<4> | true | AddEI | ADD | <span style="color: red">(+195 [+2.8%])</span> <div style='text-align: right'>7,189</div>  |
| verify_fibair | Boundary | true | AddEI | ADD | <div style='text-align: right'>440</div>  |
| verify_fibair | <NativeAdapterAir<2, 1>,FieldArithmeticCoreAir> | true | AddFI | ADD | <span style="color: red">(+1,290 [+3.3%])</span> <div style='text-align: right'>39,990</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | true | IfEqI | JAL | <span style="color: red">(+1,730 [+18.0%])</span> <div style='text-align: right'>11,340</div>  |
...
| verify_fibair | AccessAdapter<2> | true | MulE | BBE4MUL | <span style="color: red">(+330 [+2.4%])</span> <div style='text-align: right'>14,146</div>  |
| verify_fibair | AccessAdapter<4> | true | MulE | BBE4MUL | <span style="color: red">(+195 [+2.4%])</span> <div style='text-align: right'>8,359</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <span style="color: green">(-2.0 [-13.3%])</span> <div style='text-align: right'>13.0</div>  | <span style="color: green">(-4.0 [-1.5%])</span> <div style='text-align: right'>258.0</div>  | <span style="color: green">(-4.0 [-1.9%])</span> <div style='text-align: right'>210.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-3.0 [-6.7%])</span> <div style='text-align: right'>42.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: red">(+4,070 [+0.0%])</span> <div style='text-align: right'>8,310,317</div>  | <span style="color: red">(+216 [+0.1%])</span> <div style='text-align: right'>199,383</div>  | <span style="color: green">(-23.0 [-1.5%])</span> <div style='text-align: right'>1,464.0</div>  | <span style="color: red">(+1.0 [+5.0%])</span> <div style='text-align: right'>21.0</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <div style='text-align: right'>46.0</div>  | <span style="color: green">(-19.0 [-1.6%])</span> <div style='text-align: right'>1,160.0</div>  | <div style='text-align: right'>23,085,080</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/0692e50223da125ebe5a853683dea4d3fd66100d/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)

</details>

Commit: https://github.com/axiom-crypto/afs-prototype/commit/0692e50223da125ebe5a853683dea4d3fd66100d

Instance Type: 64cpu-linux-arm64

Memory Allocator: mimalloc

[Benchmark Workflow](https://github.com/axiom-crypto/afs-prototype/actions/runs/11966233990)
