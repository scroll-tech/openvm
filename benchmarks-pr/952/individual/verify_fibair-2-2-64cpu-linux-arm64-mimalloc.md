...
| --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>2</div>  | <span style="color: green">(-850 [-0.0%])</span> <div style='text-align: right'>48,126,235</div>  | <span style="color: green">(-15 [-0.0%])</span> <div style='text-align: right'>198,565</div>  | <span style="color: red">(+23.0 [+0.4%])</span> <div style='text-align: right'>5,703.0</div>  |
...
| --- | --- |
| <span style="color: red">(+2.0 [+16.7%])</span> <div style='text-align: right'>14.0</div>  | <div style='text-align: right'>32</div>  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | <div style='text-align: right'>9.0</div>  | <span style="color: green">(-12.0 [-0.7%])</span> <div style='text-align: right'>1,696.0</div>  | <span style="color: red">(+8.0 [+1.4%])</span> <div style='text-align: right'>581.0</div>  | <div style='text-align: right'>2</div>  | <span style="color: green">(-1.0 [-1.5%])</span> <div style='text-align: right'>64.0</div>  | <div style='text-align: right'>1</div>  | <span style="color: green">(-850 [-0.0%])</span> <div style='text-align: right'>48,126,235</div>  | <span style="color: green">(-15 [-0.0%])</span> <div style='text-align: right'>198,565</div>  | <span style="color: red">(+23.0 [+0.4%])</span> <div style='text-align: right'>5,703.0</div>  | <div style='text-align: right'>15.0</div>  |
...
| verify_fibair | AccessAdapter<2> | <span style="color: green">(-40 [-0.1%])</span> <div style='text-align: right'>58,144</div>  |
| verify_fibair | AccessAdapter<4> | <span style="color: green">(-20 [-0.1%])</span> <div style='text-align: right'>35,772</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | <span style="color: green">(-15 [-0.3%])</span> <div style='text-align: right'>5,089</div>  |
...
| verify_fibair |  | JAL | <span style="color: green">(-15 [-0.3%])</span> <div style='text-align: right'>5,089</div>  |
...
| verify_fibair | AccessAdapter<2> |  | ADD | <span style="color: green">(-220 [-1.7%])</span> <div style='text-align: right'>12,815</div>  |
| verify_fibair | AccessAdapter<4> |  | ADD | <span style="color: green">(-130 [-1.7%])</span> <div style='text-align: right'>7,735</div>  |
...
| verify_fibair | AccessAdapter<2> |  | BBE4MUL | <span style="color: green">(-220 [-1.5%])</span> <div style='text-align: right'>14,916</div>  |
| verify_fibair | AccessAdapter<4> |  | BBE4MUL | <span style="color: green">(-130 [-1.5%])</span> <div style='text-align: right'>8,814</div>  |
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> |  | JAL | <span style="color: green">(-150 [-0.3%])</span> <div style='text-align: right'>50,890</div>  |
...
| --- | --- | --- | --- | --- |
| verify_fibair | 0 | <span style="color: green">(-4.0 [-0.4%])</span> <div style='text-align: right'>1,079.0</div>  | <span style="color: red">(+39.0 [+1.3%])</span> <div style='text-align: right'>2,928.0</div>  | <div style='text-align: right'>107,769,880</div>  |
...
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)](https://axiom-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/ccb4cde40d50bf52a726ebe4322d805bcb503549/verify_fibair-2-2-64cpu-linux-arm64-mimalloc-verify_fibair.dsl_ir.opcode.frequency.svg)
