...
#[derive(Clone)]
pub struct IsFullIndexedOutputPageCols<T> {
    pub cache_cols: PageCols<T>,
    pub metadata: IsFullIndexedOutputPageMetadataCols<T>,
}

#[derive(Clone)]
pub struct IsFullIndexedOutputPageSubAirCols<T> {
...
#[derive(Clone)]
pub struct IsFullIndexedOutputPageMetadataCols<T> {
    pub range_inclusion_cols: RangeInclusionCols<T>,
    pub subchip_aux_cols: IsFullIndexedOutputPageSubAirCols<T>,
}

impl<T> IsFullIndexedOutputPageCols<T> {
    pub fn from_slice(
        cols: &[T],
        idx_len: usize,
        data_len: usize,
        ...
        T: Clone,
    {
        Self {
            ...
            metadata: IsFullIndexedOutputPageMetadataCols::from_slice(
...
impl<T> IsFullIndexedOutputPageMetadataCols<T> {
    pub fn from_slice(
        cols: &[T],
        idx_len: usize,
        is_less_than_tuple_params: MyLessThanTupleParams,
        ...
        T: Clone,
    {
        ...
        let subair_cols = IsFullIndexedOutputPageSubAirCols {
