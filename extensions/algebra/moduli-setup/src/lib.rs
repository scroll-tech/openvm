            ...
            externs.push(quote::quote_spanned! { span.into() =>
                ...
                extern "C" fn #func_name(rd: usize, rs1: usize, rs2: usize) {
                    axvm_platform::custom_insn_r!(
                        opcode = ::axvm_algebra_guest::OPCODE,
                        funct3 = ::axvm_algebra_guest::MODULAR_ARITHMETIC_FUNCT3 as usize,
                        funct7 = ::axvm_algebra_guest::ModArithBaseFunct7::#local_opcode as usize + #mod_idx * (::axvm_algebra_guest::ModArithBaseFunct7::MODULAR_ARITHMETIC_MAX_KINDS as usize),
                        rd = In rd,
                        rs1 = In rs1,
                        rs2 = In rs2
                    )
        ...
        setups.push(quote::quote_spanned! { span.into() =>
            ...
            pub fn #setup_function() {
                #[cfg(target_os = "zkvm")]
                {
                    ...
                    axvm_platform::custom_insn_r!(
                        opcode = ::axvm_algebra_guest::OPCODE,
                        funct3 = ::axvm_algebra_guest::MODULAR_ARITHMETIC_FUNCT3,
                        funct7 = ::axvm_algebra_guest::ModArithBaseFunct7::SetupMod as usize
                            + #mod_idx
