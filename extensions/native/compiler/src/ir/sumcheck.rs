...
impl<C: Config> Builder<C> {
    ...
    ///     ];
    /// 
    /// 2. for computing expected eval of next layer,
    ...
    pub fn sumcheck_layer_eval (
        ...
        prod_specs_eval: &Array<C, Ext<C::F, C::EF>>,       // GKR product IOP evaluations. Flattened from 3D array. 
        logup_specs_eval: &Array<C, Ext<C::F, C::EF>>,      // GKR logup IOP evaluations. Flattened from 3D array.
        r_evals: &Array<C, Ext<C::F, C::EF>>,               // Next layer's evaluations (pointer used for storing opcode output)
    ) {
