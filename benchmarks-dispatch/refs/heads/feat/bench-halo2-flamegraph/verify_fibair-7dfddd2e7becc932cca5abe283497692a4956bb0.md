...
|:---|---:|---:|
| Total | <span style='color: red'>(+2 [+56.2%])</span> 5.92 | <span style='color: red'>(+2 [+56.2%])</span> 5.92 |
| verify_fibair | <span style='color: red'>(+2 [+56.2%])</span> 5.92 | <span style='color: red'>(+2 [+56.2%])</span> 5.92 |


| verify_fibair |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2131 [+56.2%])</span> 5,925 | <span style='color: red'>(+2131 [+56.2%])</span> 5,925 | <span style='color: red'>(+2131 [+56.2%])</span> 5,925 | <span style='color: red'>(+2131 [+56.2%])</span> 5,925 |
| `main_cells_used     ` |  30,014,274 |  30,014,274 |  30,014,274 |  30,014,274 |
| `total_cycles        ` |  746,415 |  746,415 |  746,415 |  746,415 |
| `execute_time_ms     ` | <span style='color: red'>(+2157 [+1373.9%])</span> 2,314 | <span style='color: red'>(+2157 [+1373.9%])</span> 2,314 | <span style='color: red'>(+2157 [+1373.9%])</span> 2,314 | <span style='color: red'>(+2157 [+1373.9%])</span> 2,314 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-17 [-0.5%])</span> 3,175 | <span style='color: green'>(-17 [-0.5%])</span> 3,175 | <span style='color: green'>(-17 [-0.5%])</span> 3,175 | <span style='color: green'>(-17 [-0.5%])</span> 3,175 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-8 [-1.5%])</span> 528 | <span style='color: green'>(-8 [-1.5%])</span> 528 | <span style='color: green'>(-8 [-1.5%])</span> 528 | <span style='color: green'>(-8 [-1.5%])</span> 528 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+5 [+0.8%])</span> 644 | <span style='color: red'>(+5 [+0.8%])</span> 644 | <span style='color: red'>(+5 [+0.8%])</span> 644 | <span style='color: red'>(+5 [+0.8%])</span> 644 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+5 [+0.9%])</span> 578 | <span style='color: red'>(+5 [+0.9%])</span> 578 | <span style='color: red'>(+5 [+0.9%])</span> 578 | <span style='color: red'>(+5 [+0.9%])</span> 578 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-24 [-3.3%])</span> 712 | <span style='color: green'>(-24 [-3.3%])</span> 712 | <span style='color: green'>(-24 [-3.3%])</span> 712 | <span style='color: green'>(-24 [-3.3%])</span> 712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 436 | 5,925 | 746,415 | 89,839,640 | 3,175 | 644 | 578 | 528 | 712 | 619 | 30,014,274 | 93 | 2,314 | 
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | IfEqI | JAL | 50,160 | 
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 19,299 | 
...
| verify_fibair | AccessAdapter<2> | 95,782 | 
| verify_fibair | AccessAdapter<4> | 47,892 | 
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7dfddd2e7becc932cca5abe283497692a4956bb0/verify_fibair-7dfddd2e7becc932cca5abe283497692a4956bb0-verify_fibair.dsl_ir.opcode.frequency.svg)
