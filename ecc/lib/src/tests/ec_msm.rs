...
use crate::ec_msm::multi_scalar_multiply;
...
pub fn msm_simple_test() {
    ...
    let res = multi_scalar_multiply(g, scalars);
...
pub fn msm_rand_test(n: usize, disable_base_line: bool) {
    ...
    let res = multi_scalar_multiply(g.clone(), scalar_muls.clone());
