...
use crate::{
    ...
    operations::{
        evaluate_line, fp12_square, line_repr_from_point, mul_013_by_013, mul_by_01234, mul_by_013,
    },
};
...
fn test_mul_013_by_013() {
    ...
    let line_0 = line_repr_from_point::<Fq, Fq2>(rnd_pt_0.x, rnd_pt_0.y);
    let line_1 = line_repr_from_point::<Fq, Fq2>(rnd_pt_1.x, rnd_pt_1.y);
...
fn test_mul_by_013() {
    ...
    let line = line_repr_from_point::<Fq, Fq2>(rnd_pt.x, rnd_pt.y);
